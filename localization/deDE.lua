...
L["voidflame_ritual"] = "Lösche alle Leerenberührten Kerzen." --check for correctness
...
L["mending_monstro"] = "Zerstöre alle drei Heilbernkristalle." --check for correctness
