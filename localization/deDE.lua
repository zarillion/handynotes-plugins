...
L["gaze_of_nzoth"] = "Teilt sich den spawn mit \"Übler Beobachter\"."
...
L["kanebti"] = "Sammle eine Juwelenbesetzte Skarabäusfigur von einem Juwelenbesetzter Skarabäus, der sich einen spawn mit normalen Grabskarabäen teilt. Setze die Figur in den Skarabäusschrein ein, um Kaneb-ti zu beschwören."
...
L["wastewander"] = "Teilt sich den spawn mit \"Befallener Wüstenwanderer\"."
...
L["executor_nzoth"] = "Töte den Exekutor von N'Zoth und zerstöre dann den Exekutoranker."
...
L["monstrous_summon"] = "Töte alle Abyssischen Herolds um die Beschwörung zu stoppen."
...
L["mantid_relic"] = "Benötigt Mantisrelikt"
L["mogu_plunder"] = "Mogubeute"
L["mogu_strongbox"] = "Schließkassette der Mogu"
L["mogu_relic"] = "Benötigt Mogurelikt"

L["abyssal_ritual"] = "Töte die Ertrunkenen Anhänger und dann die Tiefenmonstrosität."
L["bound_guardian"] = "Töte drei Tiefengeborene Binder um Makelloser Tropfen zu befreien."
L["colored_flames"] = "Sammle die farbigen Flammen ein und bring sie zu den passenden Runen."
...
L["electric_empower"] = "Töte die Rufer der Zan-Tien und dann Menek der Durchströmte."
...
L["swarm_caller"] = "Zerstöre den Schwarmrufer."
L["vault_of_souls"] = "Öffne das Verlies der Seelen, töte die Statuen und dann den Wächter des Gewölbes."
L["void_conduit"] = "Klicke auf die Leerenleitung und zerquetsche die Wachsamen Augen."
L["war_banner"] = "Verbrenne die Kriegsbanner und töten Wellen von Gegnern bis Kommandant I'juk erscheint."
...
L["ethereal_note"] = "Sammel orangene Kristalle die in der Vision versteckt sind und bringe sie zu diesem NPC um extra Verderbte Andenken zu erhalten. Es gibt insgesamt 10 Kristalle, zwei in jeder Zone.\n\n|cFF00FF00Vergiss nicht die Truhe zu plündern!|r"
...
L["c_center_building"] = "Im Erdgeschoss des Hauptgebäudes."
