...
L["aqir_flayer"] = "與亞基蟲巢工人以及亞基收割者共享出生點。"
L["aqir_titanus"] = "與亞基甲蟲共享出生點。"
L["aqir_warcaster"] = "與亞基虛無法師共享出生點。"
...
L["construction_ritual"] = "將老虎雕像推入光束中。(暫譯)"
L["consuming_maw"] = "淨化生長物和觸手，直到被踢出。"
L["corruption_tear"] = "點擊抓起一旁的巨大信標，在不讓旋轉的眼睛撞到你的情況下關閉裂口。"
L["electric_empower"] = "殺死Zan-Tien召喚者，然後殺死Menek the Infused。(暫譯)"
L["empowered_demo"] = "關閉所有精神聖匣(暫譯)"
L["font_corruption"] = "旋轉魔古雕像，直到兩個光束都到達後方，然後點擊控制台。"
L["infested_statue"] = "將所有扭曲之眼從雕像上移開。"
L["mystery_sacro"] = "摧毀所有可疑墓碑，殺死號叫之魂。(暫譯)"
L["protect_stout"] = "保護洞穴免遭怪物的襲擊。"
L["pulse_mound"] = "殺死周圍的生物，然後殺死成長活體"
L["serpent_binding"] = "殺死Zan-Tien征服者，然後殺死Haofeng。(暫譯)"
L["vault_of_souls"] = "打開金庫，摧毀所有塑像。"
L["void_conduit"] = "點擊虛空導管並擠壓觀察的眼睛。"
L["weighted_artifact"] = "拿起奇怪的重花瓶，將迷宮倒回基座，會被塑像給暈了，瓶子就掉了。(暫譯)"
