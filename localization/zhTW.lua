...
L["gaze_of_nzoth"] = "與汙穢的觀察者共用出生點。(暫譯)"
...
L["neferset_rare"] = "這六個稀有怪在納弗塞特具有相同的三個出生位置。 完成許多“召喚儀式”事件後，將隨機產生三個。"
...
L["summoning_ritual"] = "殺死侍僧，然後關閉召喚傳送門。事件多次完成後，納弗塞特周圍將產生一組三種稀有。"
...
L["construction_ritual"] = "將老虎塑像推入光束中。"
L["consuming_maw"] = "淨化生長物和觸手，直到被踢出。"
L["corruption_tear"] = "點擊抓起一旁的巨大信標，在不讓旋轉的眼睛撞到你的情況下關閉裂口。"
L["electric_empower"] = "殺死參天召喚者，然後殺死注入者Menek。(暫譯)"
L["empowered_demo"] = "關閉所有靈神聖匣(暫譯)"
L["font_corruption"] = "旋轉魔古雕像，直到兩個光束都到達後方，然後點擊控制台。"
L["goldbough_guardian"] = "保護族長金枝免受一波波怪物的襲擊。(暫譯)"
...
L["weighted_artifact"] = "拿起奇怪的重花瓶，穿越迷宮回到基座，中途如果被雕像打中花瓶會掉落。"
