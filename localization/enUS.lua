...
L["buffs_change"] = "Available buffs change each week. Buildings will be closed when they are not up."
...
L["ethereal"] = "Ethereal"
L["ethereal_note"] = "Collect orange crystals hidden throughout the vision and return them to this NPC for extra momentos. Don't forget to loot the chest!"
