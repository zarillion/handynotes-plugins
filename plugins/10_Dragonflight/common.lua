...
ns.DRAGON_CUSTOMIZATIONS = {
    ...
    WindingSlitherdrake = {
        AntlerHorns = Item({item = 203338, quest = nil}),
        ...
        ClusterHorns = Item({item = 203331, quest = nil}),
        ClusterJawHorns = Item({item = 203340, quest = nil}),
        CurledCheekHorn = Item({item = 203321, quest = nil}),
        ...
        FinnedCheek = Item({item = 203319, quest = nil}),
        FinnedTipTail = Item({item = 203361, quest = nil}),
        GrandChinThorn = Item({item = 203310, quest = nil}),
        GreenAndBronzeArmor = Item({item = 203299, quest = nil}),
        GreenScales = Item({item = 203352, quest = nil}),
        HairyBrow = Item({item = 203308, quest = nil}),
        HairyChin = Item({item = 203311, quest = nil}),
        HairyCrest = Item({item = 203318, quest = nil}),
        HairyJaw = Item({item = 203343, quest = nil}),
        HairyTail = Item({item = 203362, quest = nil}),
        HairyThroat = Item({item = 203365, quest = nil}),
        HeavyHorns = Item({item = 203329, quest = nil}),
        HeavyScales = Item({item = 205341, quest = nil}),
        Helm = Item({item = 203326, quest = nil}),
        HornedBrow = Item({item = 203306, quest = nil}),
        ImpalerHorns = Item({item = 203339, quest = nil}),
        LargeFinnedCrest = Item({item = 203316, quest = nil}),
        LargeFinnedTail = Item({item = 203360, quest = nil}),
        LargeFinnedThroat = Item({item = 203363, quest = nil}),
        LargeSpikedNose = Item({item = 203347, quest = nil}),
        LightBlueAndCopperArmor = Item({item = 203301, quest = nil}),
        LongChinHorn = Item({item = 203309, quest = nil}),
        LongJawHorns = Item({item = 203341, quest = nil}),
        PairedHorns = Item({item = 203336, quest = nil}),
        PlatedBrow = Item({item = 203307, quest = nil}),
        PointedNose = Item({item = 203348, quest = nil}),
        PurpleAndSilverArmor = Item({item = 203302, quest = nil}),
        RedAndGoldArmor = Item({item = 203303, quest = nil}),
        RedHair = Item({item = 203325, quest = nil}),
        RedScales = Item({item = 203353, quest = nil}),
        SharkFinnedTail = Item({item = 203359, quest = nil}),
        ShortHorns = Item({item = 203333, quest = nil}),
        SingleJawHorn = Item({item = 203344, quest = nil}),
        ...
        SpikedTail = Item({item = 203357, quest = nil}),
        SplitJawHorns = Item({item = 203345, quest = nil}),
        SweptHorns = Item({item = 203330, quest = nil}),
        TanHorns = Item({item = 203327, quest = nil}),
        TechniqueBlueAndSilverArmor = Item({item = 205127, quest = nil}),
        TechniqueCurvedChinHorn = Item({item = 205129, quest = nil}),
        TechniqueSmallFinnedThroat = Item({item = 205131, quest = nil}),
        TechniqueWhiteHair = Item({item = 205130, quest = nil}),
        TechniqueYellowAndSilverArmor = Item({item = 205128, quest = nil}),
        ThornHorns = Item({item = 203337, quest = nil}),
