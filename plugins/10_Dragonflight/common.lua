...
ns.DRAGON_CUSTOMIZATIONS = {
    RenewedProtoDrake = {
        ...
        EmbodimentOfShadowflame = Item({item = 210537, quest = nil}),
        EmbodimentOfTheBlazing = Item({item = 210536, quest = nil}),
    ...
    WindingSlitherdrake = {
        ...
        EmbodimentOfTheVerdantGladiator = Item({item = 210064, quest = nil}),
