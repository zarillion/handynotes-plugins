...
ns.DRAGON_CUSTOMIZATIONS = {
    ...
    WindborneVelocidrake = {
        ...
        -- OxHorns = Item({item = nil, quest = nil}),
        -- PlatedNeck = Item({item = nil, quest = nil}),
        -- ReaverPattern = Item({item = nil, quest = nil}),
        -- RedHair = Item({item = nil, quest = nil}),
        -- RedScales = Item({item = nil, quest = nil}),
        -- ShriekerPattern = Item({item = nil, quest = nil}),
        -- SilverAndBlueArmor = Item({item = nil, quest = nil}),
        ...
        -- SplitHorns = Item({item = nil, quest = nil}),
        -- SteelAndOrangeArmor = Item({item = nil, quest = nil}),
        SweptHorns = Item({item = 197606, quest = 69810})
        -- TealScales = Item({item = nil, quest = nil}),
        -- WavyHorns = Item({item = nil, quest = nil}),
        -- WhiteAndPinkArmor = Item({item = nil, quest = nil}),
        -- WhiteHorns = Item({item = nil, quest = nil}),
        -- WhiteScales = Item({item = nil, quest = nil}),
        -- WindsweptPattern = Item({item = nil, quest = nil}),
        -- YellowHorns = Item({item = nil, quest = nil})
    },
    HighlandDrake = {
        -- Armor = Item({item = 197099, quest = nil}),
        -- BlackHair = Item({item = 197117, quest = nil}),
        -- BlackScales = Item({item = 197142, quest = nil}),
        -- BladedTail = Item({item = 197153, quest = nil}),
        -- BronzeAndGreenArmor = Item({item = 197156, quest = nil}),
        -- BronzeScales = Item({item = 197145, quest = nil}),
        -- BrownHair = Item({item = 197118, quest = nil}),
        -- BushyBrow = Item({item = 197101, quest = nil}),
        -- CoiledHorns = Item({item = 197125, quest = nil}),
        -- CrimsonGladiato = Item({item = 201792, quest = nil}),
        -- CurledBackHorns = Item({item = 197128, quest = nil}),
        -- Ears = Item({item = 197116, quest = nil}),
        -- FinnedHead = Item({item = 197106, quest = nil}),
        -- FinnedNeck = Item({item = 197155, quest = nil}),
        -- GoldAndBlackArmor = Item({item = 197090, quest = nil}),
        -- GoldAndRedArmor = Item({item = 197094, quest = nil}),
        -- GoldAndWhiteArmor = Item({item = 197095, quest = nil}),
        -- GrandThornHorns = Item({item = 197127, quest = nil}),
        -- GreenScales = Item({item = 197143, quest = nil}),
        -- HairyCheek = Item({item = 197131, quest = nil}),
        -- HeavyHorns = Item({item = 197122, quest = nil}),
        -- HeavyScales = Item({item = 197147, quest = nil}),
        -- Helm = Item({item = 197119, quest = nil}),
        -- HookedHorns = Item({item = 197126, quest = nil}),
        -- HornedChin = Item({item = 197102, quest = nil}),
        -- LargeSpottedPattern = Item({item = 197139, quest = nil}),
        -- ManedChin = Item({item = 197103, quest = nil}),
        -- MultiHornedHead = Item({item = 197114, quest = nil}),
        -- OrnateHelm = Item({item = 197120, quest = nil}),
        -- PlatedHead = Item({item = 197110, quest = nil}),
        -- RedScales = Item({item = 197144, quest = nil}),
        -- ScaledPattern = Item({item = 197141, quest = nil}),
        -- SilverAndBlueArmor = Item({item = 197091, quest = nil}),
        -- SilverAndPurpleArmor = Item({item = 197093, quest = nil}),
        -- SingleHornedHead = Item({item = 197112, quest = nil}),
        -- SleekHorns = Item({item = 197129, quest = nil}),
        -- SmallSpottedPattern = Item({item = 197140, quest = nil}),
        -- SpikedCheek = Item({item = 197132, quest = nil}),
        -- SpikedHead = Item({item = 197109, quest = nil}),
        -- SpikedLegs = Item({item = 197134, quest = nil}),
        -- SpikedTail = Item({item = 197151, quest = nil}),
        -- SpinedBack = Item({item = 197097, quest = nil}),
        -- SpinedCheek = Item({item = 197133, quest = nil}),
        -- SpinedChin = Item({item = 197105, quest = nil}),
        -- SpinedHead = Item({item = 197108, quest = nil}),
        -- SpinedNeck = Item({item = 197154, quest = nil}),
        -- SpinedNose = Item({item = 197137, quest = nil}),
        -- StagHorns = Item({item = 197130, quest = nil}),
        -- SteelAndYellowArmor = Item({item = 197096, quest = nil}),
        -- SweptHorns = Item({item = 197124, quest = nil}),
        -- SweptSpikedHead = Item({item = 197113, quest = nil}),
        -- TaperedChin = Item({item = 197104, quest = nil}),
        -- TapereredNose = Item({item = 197136, quest = nil}),
        -- ThornedJaw = Item({item = 197115, quest = nil}),
        -- ThornHorns = Item({item = 197123, quest = nil}),
        -- TripleFinnedHead = Item({item = 197107, quest = nil}),
        -- VerticalFinnedTail = Item({item = 197148, quest = nil}),
        -- WhiteScales = Item({item = 197146, quest = nil}),
    ...
    CliffsideWylderdrake = {
        Armor = Item({item = 196961, quest = nil}),
        BlackHair = Item({item = 196986, quest = nil}),
        BlackHorns = Item({item = 196991, quest = 69191}),
        BlackScales = Item({item = 197013, quest = nil}),
        BlondeHair = Item({item = 196987, quest = nil}),
        ...
        BronzeAndTealArmor = Item({item = 196965, quest = nil}),
        CoiledHorns = Item({item = 197000, quest = nil}),
        ConicalHead = Item({item = 196981, quest = nil}),
        CurledHeadHorns = Item({item = 196979, quest = nil}),
        DarkSkinVariation = Item({item = 197015, quest = nil}),
        DualHornedChin = Item({item = 196973, quest = 69173}),
        Ears = Item({item = 196982, quest = 69182}),
        FinnedBack = Item({item = 196969, quest = nil}),
        FinnedCheek = Item({item = 197001, quest = 69201}),
        FinnedJaw = Item({item = 196984, quest = nil}),
        FinnedNeck = Item({item = 197022, quest = 69222}),
        FinnedTail = Item({item = 197018, quest = nil}),
        FlaredCheek = Item({item = 197002, quest = nil}),
        FourHornedChin = Item({item = 196974, quest = nil}),
        GoldAndBlackArmor = Item({item = 196964, quest = nil}),
        GoldAndOrangeArmor = Item({item = 196966, quest = nil}),
        GoldAndWhiteArmor = Item({item = 196967, quest = nil}),
        GreenScales = Item({item = 197011, quest = nil}),
        HeadFin = Item({item = 196975, quest = nil}),
        HeadMane = Item({item = 196976, quest = 69176}),
        HeavyHorns = Item({item = 196992, quest = 69192}),
        Helm = Item({item = 196990, quest = nil}),
        HookHorns = Item({item = 196998, quest = nil}),
        HornedJaw = Item({item = 196985, quest = 69185}),
        HornedNose = Item({item = 197005, quest = 69205}),
        LargeTailSpikes = Item({item = 197017, quest = nil}),
        ManedJaw = Item({item = 196983, quest = nil}),
        ManedNeck = Item({item = 197023, quest = 69223}),
        ManedTail = Item({item = 197016, quest = nil}),
        NarrowStripesPattern = Item({item = 197008, quest = nil}),
        PlatedBrow = Item({item = 196972, quest = nil}),
        PlatedNose = Item({item = 197006, quest = nil}),
        RedHair = Item({item = 196988, quest = nil}),
        RedScales = Item({item = 197010, quest = nil}),
        ScaledPattern = Item({item = 197009, quest = nil}),
        ShortHorns = Item({item = 196994, quest = nil}),
        SilverAndBlueArmor = Item({item = 196963, quest = nil}),
        SilverAndPurpleArmor = Item({item = 196962, quest = nil}),
        SleekHorns = Item({item = 196993, quest = nil}),
        SmallHeadSpikes = Item({item = 196978, quest = nil}),
        SpearTail = Item({item = 197020, quest = nil}),
        SpikedBack = Item({item = 196970, quest = nil}),
        SpikedBrow = Item({item = 196971, quest = nil}),
        SpikedCheek = Item({item = 197003, quest = nil}),
        SpikedClubTail = Item({item = 197021, quest = nil}),
        SpikedHorns = Item({item = 196995, quest = nil}),
        SpikedLegs = Item({item = 197004, quest = nil}),
        SplitHeadHorns = Item({item = 196977, quest = nil}),
        SplitHorns = Item({item = 196997, quest = nil}),
        SteelAndYellowArmor = Item({item = 196968, quest = nil}),
        SweptHorns = Item({item = 196999, quest = nil}),
        TripleHeadHorns = Item({item = 196980, quest = nil}),
        WhiteHair = Item({item = 196989, quest = nil}),
        WhiteScales = Item({item = 197014, quest = nil}),
        WideStripesPattern = Item({item = 197007, quest = nil})
    }
}
