...
map.nodes[49007030] = Treasure({
    label = L['kaldorei_horn_label'],
    quest = 79497,
    note = L['night_elven_sgnal_note'],
    rewards = {Transmog({item = 213007, slot = L['offhand']})}
}) -- Night Elven Signal

map.nodes[58405190] = Treasure({
    label = L['kaldorei_horn_label'],
    quest = 79498,
