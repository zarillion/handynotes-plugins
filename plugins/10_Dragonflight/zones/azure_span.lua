...
map.nodes[27214490] = Rare({
    ...
    rewards = {
        ...
        DC.CliffsideWylderdrake.BluntSpikedTail, DC.CliffsideWylderdrake.HornedNose
    },
    pois = {
        Path({
