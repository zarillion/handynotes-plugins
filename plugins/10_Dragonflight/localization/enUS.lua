...
L['nahqi_note'] = 'It requires the {item:211314} to {spell:1515} {npc:210908}, that is obtained from the mount {item:210061}.\n\n{npc:210908}{npc:<Ember of Regrowth>} flies 300yds from the ground around {location:Amirdrassil} in a {note:counter clockwise} route, taking 17:30 minutes to complete a lap. \nIt has a minimum respawn timer of 30 minutes. \n\nIt has an increased visibility distance compared to other mobs, being visible and targetable from 400yds on the horizontal axis compared to the usual 100yds.\n\n{note:It is a {npc:Spirit Beast}. Only Beast Mastery Hunters can tame it.}'

L['sulraka_note'] = '{npc:210868}{npc:<Daughter of Kimbul>} patrols the area to the east of {location:Amirdrassil} in a {note:counter clockwise} route, taking 17 minutes to complete a lap. \nIt has a minimum respawn timer of 30 minutes.\n\nIt leaves behind {object:Heavy Tracks} while walking which lasts 3 minutes. \nTo find it you need to use {spell:1543} in front of a freshly spawn {object:Heavy Tracks} to reveal {npc:210868}. \nCast {spell:257284} and/or {spell:187650} and attampt to {spell:1515}.\n\n{note:It is important to trap it or to reveal it because {npc:210868} will not stop moving, even when attacked, and can get out of range of the {spell:1543} cancelling the {spell:1515}.}\n\n{note:It is a {npc:Spirit Beast}. Only Beast Mastery Hunters can tame it.}'
-------------------------------------------------------------------------------
----------------------------- SECRETS OF AZEROTH ------------------------------
-------------------------------------------------------------------------------
