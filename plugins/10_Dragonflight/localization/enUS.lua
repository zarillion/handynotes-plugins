...
L['spawns_two_hourly'] = 'Possible spawns on the hour every 2 hours.'
...
L['pt_ench_faintly_enchanted_remains_note'] = 'Click the {npc:194882} to spawn and kill a mob. Then loot the crystal that spawns.'
