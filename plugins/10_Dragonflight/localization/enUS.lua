...
L['pt_leath_treated_hides_note'] = 'At |cFFFFFD00Snowhide|r camp'
...
L['pt_alch_canteen_of_suspicious_water_note'] = 'Deep inside cave near a dead |cFFFFFD00Expedition Scout|r'
...
L['pt_leath_wind_blessed_hide_note'] = 'Inside |cFFFFFD00Shikaar Highlands Centaur|r camp'
L['pt_script_sign_language_reference_sheet_note'] = 'Banging on the tent entrance'
...
L['pt_tailor_silky_surprise_note'] = 'Find a loot a |cFFFFFD00Catnip Frond|r'
...
L['pt_ench_flashfrozen_scroll_note'] = 'Inside the |cFFFFFD00Flashfrozen Enclave|r cave system'
...
L['pt_jewel_closely_guarded_shiny_note'] = 'Blue gem underneath the a tree next to a nest'
L['pt_jewel_igneous_gem_note'] = nil -- Minigame
L['pt_leath_poachers_pack_note'] = 'Next to a dead Vulpera beside the riverbed'
L['pt_leath_spare_djaradin_tools_note'] = 'Nnext to dead red dragon'
...
L['pt_tailor_mysterious_banner_note'] = 'Fluttering on top of of the buildings'
