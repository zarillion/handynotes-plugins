...
L['snowclaw_cub_note_start'] = 'You must complete the {quest:67094} quest chain offered by {npc:192522} in {sanctuary:Valdrakken} to obtain the {title:Honorary Dryad} title.\n\nGather the following items:'
