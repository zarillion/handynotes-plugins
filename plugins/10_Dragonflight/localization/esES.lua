...
L['golden_claw_note'] = 'En la garra trasera izquierda de la estatua del dragón.'
...
L['bugged_selfie'] = '|cFFFF0000(BUG: Será detectado el PNJ equivocado o ninguno.)|r'
L['options_icons_pretty_neat_selfie'] = '{achievement:16446}'
L['options_icons_pretty_neat_selfie_desc'] = 'Muestra dónde están los PNJ para el logro {achievement:16446}.'
...
L['pt_ench_faintly_enchanted_remains_note'] = 'Clica en la |cFFFFFD00Recogida de Cristal del Sediento de Maná|r para hacer aparecer y matar a un enemigo. Después ya puedes despojar el cristal que aparece.'
...
L['pt_jewel_harmonic_crystal_harmonizer_note'] = 'Clica en el cofre para recibir un buff. Ahora clica en los 3 cristales.'
...
L['hunter_of_the_deep_note'] = 'Clica en el armero y dispara a los peces hasta que aparezca el raro and shoot fish until the rare spawns.'
L['scaleseeker_mezeri_note'] = 'Ofrece {item:194681} a {npc:193224} y te revelará al raro.'
L['shade_of_grief_note'] = 'Clica en {npc:193166} para hacer aparecer al raro.'
L['windscale_the_stormborn_note'] = 'Mata a los {npc:192367} que están canalizando en los {npc:192357}.'
L['zarizz_note'] = 'Clica y ' .. ns.color.Orange('haz /hiss') .. ' a las cuatro {npc:193169} para invocar al raro.'
...
L['ohnahra_note_item1'] = 'Recoge 3x {item:201929} de los {npc:186151}, el jefe final de la mazmorra |cFFFFFD00Ofensiva Nokhud|r (dificultad Heroica). No tiene un 100% de caer.'
...
L['pt_script_counterfeit_darkmoon_deck_note'] = 'Habla con {npc:194856} y ofrécete a ayudarla a recoger su |cFFFFFD00Colección de la Luna Negra|r esparcida a sus pies. Clica en las cartas en el orden correcto (del As al 8). Después habla con ella de nuevo para conseguir la colección.'
...
L['pt_tailor_ancient_dragonweave_bolt_note'] = 'Haz clic en el |cFFFFFD00Telar de Tejido de Dragón Ancestral|r para completar un minijuego donde has de conectar los carretes de hilo a la gema central.'
...
L['shadeslash_note'] = 'Clica en el |cFFFFFD00Foco Birlado|r para hacer aparecer al raro.'
...
L['pt_jewel_igneous_gem_note'] = 'Clica rápidamente en los tres cristales de las islas pequeñas dentro del magma.'
...
L['pt_smith_ancient_monument_note'] = 'Derrota a los 4 {npc:188648} rodeando una espada en un pedestal.\n\n|cFFFF0000(BUG: Actualmente, tras clicar en la espada no tendrás el objeto en el inventario. En lugar de eso, se te enviará al buzón de correo tras algo de tiempo.)|r'
...
L['pt_tailor_itinerant_singed_fabric_note'] = 'Un trozo de tela colgando de unos árboles justo fuera de la cueva donde aparece el jefe final. ' .. ns.color.Orange('Requiere precisión montando dragones o un portal de brujo')
...
L['complaint_to_scalepiercer_note'] = 'Clica en la |cFFFFFD00Tablilla de Piedra|r que hay dentro de la choza (en el lado izquierdo de la parte de atrás).'
L['grand_flames_journal_note'] = 'Clica en la |cFFFFFD00Tablilla de Piedra|r de fuera detrás de la choza.'
L['wyrmeaters_recipe_note'] = 'Clica en la |cFFFFFD00Tablilla de Piedra|r que hay dentro de la choza (en el lado izquierdo).'
