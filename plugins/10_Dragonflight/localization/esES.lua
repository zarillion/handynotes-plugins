...
L['forgotten_dragon_treasure_step1'] = '1.{dot:Green}Recoge 5x {item:195884} de las {object:Flores Cristalinas} al oeste de las {location:Llanuras de Ohn\'ahra}.'
...
L['shadeslash_note'] = 'Haz click en el {object:Foco Birlado} o en el {object:Telescopio Birlado}. Después haz click en el {object:Foco Birlado} para hacer aparecer al raro.'
