...
L['spawns_hourly'] = 'Apparaît uniquement à heure fixe.'
L['spawns_at_night'] = 'Apparitions possible uniquement la nuit. (apparition à 18:30, heure du serveur)'
...
L['otto_note_start2'] = '{note:Battre des monstres {title:<Malabar>} nécessitera un Renom 7 avec les {faction:2511} et l\'accès au {item:194510}.}'
