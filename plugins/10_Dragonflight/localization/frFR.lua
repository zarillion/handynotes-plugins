...
L['pt_alch_canteen_of_suspicious_water_note'] = 'Au fond d\'une grotte, près d\'un |cFFFFFD00Eclaireur de l\'expédition|r mort'
...
L['pt_alch_contraband_concoction_note'] = 'Caché dans les buissons. ' .. ns.color.Orange('Difficile de voir')
...
L['pt_jewel_closely_guarded_shiny_note'] = 'Une gemme bleue sous l\'arbre à côté d\'un nid.'
