...
L['fisherman_tinnak_note'] = 'Récupérez la Canne à pêche cassée, le Filet de pêche déchiré et le Vieux harpon pour faire apparaître le rare.'
...
L['hidden_hornswog_hoard_note'] = 'Collectez {item:200064}, {item:200065} et {item:200066}, combinez-les à "l\'Énigmes sagaces : un guide de poche" près du trésor puis nourrissez la grenouille.'
