...
L['renown_envoy_note'] = 'Обменяйте {currency:2118} или золото на средства передвижения, питомцев, трансмогрификацию, манускрипты для дракона, рецепты и другие полезные предметы.' -- review new line
