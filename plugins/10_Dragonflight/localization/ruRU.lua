...
L['snowclaw_cub_note_end'] = '{note:Все предметы можно приобрести на аукционе. Это особенно полезно, если у вас нет доступа к {item:199215}, который требуется для покупки предметов у {npc:193310}.}\n\nКак только у вас появиться титул {title:почетная дриада} отдайте все 4 предмета {npc:196768}, чтобы получить своего питомца.\n\n{bug:(БАГ: титул может исчезнуть стоит ожидать исправления)}'
...
L['porta_the_overgrown_note'] = 'Можно найти {item:194426} на дне озера {location:Зеркало Небес} в западной части. Раскидайте 5x 5x {item:194426} на {npc:191953}, чтобы вызвать редкого монстра.'
...
L['lepidoralia_note'] = 'Находиться в |cFFFFFD00Порхающей Пещере|r. Помогите {npc:193342} ловить {npc:193274}, пока не появятся редкий монстр.'
