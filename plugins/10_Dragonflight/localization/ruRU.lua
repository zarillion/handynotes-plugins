...
L['sulraka_note'] = '{npc:210868}{npc:<Daughter of Kimbul>} патрулирует территорию к востоку от {location:Amirdrassil} маршрут {note:counter clockwise} на прохождение круга уходит 17 минут.\nМинимальный таймер возрождения составляет 30 минут.\n\nОна оставляет позади {object:Heavy Tracks} во время ходьбы, которые остаются на 3 минуты.\nХодит всегда скрытно, поэтому вам нужно будет использовать {spell:1543} перед свежими {object:Heavy Tracks} чтобы раскрыть ее.\nИспользуйте {spell:257284} или {spell:187650} и попытайтесь использовать {spell:1515}.\n\n{note:Важно поймать ее или раскрыть, потому что {npc:210868} не перестанет двигаться, даже если на нее нападут. Может выйти за пределы зоны действия навыка {spell:1543}.}\n\n{note:Это {npc:Spirit Beast}. Только охотники со специализацией Повелитель зверей могут его приручить.}'
