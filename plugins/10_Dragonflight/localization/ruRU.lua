...
L['gem_cluster_note'] = 'Эти предметы станут доступны с 21-го уровня известности с {faction:Драконьей Экспедиции}, их можно найти в {object:Сумках разведчиков экспедиции} и в {object:Потревоженной почве}.'
