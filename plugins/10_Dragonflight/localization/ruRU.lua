...
4. Использование данного предмета даст вам дебафф {spell:386848}, который позволит вам собирать {item:202173} с монстров в |cFFFFFFD00Обсидиановой цитадели|r.
