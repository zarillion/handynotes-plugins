...
L['yennus_boat_note'] = 'Возьмите игрушечную лодку клыкарров, чтобы получить {item:200876}, который запускает задание {quest:72063}, которое можно сдать у {npc:195252}.'
...
L['acorn_harvester_note'] = 'Подберите желудь с земли поблизости, чтобы получить {spell:388485}, а затем взаимодействуйте с {npc:196172}.'
...
L['onyx_gem_cluster_note'] = 'Купите {item:200738} у {npc:189065} за 3 {item:192863} и 500 {currency:2003} на 21 уровне известности у Драконьей Экспедиции и используйте его.'
