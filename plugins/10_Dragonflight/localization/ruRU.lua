...
L['rare_14h'] = 'Редкий монстр находится в 14-часовой ротации с другими редкими монстрами, один редкий монстр может появляться каждые 30 минут.\n\nСледующее возможное появление: {note:%s} (время сервера)'
...
L['options_icons_elemental_storm_desc'] = 'Показать награды за {spell:392768}.'
...
L['pt_alch_tasty_candy_note'] = 'Бросьте ближайшую {object:Брошенную игрушку} в каждый котел, затем убейте появившегося монстра.'
