...
L['rare_14h'] = 'Редкий монстр находится в 14-часовой ротации с другими редкими монстрами, один редкий монстр появляется каждые 30 минут.\n\nСледующее появление через: {note:%s}'
...
L['clued_in_note'] = '{npc:210079} появляется во время {note:Больших раскопок} событие и 3 локальных задания {wq:Исследование: ...}.'
...
L['pt_ench_faintly_enchanted_remains_note'] = 'Нажмите на {object:Жаждущую маны друзу}, чтобы вызвать и убить монстра. Затем заберите кристалл, который появится.'
...
Как только у вас появится титул {title:почетная дриада} отдайте все 4 предмета {npc:196768}, чтобы получить своего питомца.
...
{npc:191143}({dot:Green}) и другие НПС будут пробиваться от северо-восточного входа к {location:Имбу} до скалы, где {npc:196165} затем появится.
...
L['slightly_chewed_duck_egg_note'] = 'Найдите и погладьте {npc:192997}, чтобы получить {item:195453}, затем используйте ее. {item:199171} превратится через 3 дня в {item:199172}.'
...
L['lepidoralia_note'] = 'Находится в {location:Порхающей Пещере}. Помогите {npc:193342} ловить {npc:193274}, пока не появится редкий монстр.'
...
L['otto_note_end'] = 'Вернитесь в {location:Шипящий грот} на Берегах Пробуждения и оставьте бочку там, где вы ее нашли, чтобы призвать {npc:199563} и получить свое средство передвижения!'
...
L['seething_cache'] = 'Дымящийся тайник'
...
L['envoy_of_winter_note'] = 'Соберите {item:208881} и используйте {spell:421658} возле колодца, пока не появится {npc:209929}.'
...
L['silent_mark_note'] = 'Нацеливайтесь на нужное животное и направляйте соответствующий предмет до тех пор, пока не появится {spell:426910}. {note:Вы должны настроиться на более чем 10 животных.}\n\nКанал {item:210764} на {npc:210892}.\n\nКанал {item:210767} на {npc:211347}, {npc:211283}, или {npc:210894}.\n\nКанал {item:210755} на {npc:210594}.\n\nКанал {item:210766} на {npc:209494}, {npc:212028}, или {npc:212024}.'
...
L['soa_03_clinkyclick_note_a'] = 'Поговорите с {npc:185548}, чтобы получить {item:207814}. Вам понадобится:'
...
L['soa_11_burial_banner_note'] = 'Внутри пещеры доберитесь до второго этажа, в конце вы найдете место, чтобы использовать {item:208852}.'
...
L['bs_tas_location'] = 'Используйте {item:208135}, чтобы растопить {npc:96438} и появится {object:Кучка рыхлой земли}.'
