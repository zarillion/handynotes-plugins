...
L['gethdazr_note'] = [[
Появляется как часть события в {location:Имбу} которое начинается если подуть в {object:Великий рог Имбу}({dot:Синий}).
Рог станет активным только после убийства {npc:196155} который возрождается примерно раз в 30-60 минут.

{npc:191143}({dot:Зеленый}) и другие НПС будут пробиваться от северо-восточного входа к {location:Имбу} до скалы, где {npc:196165} затем появиться.
...
{item:200064}{dot:Желтый}
{item:200065}{dot:Синий}
{item:200066}{dot:Белый}
]]
