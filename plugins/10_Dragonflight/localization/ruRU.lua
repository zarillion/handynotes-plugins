...
L['pt_leath_treated_hides_note'] = 'В |cFFFFFD00лагере Снегошкуров|r.'
...
L['snowclaw_cub_note_end'] = ns.color.Orange('Все предметы можно приобрести на аукционе. Это особенно полезно, если у вас нет доступа к {item:199215}, который требуется для покупки предметов у {npc:193310}.') .. '\n\nКак только у вас появиться титул |cFFFFFD00почетная дриада|r отдайте все 4 предмета {npc:196768}, чтобы получить своего питомца.' .. ns.color.Red('\n\nБАГ: титул может исчезнуть стоит ожидать исправления.')
...
L['ohnahra_note_start'] = nil -- review 'Завершите сюжетную линию Похождения посвященного, начав с {quest:65901} у {npc:190022} который появиться в |cFFFFFD00ключах Он\'ир|r за хижиной жреца ветра.\n\nСоберите следующие материалы:'
...
L['ohnahra_note_end'] = nil -- review 'Когда у вас будут все материалы, вернитесь к {npc:190022} и возьмите задание {quest:72512}. Отправляйтесь к {npc:194796}, чтобы сдать задание и получить средство передвижение.'
...
L['ancestor_note'] = 'Получите усиление {spell:369277} (на 1 час) в палатке на |cFFFFFD00Лесной Тропе|r от |cFFFFFD00Сущности пробуждения|r чтобы увидеть предка и предложить ему нужный предмет.'
...
L['pt_script_counterfeit_darkmoon_deck_note'] = 'Поговорите с {npc:194856} и предложите помочь ей вернуть |cFFFFFD00Колоды карт Новолуния|r которые разбросаны у ее ног. Нажмите на карты в правильном порядке (от туза до 8), а затем поговорите с ней, чтобы получить колоду.'
...
L['pt_engi_boomthyr_rocket_note'] = 'Соберите предметы, перечисленные в |cFFFFFD00Инструкция к ракете Бумтир|r:\n\n{item:198815}\n{item:198817}\n{item:198816}\n{item:198814}\n\nСобрав их, верните их к ракете, чтобы получить сокровище.'
L['pt_engi_intact_coil_capacitor_note'] = 'Взаимодействeуйте с тремя |cFFFFFD00Электродами|r чтобы исправить и забрать |cFFFFFD00Перегруженную катушку Теслы|r.'
...
L['pt_smith_ancient_monument_note'] = 'Победите 4 {npc:188648}, окружающих меч на пьедестале.\n\n|cFFFF0000(БАГ: в настоящее время вы не получаете предмет после нажатия на меч, вместо этого он будет отправлен на почту через некоторое время.)|r'
L['pt_smith_curious_ingots_note'] = 'Небольшой слиток на земле в |cFFFFFD00Крепости Расколотой Чешуи|r.'
L['pt_smith_glimmer_of_blacksmithing_wisdom_note'] = 'Создайте {item:189541} рядом с |cFFFFFD00Темной кузней|r и предмет в |cFFFFFD00ящике|r станет доступным для добычи.'
...
L['pt_tailor_itinerant_singed_fabric_note'] = 'Кусок ткани, висящий на деревьях рядом с пещерой, где появляется финальный босс. ' .. ns.color.Orange('Требуется точная езда на драконе или портал чернокнижника.')
...
L['otto_note_start1'] = 'Соберите пару {item:202042}. Очки выпадают с шансом 100% из {item:202102}, который можно купить у {npc:191608} на |cFFFFFD00Равнинах Он\'ары|r.\n\nСумку можно купить за 1x {item:199340} за 5x {item:199339} за 75x {item:199338} которые можно выловить в любом месте |cFFFFFD00Драконьих Островов|r или победив |cFFFFFD00<Гигантов>|r это специальные монстры обитающие в косяках.'
L['otto_note_start2'] = ns.color.Orange('Сражение с |cFFFFFD00<Гигантами>|r открывается на 7 уровне известности с |cFFFFFD00Искарскими клыкаррами|r и дает доступ к {item:194510}.')
