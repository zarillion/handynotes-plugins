...
L['onyx_gem_cluster_note'] = 'Купите {item:200738} у {npc:189065} за 3 {item:192863} и 500 {currency:2003} на 21 уровне известности у Драконьей Экспедиции и используйте его.' -- review
L['replica_dragon_goblet_note'] = 'Купите {item:198854} у {npc:193915} в |cFFFFFD00посольстве Крылатого Приюта|r и используйте.'
