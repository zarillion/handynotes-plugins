...
['pt_script_counterfeit_darkmoon_deck_note'] = 'Поговорите с {npc:194856} и предложите помочь ей вернуть |cFFFFFD00Колоды карт Новолуния|r которые разбросаны у ее ног. Нажмите на карты в правильном порядке (от туза до 8), а затем поговорите с ней, чтобы получить колоду.'
