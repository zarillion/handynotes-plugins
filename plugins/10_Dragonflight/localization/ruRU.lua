...
L['zaralek_rotation_active'] = ns.color.Blue('Этот редкий монстр может появиться сегодня.')
L['zaralek_rotation_inactive'] = ns.color.Orange('Этот редкий монстр не появится сегодня, приходите завтра.')
