...
L['ohnahra_note_start'] = 'Выполните ежедневную цепочку заданий {quest:71196} для {item:192799} в |cFFFFFD00Ключах Он\'ир|r. Примите задание {quest:72512} от {npc:190022} за хижиной жрец ветра в |cFFFFFD00ключах Он\'ир|r.\n\nСоберите следующие материалы:'
