...
L['otto_note_start1'] = 'Соберите пару {item:202042}. Очки выпадают с шансом 100% из {item:202102}, который можно купить у {npc:191608} на |cFFFFFD00Равнинах Он\'ары|r.\n\nСумку можно купить за 1x {item:199340} за 5x {item:199339} за 75x {item:199338} которые можно выловить в любом месте |cFFFFFD00Драконьих Островов|r или победив |cFFFFFD00<Гигантов>|r это специальные монстры обитающие в рыбных лунках.'
