...
在 {location:Irontree woods} 你會找到一個巨大的 {npc:210417} 和一個 {object:Mimiron's Booster Part}.
你可以使用 {object:Mimiron's Booster Part} 來騎上元素並且使用他的技能 {spell:423412} 來把玩家吸進來, 或者是跑到足夠靠近元素 (但是不會太靠近而吃到它的範圍攻擊, 會擊退你) 讓控制元素的人可以把你吸進去.

當元素吸進4個人後, 他會爆炸並掉落 {item:209781}! 任何在附近的人都可以拾取他.]]
