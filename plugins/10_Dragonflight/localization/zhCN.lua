...
L['spawns_hourly'] = '只在整点可能出现，可能会延迟几分钟。'
...
L['shadeslash_note'] = '点击 {object:失窃的球} 或 {object:偷来的望远镜}，然后点击 {object:失窃的法器} 召唤稀有。'
...
L['otto_note_start2'] = '一旦你有了一对 {item:202042}，就可以前往位于 {location:嘶鸣海湾} 的 {location:泡泡浴} 深水酒吧找到一个跳舞垫，然后站在上面获得负面效果 {spell:396539}。一旦负面效果结束，你就会昏倒并在桶旁醒来。与它互动以拾取 {item:202061}。现在需要在桶里装满鱼来喂给 {npc:199563}。'
