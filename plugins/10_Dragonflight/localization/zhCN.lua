...
L['gem_cluster_note'] = '所需物品需要 {faction:龙鳞探险队} 声望到达21级可以从 {object:探险队斥候的背包} 和 {object:翻动过的泥土} 中找到。'
...
L['snowclaw_cub_note_start'] = '必须在 {sanctuary:瓦德拉肯} 中完成 {npc:192522} 提供的 {quest:67094} 任务线才能获得 {title:荣誉树妖} 头衔。\n\n收集以下物品：'
...
L['elder_poa_note'] = '用 {item:200071} 换取 {faction:伊斯卡拉海象人} 声望。'
...
L['hunt_instructor_basku_note'] = '用 {item:200093} 换取 {faction:马鲁克半人马} 声望。'
...
L['picante_pomfruit_cake_note'] = '{item:200904} 并非每天都可用，因此请每天查看 {sanctuary:红玉飞地}。当在那里时，一定要品尝3种可用的菜肴来完成 {achievement:16556}。'
L['icecrown_bleu_note'] = '从 {sanctuary:匠人集市} 的 {npc:196729} {title:<奶酪商贩>} 购买。'
L['dreamwarding_dripbrew_note'] = '从 {location:熬夜实验室} 的 {npc:197872} {title:<咖啡因操控师>} 购买。'
L['arcanostabilized_provisions_note'] = '从 {sanctuary:拜荒者的未来} 内的 {sanctuary:时光流汇} 的 {npc:198831} {title:<厨师长>} 购买。'
...
L['sorotis_note'] = '用 {item:199906} 换取 {faction:瓦德拉肯联军} 声望。'
L['lillian_brightmoon_note'] = '用 {item:201412} 换取 {faction:龙鳞探险队} 声望。'
...
L['onyx_gem_cluster_note'] = '{faction:龙鳞探险队} 声望到达21级，从 {npc:189065} 购买 {item:200738} 需要3个 {item:192863} 和500 {currency:2003} 并使用它。'
...
L['otto_note_start2'] = '{note:击败 {title:<大家伙>} 怪物需要7级 {faction:伊斯卡拉海象人} 声望并获得 {item:194510}。}'
...
L['cataloger_jakes_note'] = '用 {item:192055} 换取 {faction:龙鳞探险队} 声望。'
