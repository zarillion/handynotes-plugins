...
L['disturbed_dirt'] = '翻动过的泥土堆'
L['options_icons_disturbed_dirt'] = '翻动过的泥土堆'
L['options_icons_disturbed_dirt_desc'] = '显示翻动过的泥土堆的位置。'
...
L['dreamguard_note'] = '目标为梦境防御者并 ' .. ns.color.Orange('/睡觉')
