...
L['pt_ench_faintly_enchanted_remains_note'] = '点击 |cFFFFFD00缺魔水晶簇|r 出现并杀死一个怪物。然后拾取出现的水晶。'
...
L['pt_leath_treated_hides_note'] = '在 |cFFFFFD00雪皮营地|r。'
...
L['elder_poa_note'] = '用 {item:200071} 换取 |cFFFFFD00伊斯卡拉海象人|r 声望。'
...
L['porta_the_overgrown_note'] = '可以从西侧的 |cFFFFFD00镜天湖|r 湖底找到 {item:194426}，将5个 {item:194426} 撒在 {npc:191953} 后稀有出现。'
...
L['pt_leath_wind_blessed_hide_note'] = '在 |cFFFFFD00席卡尔高地|r 半人马营地。'
L['pt_script_sign_language_reference_sheet_note'] = '敲打帐篷入口。'
L['pt_smith_ancient_spear_shards_note'] = '在 |cFFFFFD00鲁萨扎尔高台|r 西侧洞穴。'
L['pt_smith_falconer_gauntlet_drawings_note'] = '海中小岛，小屋内。'
L['pt_tailor_noteworthy_scrap_of_carpet_note'] = '在一间小屋里。' .. ns.color.Orange('3个精英在屋里。')
L['pt_tailor_silky_surprise_note'] = '找到拾取一个 |cFFFFFD00猫薄荷复叶|r。'
...
L['ohnahra_note_start'] = '在 |cFFFFFD00欧恩伊尔清泉|r 完成日常任务线 {quest:71196} 获得 {item:192799}。从位于 |cFFFFFD00欧恩伊尔清泉|r 轻风贤者小屋的 {npc:190022} 领取任务 {quest:72512}。\n\n收集以下材料：'
...
L['ancestor_note'] = '在 |cFFFFFD00森步岗哨|r 的帐篷中获得 {spell:369277} 增益（1小时）来自|cFFFFFD00觉醒精华|r 以见到先祖并向他提供所需的物品。'
...
L['pt_jewel_alexstraszite_cluster_note'] = '|cFFFFFD00提尔要塞|r 内。'
L['pt_jewel_painters_pretty_jewel_note'] = '一盏灯内。'
L['pt_leath_decayed_scales_note'] = '篮子内。'
L['pt_script_counterfeit_darkmoon_deck_note'] = '与 {npc:194856} 交谈并提出帮助阻止她的 |cFFFFFD00暗月套牌|r 散落在她的脚下。按正确的顺序（A 到 8）点击卡片，然后与她交谈以获得套牌。'
...
L['sorotis_note'] = '用 {item:199906} 换取 |cFFFFFD00瓦德拉肯联军|r 声望。'
L['lillian_brightmoon_note'] = '用 {item:201412} 换取 |cFFFFFD00龙鳞探险队|r 声望。'
...
L['bubble_drifter_note'] = '{item:199061} 可以从探险队斥候的背包和翻动过的泥土中找到。'
L['dead_mans_chestplate_note'] = '塔内中层。'
L['fullsails_supply_chest_note'] = '钥匙从 |cFFFFFD00翼眠大使馆|r 以南的 {npc:187971} 和 {npc:187320} 掉落。'
...
L['pt_ench_flashfrozen_scroll_note'] = '|cFFFFFD00闪霜飞地|r 洞穴系统内部。'
L['pt_ench_lava_infused_seed_note'] = '|cFFFFFD00碎鳞要塞|r 一朵花里。'
L['pt_engi_boomthyr_rocket_note'] = '收集 |cFFFFFD00轰希尔火箭笔记|r 中列出的物品：\n\n{item:198815}\n{item:198817}\n{item:198816}\n{item:198814}\n\n收集后，带上它们回到火箭去领取宝藏。'
L['pt_engi_intact_coil_capacitor_note'] = '与三个 |cFFFFFD00裸露的电线|r 互动以修复和拾取 |cFFFFFD00超载的电磁圈|r。'
...
L['cataloger_jakes_note'] = '用 {item:192055} 换取 |cFFFFFD00龙鳞探险队|r 声望。'
