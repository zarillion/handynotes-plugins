...
L['spider_hill_note'] = [[Atteignez le point le plus haut du {location:Nid de la veuve}.
...
L['fiery_lords_note'] = 'Un seul {npc:Seigneur des tisons} est actif à la fois, après l\'avoir tué, le suivant apparaîtra immédiatement.'
L['have_we_met_note'] = [[Un groupe de combattants d'élite vous assistera lors de la quête journalière à votre arrivée au {location:Perchoir de Sethria}.

Utilisez l'emote {emote:/wave} pour faire signe au PNJ requis.]]
L['ludicrous_speed_note'] = [[Pendant la quête {daily:29147}, obtenez 65 charges de {spell:100957}.
