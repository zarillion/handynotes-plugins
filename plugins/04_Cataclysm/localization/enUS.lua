...
L['spider_hill_note'] = [[Reach the highest point in the {location:Widow's Clutch}.
...
L['fiery_lords_note'] = 'Only one {npc:Lord of Cinders} is up at a time, after killing it the next will spawn immediately.'
L['have_we_met_note'] = [[An elite group of fighters will assist you at the daily quest as you arrive in {location:Sethria's Roost}.

Use the emote {emote:/wave} to wave to the required NPC.]]
L['ludicrous_speed_note'] = [[While on the quest {daily:29147}, obtain 65 stacks of {spell:100957}.
