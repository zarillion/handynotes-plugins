...
map.nodes[56712795] = ns.node.Dragonrace({
    ...
    rewards = {
        ...
        Achievement({id = 17714, criteria = 3, oneline = true}), -- normal gold
        Achievement({id = 17715, criteria = 3, oneline = true}), -- advanced bronze
        Achievement({id = 17716, criteria = 3, oneline = true}), -- advanced silver
        Achievement({id = 17717, criteria = 3, oneline = true}), -- advanced gold
...
map.nodes[21965429] = ns.node.Dragonrace({
    ...
    rewards = {
        ...
        Achievement({id = 17714, criteria = 4, oneline = true}), -- normal gold
        Achievement({id = 17715, criteria = 4, oneline = true}), -- advanced bronze
        Achievement({id = 17716, criteria = 4, oneline = true}), -- advanced silver
        Achievement({id = 17717, criteria = 4, oneline = true}), -- advanced gold
