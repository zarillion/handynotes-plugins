...
L['arcavellus_note'] =
    '击杀 {npc:90242} 和 {npc:90243} 直到稀有出现。'
L['beacher_note'] =
    '当世界任务 {wq:海拉加尔登陆战：灰色浅滩} 激活时不出现。'
L['brogozog_note'] = '和 {npc:91097} 交谈。'
L['chief_bitterbrine_note'] = '位于船下层甲板。'
L['devious_sunrunner_note'] =
    '使用小洞穴内的魔网传送门。别忘了拾取宝箱。'
L['doomlord_kazrok_note'] = '和 {npc:91580} 交谈。'
L['felwing_note'] =
    '和 {npc:105913} 交谈并击杀 {npc:105919} 直到稀有出现。'
L['golza_note'] =
    '吹响海妖号角并击杀 {npc:90774} 和 {npc:90778} 直到稀有出现。'
L['infernal_lord_note'] =
    '点击地狱火宝箱并击杀 {npc:90797} 直到稀有出现。'
...
L['shoe_shine_kit_note'] = '每个星期六晚上的午夜零时（' .. tz ..
                               '）{npc:97003} 将他的箱子丢在地上几小时并离开。'
L['wand_simulated_life_note'] = '楼上的桌子上。'

L['sir_galveston_note'] =
    '你准备好了吗，奔波尔斯顿爵士？勇敢地战斗吧！'
...
L['treasure_39074'] = '树下。'
L['treasure_39080'] =
    '地下室内。需要开始任务线开始于 {npc:92688} 的 {quest:38643} 任务然后是 {npc:92683} 的 {quest:38644}。'
