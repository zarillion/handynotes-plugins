...
L['arcavellus_note'] =
    'Mata las {npc:90242} y las {npc:90243} hasta que aparezca {npc:90244}.'
L['beacher_note'] =
    'Cuando la misión del mundo {wq:Desembarco Helarjar: Marisma Gris} esté activa, no estará {npc:91187}.'
L['brogozog_note'] = 'Habla con {npc:91097}.'
L['chief_bitterbrine_note'] = 'En el barco, en la cubierta inferior.'
L['devious_sunrunner_note'] =
    'Usa el Portal Ley en una cueva pequeña y no te de olvides despojar el cofre.'
L['doomlord_kazrok_note'] = 'Habla con {npc:91580}.'
L['felwing_note'] =
    'Habla con {npc:105913} y mata {npc:105919} hasta que aparezca {npc:105938}.'
L['golza_note'] =
    'Sopla el Cuerno de la Sirena y mata {npc:90774} y {npc:90778} hasta que aparezca {npc:89816}.'
L['infernal_lord_note'] =
    'Haz click en el Alijo de Infernales y mata {npc:90797} hasta que aparezca el {npc:90803}.'
L['inquisitor_tivos_note'] =
    'Usa el Portal de la Legión. Está en el piso inferior.'
...
L['seemingly_unguarded_treasure_note'] =
    'Intenta despojar el tesoro y entonces matar algunas oleadas de {npc:94167}.'
...
L['shoe_shine_kit_note'] = 'Cada noche del Sábado al Domingo a medianoche (' ..
                               tz ..
                               ') {npc:97003} soltará su cofre en el suelo unas horas y se irá.'
...
L['master_tamer_flummox_note'] =
    '¡Flummox no necesita mascotas! ¡Flummox se las come AHORA!'
...
L['anthydas_note'] =
    'Despoja el cofre del tesoro del segundo piso del edificio, junto al fregadero.'
L['elandris_note'] =
    'Cuando, durante una invasión de la legión, la misión del mundo {wq:El valle tenebroso} está activa, no estará {npc:109225}.'
L['gathenak_note'] = 'Habla con {npc:112472}.'
L['gorebeak_note'] = 'Habla con {npc:92111}.'
L['jinikki_note'] =
    'Habla con el {npc:93677} y mata {npc:93684} hasta que aparezca {npc:93686}.'
...
L['treasure_38387'] =
    'En una cueva pequeña debajo de la posada. La entrada está detrás del edificio.'
...
L['treasure_39080'] =
    'En el sótano. Necesitas empezar una cadena de misiones. Comienza con {quest:38643} dada por {npc:92688} y seguida por {quest:38644} que la da {npc:92683}.'
...
L['general_pet_tamer_note'] = ns.color.Orange(
    'Sólo aparece cuando la misión del mundo para él está disponible.')
