...
L['arcavellus_note'] =
    'Kill {npc:90242s} and {npc:90243s} until the rare appears.'
L['beacher_note'] =
    'Not available when the {wq:Helarjar Landing: Grey Shoals} world quest is active.'
L['brogozog_note'] = 'Speak with {npc:91097}.'
L['chief_bitterbrine_note'] = 'In the ship on the lower deck.'
L['devious_sunrunner_note'] =
    'Use the Ley Portal in a small cave. Don\'t forget to loot the chest.'
L['doomlord_kazrok_note'] = 'Speak with {npc:91580}.'
L['felwing_note'] =
    'Speak with {npc:105913} and then kill {npc:105919s} until the rare appears.'
L['golza_note'] =
    'Blow the Horn of the Siren, then kill {npc:90774s} and {npc:90778s} until the rare appears.'
L['infernal_lord_note'] =
    'Click the Cache of Infernals and kill {npc:90797s} until the rare appears.'
...
L['seemingly_unguarded_treasure_note'] =
    'Try to loot the treasure and then kill a few waves of {npc:94167s}.'
...
L['shoe_shine_kit_note'] = 'Every Saturday night at midnight (' .. tz ..
                               ') {npc:97003} will drop his chest on the ground for a couple hours and leave.'
...
L['anthydas_note'] =
    'Loot the treasure chest on the second floor of the building next to the sink.'
L['elandris_note'] =
    'Not available when the legion invasion world quest {wq:The Vale of Dread} is active.'
L['gathenak_note'] = 'Speak with {npc:112472}.'
L['gorebeak_note'] = 'Speak with {npc:92111}.'
L['jinikki_note'] =
    'Speak with {npc:93677} and kill {npc:93684s} until the rare appears.'
...
L['treasure_38387'] =
    'In an small cave under the inn. The entrance is behind the building.'
...
L['treasure_39080'] =
    'In the basement. You need to start a questline beginning with {quest:38643} from {npc:92688} followed by {quest:38644} from {npc:92683}.'
...
L['general_pet_tamer_note'] = ns.color.Orange(
    'Only appears when the corresponding world quest is active.')
