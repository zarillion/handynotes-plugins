...
map.nodes[62807480] = ns.node.Safari.AuburnRingtail({
    pois = {
        POI({
            ...
            60807040, 60807120, 61007340, 61807560, 62007420, 62407540,
            62607240, 62608360, 62807480, 63007140, 63607320, 63807400,
            64008720, 64407180, 64807120, 65206620, 65406760
        })
    }
})
...
map.nodes[55606860] = ns.node.Safari.GleamhoofFawn({
    pois = {
        POI({
            ...
            53007140, 53007160, 53405160, 53406960, 53805080, 53807320,
            54007380, 54807240, 54807260, 55007380, 55407460, 55606860,
            55607480, 55806720, 56208240, 56406600, 56408580, 56806420,
            56806460, 56808120, 57205920, 57206660, 57408460, 57806580,
            58007340, 58406480, 59009000, 59608760, 60208580, 62008220
        })
    }
})
...
map.nodes[54608620] = ns.node.Safari.ShimmeringAquafly({
    pois = {
        POI({
            ...
            53208000, 53608440, 53608460, 54007960, 54008300, 54208160,
            54408680, 54608100, 54608340, 54608620, 54608680, 54808220,
            55208380, 55208540
        })
    }
})
...
map.nodes[49006860] = ns.node.Safari.SpringStrider({
    pois = {
        POI({
            ...
            46807020, 48207020, 48406940, 49006860, 49407020, 49606940, 49806980
        })
    }
})
...
map.nodes[62603800] = ns.node.Safari.TerrorLarva({
    pois = {
        POI({
            ...
            58204480, 59604520, 60005080, 60404720, 61205180, 61405860,
            61604360, 62405860, 62603800, 62804320, 63403560, 66204720,
            68605320, 69005140
        })
    }
})
...
map.nodes[65207220] = ns.node.Safari.ValeFlitter({
    pois = {
        POI({
            ...
            56208540, 57007780, 57606180, 58607740, 59408340, 60007760,
            60607700, 60607780, 61007900, 65207220, 69803420, 70203760,
            70204380, 71203520, 71604640, 72804280
        })
    }
})
