...
map.nodes[41953647] = Rare({
    ...
    rewards = {Achievement({id = 12941, criteria = 41714})}
}) -- Ancient Sarcophagus
...
map.nodes[27561420] = Rare({
    ...
    pois = {Path({28301415, 27561420, 26781427})}
}) -- Captain Leadfist
...
map.nodes[52074697] = Rare({
    ...
    rewards = {Achievement({id = 12941, criteria = 41715})}
}) -- Cottontail Matron
...
map.nodes[55605181] = Treasure({
    ...
    rewards = {
        Achievement({id = 12995, criteria = 41703}), Item({item = 163790}), -- Spooky Incantation
...
map.nodes[25452417] = Treasure({
    ...
    rewards = {
        Achievement({id = 12995, criteria = 41705}), Item({item = 163796}), -- Wolf Pup Spine
        Pet({item = 163497, id = 2411}) -- Wicker Pup
    }
}) -- Enchanted Chest
...
map.nodes[67767367] = Treasure({
    ...
    note = L['wicker_pup_note'],
    rewards = {
        Achievement({id = 12995, criteria = 41704}), Item({item = 163791}), -- Miniature Stag Skull
        Pet({item = 163497, id = 2411}) -- Wicker Pup
    }
}) -- Ensorcelled Chest
...
map.nodes[18515133] = Treasure({
    ...
    note = L['wicker_pup_note'],
    rewards = {
        Achievement({id = 12995, criteria = 41702}), Item({item = 163789}), -- Bundle of Wicker Sticks
        Pet({item = 163497, id = 2411}) -- Wicker Pup
    }
}) -- Hexed Chest
...
map.nodes[63306585] = Treasure({
    ...
    rewards = {
        Achievement({id = 12995, criteria = 41699}), Item({item = 163743}) -- Drust Soulcatcher
    }
}) -- Runebound Cache
...
map.nodes[44222770] = Treasure({
    ...
    rewards = {
        Achievement({id = 12995, criteria = 41700}), Toy({item = 163742}) -- Heartsbane Grimoire
    }
}) -- Runebound Chest
...
map.nodes[33687173] = Treasure({
    ...
    rewards = {
        Achievement({id = 12995, criteria = 41701}), Toy({item = 163740}) -- Drust Ritual Knife
    }
}) -- Runebound Coffer
...
map.nodes[33713008] = Treasure({
    quest = 53356,
    rewards = {Achievement({id = 12995, criteria = 41697})}
}) -- Web-Covered Chest
...
map.nodes[30223362] = Supply({quest = 55408, fgroup = 'supply_path_1'})
map.nodes[31812232] = Supply({
    quest = 55408,
    fgroup = 'supply_path_1',
    pois = {Arrow({33750842, 27005679})}
})
map.nodes[33051346] = Supply({quest = 55408, fgroup = 'supply_path_1'})

map.nodes[53422897] = Supply({quest = 55408, fgroup = 'supply_path_2'})
map.nodes[58104270] = Supply({
    quest = 55408,
    fgroup = 'supply_path_2',
    pois = {Arrow({66006663, 50001873})}
})
map.nodes[62825711] = Supply({quest = 55408, fgroup = 'supply_path_2'})
...
map.nodes[19065787] = Stele({
    rewards = {Achievement({id = 13064, criteria = 41443})}
}) -- Drust Stele: The Cycle

map.nodes[27354833] = Stele({
    rewards = {Achievement({id = 13064, criteria = 41438})}
}) -- Drust Stele: The Tree

map.nodes[27605760] = Stele({
    rewards = {Achievement({id = 13064, criteria = 41441})}
}) -- Drust Stele: Sacrifice

map.nodes[36806450] = Stele({
    rewards = {Achievement({id = 13064, criteria = 41436})}
}) -- Drust Stele: The Circle

map.nodes[44584566] = Stele({
    note = L['stele_forest_note'],
    rewards = {Achievement({id = 13064, criteria = 41449})},
    pois = {
...
map.nodes[46453723] = Stele({
    rewards = {Achievement({id = 13064, criteria = 41445})}
}) -- Drust Stele: Conflict

map.nodes[50144232] = Stele({
    rewards = {Achievement({id = 13064, criteria = 41442})}
}) -- Drust Stele: Constructs

map.nodes[50777371] = Stele({
    rewards = {Achievement({id = 13064, criteria = 41437})}
}) -- Drust Stele: The Ritual

map.nodes[56558583] = Stele({
    rewards = {Achievement({id = 13064, criteria = 41446})}
}) -- Drust Stele: The Flayed Man

map.nodes[59396668] = Stele({
    rewards = {Achievement({id = 13064, criteria = 41439})}
