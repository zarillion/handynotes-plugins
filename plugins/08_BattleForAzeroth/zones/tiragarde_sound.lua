...
map.nodes[74917894] = Rare({
    id = 132182,
    quest = 50156,
    rewards = {Achievement({id = 12939, criteria = 41793})}
}) -- Auditor Dolp
...
map.nodes[61786275] = Treasure({
    quest = 52867,
    note = L['in_small_cave'],
    rewards = {Achievement({id = 12852, criteria = 41015})}
...
map.nodes[56033319] = Treasure({
    quest = 52866,
    rewards = {Achievement({id = 12852, criteria = 41014})}
...
bor.nodes[63270617] = Treasure({
    ...
    note = L['in_small_cave'],
    parent = map.id,
    rewards = {Achievement({id = 12852, criteria = 41016})}
}) -- Scrimshaw Cache
...
local Scroll = Class('Scroll', Treasure, {
    ...
    label = L['damp_scroll'],
    rewards = {
        Achievement({id = 12852, criteria = 41017}), Toy({item = 161342}) -- Gem of Acquiescence
    }
})
...
map.nodes[43802080] = Supply({quest = 55411, fgroup = 'supply_path_1'})
map.nodes[49482106] = Supply({quest = 55411, fgroup = 'supply_path_1'})
...
map.nodes[77538379] = Supply({quest = 55411, fgroup = 'supply_path_2'})
map.nodes[78278989] = Supply({quest = 55411, fgroup = 'supply_path_2'})
...
map.nodes[88628019] = PetBattle({
    id = 141215,
    rewards = {Achievement({id = 12936, criteria = 44218})}
}) -- Unbreakable (Chitara)
...
bor.nodes[66806410] = Citizen({
    id = 145107,
    rewards = {
        Achievement({id = 13285, criteria = 43720}), Toy({item = 166247}) -- Citizens Brigade Whistle
    }
}) -- Leeroy Jenkins
...
bor.nodes[72306160] = Citizen({
    id = 146295,
    rewards = {
        Achievement({id = 13285, criteria = 43719}), Toy({item = 166247}) -- Citizens Brigade Whistle
    }
}) -- Flynn Fairwind
...
map.nodes[80602360] =
    Safari.CoastalBounder({pois = {POI({80602360, 80802340})}}) -- Coastal Bounder

map.nodes[77608580] = Safari.GiantWoodworm({
    pois = {
        POI({
            50203580, 53003620, 54801960, 54803320, 55001700, 55001880,
            55203640, 55403500, 55603520, 55801580, 55801660, 55801820,
            57401540, 58201660, 58401500, 58401560, 58801560, 76208140,
            76208160, 77208160, 77608580, 78807160, 78807560, 80007240,
            81207200, 81207320, 82207200, 82807280, 83407600, 84007280,
            84407480, 84607760, 85208120, 85408040, 85608040, 85608180,
            86208260, 86408080, 87408020, 88207500, 88207560, 88808000
        })
    }
}) -- Giant Woodworm

map.nodes[84403720] = Safari.HermitCrab({
    pois = {
        POI({
            56207240, 56807200, 57204960, 57807620, 58205200, 58404900,
            58407280, 58407360, 61403140, 61804580, 62203100, 62803080,
            62804760, 63203040, 64602860, 64802820, 65202740, 66202620,
            69804280, 71204520, 72004340, 72004500, 72404640, 72604620,
            73804680, 74004760, 75204880, 84203920, 84403720, 84804740,
            86003900, 86004280, 86203840, 86204680, 87404940, 87604940,
            88404980, 88405160, 88405360, 89205100, 89604940
        })
    }
}) -- Hermit Crab

map.nodes[56601560] = Safari.ParasiticBoarfly({
    pois = {
        POI({
            55201660, 55201800, 55401420, 55401640, 55601420, 55601700,
            55601800, 55801580, 56201520, 56601540, 56601560, 56801700,
            57401420, 58001460
        })
    }
}) -- Parasitic Boarfly

map.nodes[82603220] = Safari.SandybackCrawler({
    pois = {
        POI({
            31001940, 32001940, 34402140, 34602240, 34602360, 34602460,
            35202280, 57207180, 58007400, 60208500, 61408560, 69208000,
            81202280, 81402380, 81803280, 82603220, 84203900, 85404180,
            85603880, 86204300, 86404640, 86404980, 87805160, 88005000,
            88205280, 88804960, 90607560
        })
    }
}) -- Sandyback Crawler

bor.nodes[63201680] = Safari.SandybackCrawler({
    pois = {POI({62201600, 62601620, 63201680, 74602440})},
    parent = map.id
}) -- Sandyback Crawler

map.nodes[54405340] = Safari.ShackCrab({
    pois = {
        POI({
            28602840, 29002640, 29202520, 29602600, 29602720, 30002880,
            31201980, 31402900, 31602860, 32802300, 35202660, 39002740,
            39802900, 39803040, 40003100, 40402800, 40403240, 40603240,
            40803040, 40803080, 53205400, 54405340, 54607240, 57607100,
            58405680, 58406940, 58606940, 59605940, 65005020, 67404840,
            67405020, 67604840, 67605000, 67804740, 68804680, 69402060,
            69804600, 70402060, 70804600, 72204640, 72204660, 74005040,
            74405080, 74405160, 74605140, 74605180, 75604820, 77004800
        })
    }
}) -- ShackCrab

bor.nodes[76202360] = Safari.ShackCrab({
    pois = {
        POI({
            57401100, 59601260, 60001240, 62401600, 62801640, 63201680,
            63601700, 76202340, 76202360, 76202780
        })
    },
    parent = map.id
}) -- ShackCrab
...
map.nodes[46202200] = ns.node.Safari.SlitheringBrownscale({
    pois = {
        POI({
            ...
            45402200, 45601780, 45802260, 46001940, 46202200, 46601800,
            46601920, 47002180, 47401700, 47602100, 47801740, 49201940
        })
    }
})
