...
map.nodes[49028903] = Rare({
    ...
    quest = 49252,
    note = L['in_cave'],
    rewards = {Achievement({id = 12943, criteria = 41608})},
    pois = {
...
map.nodes[46598801] = Treasure({
    ...
    rewards = {Achievement({id = 12849, criteria = 40966})}
}) -- Ashvane Spoils

map.nodes[40578574] = Treasure({
    quest = 52994,
    rewards = {Achievement({id = 12849, criteria = 41003})}
}) -- Deadwood Chest

map.nodes[57746464] = Treasure({
    quest = 51136,
    note = L['excavators_greed_note'],
    rewards = {Achievement({id = 12849, criteria = 40971})}
}) -- Excavator's Greed

map.nodes[48186469] = Treasure({
    quest = 51093,
    note = L['grayals_offering_note'],
    rewards = {Achievement({id = 12849, criteria = 40967})},
    pois = {
...
map.nodes[49787940] = Treasure({
    quest = 51132,
    note = L['in_small_cave'],
    rewards = {Achievement({id = 12849, criteria = 40968})}
}) -- Lost Explorer's Bounty

map.nodes[57061121] = Treasure({
    quest = 52992,
    note = L['kimbul_offerings_note'],
    rewards = {Achievement({id = 12849, criteria = 41002})}
}) -- Lost Offerings of Kimbul

map.nodes[47195846] = Treasure({
    quest = 51133,
    rewards = {Achievement({id = 12849, criteria = 40969})}
}) -- Sandfury Reserve

map.nodes[26484535] = Treasure({
    quest = 53004,
    note = L['sandsunken_note'],
    rewards = {Achievement({id = 12849, criteria = 41004})}
}) -- Sandsunken Treasure

map.nodes[44502613] = Treasure({
    quest = 51135,
    rewards = {Achievement({id = 12849, criteria = 40970})}
}) -- Stranded Cache

map.nodes[29388742] = Treasure({
    quest = 51137,
    rewards = {Achievement({id = 12849, criteria = 40972})}
...
local SECRET_CHEST = ns.node.SecretSupply({
    quest = 55389,
    rewards = {Achievement({id = 13317, criteria = 43935})}
...
map.nodes[53406720] = Supply({quest = 55412, fgroup = 'supply_path_1'})
map.nodes[53804660] = Supply({quest = 55412, fgroup = 'supply_path_1'})
...
map.nodes[62903400] = Supply({quest = 55412, fgroup = 'supply_path_2'})
map.nodes[67602620] = Supply({quest = 55412, fgroup = 'supply_path_2'})
...
map.nodes[30526194] = PetBattle({
    id = 141969,
    rewards = {Achievement({id = 12936, criteria = 44226})}
...
map.nodes[26585492] = PetBattle({
    ...
    note = L['sizzik_note'],
    rewards = {
        Achievement({id = 12936, criteria = 44228}), ns.reward.Spacer(),
...
map.nodes[45134642] = PetBattle({
    ...
    note = L['kusa_note'],
    rewards = {
        Achievement({id = 12936, criteria = 44227}), ns.reward.Spacer(),
...
map.nodes[57134896] = PetBattle({
    ...
    note = L['keeyo_note'],
    rewards = {
        Achievement({id = 12936, criteria = 44225}), ns.reward.Spacer(),
...
map.nodes[42206206] = Collectible({
    ...
    rewards = {Achievement({id = 13036, criteria = 41564})}
...
map.nodes[27706205] = Collectible({
    ...
    rewards = {Achievement({id = 13036, criteria = 41570})}
...
map.nodes[49592446] = Collectible({
    ...
    rewards = {Achievement({id = 13036, criteria = 41574})}
...
map.nodes[53189164] = Collectible({
    ...
    rewards = {Achievement({id = 13020, criteria = 41497})}
}) -- Akunda
...
map.nodes[56571023] = Collectible({
    ...
    sublabel = L['bow_to_your_masters_note'],
    group = ns.groups.BOW_TO_YOUR_MASTERS,
    rewards = {Achievement({id = 13020, criteria = 41499})}
}) -- Kimbul
...
map.nodes[27185257] = Collectible({
    ...
    sublabel = L['bow_to_your_masters_note'],
    group = ns.groups.BOW_TO_YOUR_MASTERS,
    rewards = {Achievement({id = 13020, criteria = 41503})}
}) -- Sethraliss
...
local DuneRider = Class('DuneRider', Collectible, {
    ...
    rewards = {
        Achievement({
            id = 13018,
            criteria = {{id = 1, qty = true, suffix = L['planks_ridden']}}
        })
    },
...
map.nodes[45746360] = DuneRider({
    ...
    pois = {
        Path({
            47916247, 47616221, 47106220, 46886272, 45936272, 46086301, 45746360
        })
    }
}) -- Drop Off
...
map.nodes[61900950] = Collectible({
    ...
    note = L['stompy_note'],
    rewards = {Achievement({id = 13029, criteria = 41578})},
    pois = {
        POI({40405540}) -- Rikati
    }
}) -- Ol' Stompy
...
map.nodes[46984655] = Collectible({
    ...
    rewards = {Achievement({id = 12482, criteria = 40045})}
...
map.nodes[56271527] = Collectible({
    ...
    group = ns.groups.GET_HEKD,
    rewards = {Achievement({id = 12482, criteria = 40046})}
...
map.nodes[42187208] = Collectible({
    ...
    group = ns.groups.GET_HEKD,
    rewards = {Achievement({id = 12482, criteria = 40048})}
}) -- Saurid Surprise
...
map.nodes[49368440] = Collectible({
    ...
    group = ns.groups.GET_HEKD,
    rewards = {Achievement({id = 12482, criteria = 40047})}
...
map.nodes[61001820] = Collectible({
    ...
    rewards = {Achievement({id = 13027, criteria = 41392})}
}) -- Portakillo
...
map.nodes[29465938] = ScavengerOfTheSands({
    quest = 53137,
    rewards = {Achievement({id = 13016, criteria = 41347})}
}) -- Skye's Pet Rock (163326)

map.nodes[47067577] = ScavengerOfTheSands({
    quest = 53140,
    rewards = {Achievement({id = 13016, criteria = 41350})}
...
map.nodes[52758373] = ns.node.Squirrel({
    id = 134700,
