...
L["dunewalker"] = "Clique sur le bouton sur la plateforme au dessus pour le libérer."
L["friendly_alpaca"] = "Nourris l'alpaga Légumes de Gersahl sept fois pour obtenir la monture Alpaga toison-vernale. Il reste au même endroit pendant dix minutes, puis un long respawn."
L["gaze_of_nzoth"] = "Il partage un spawn avec Observateur fétide."
L["gersahl_note"] = "Donne le au Alpaga amical sept fois pour obtenir une monture. Cela ne nécessite pas d'Herboristerie."
