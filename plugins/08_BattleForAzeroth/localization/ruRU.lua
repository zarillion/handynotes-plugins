...
L['idej_note'] = 'Сбейте его заклинание {spell:274005}, иначе он может убить {npc:139380}!'
...
L['glimmershell_note'] = 'Небольшой шанс появления на месте {npc:152426}.'
...
L['pyre_amalgamated'] = 'Активируйте костер, затем убейте все слияния, пока не появится Слияние Плоти.'
...
L['mail_muncher'] = 'При открытии почтового ящика может появиться {npc:160708}.'
