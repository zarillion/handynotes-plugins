...
L['idej_note'] =
    '昏迷他施放的 {spell:274005} 否则他会杀了 {npc:139380}！'
...
L['merchants_chest_note'] =
    '击杀附近持有钥匙的 {npc:137468} 以获得 {item:163710}。'
L['wicker_pup_note'] = [[
...
L['dilbert_mcclint_note'] =
    '嗨，害虫防治专家呆伯特·麦克林特向您报道。非常高兴能和一位像我一样的蜘蛛爱好者一较高下。'
L['fizzie_spark_note'] =
    '你觉得你的宠物有机会打败我注入了艾泽里特的队伍？想得美！'
...
L['options_icons_drust_facts_desc'] =
    '显示 {achievement:13064} 成就中石碑的位置。'
L['options_icons_drust_facts'] = '{achievement:13064}'

L['embers_crossbow_note'] =
    '两棵树中间的地上拾取 {item:163749}，然后把它带回戈尔瓦遗迹。'
L['embers_flask_note'] =
    '两块岩石中间的水里拾取 {item:163746}，然后把它带回戈尔瓦遗迹。'
L['embers_hat_note'] =
    '一堆骨头中拾取 {item:163748}，然后把它带回戈尔瓦遗迹。'
L['embers_knife_note'] =
    '从树干中拉出 {item:163747}，然后把它带回戈尔瓦遗迹。'
L['embers_golvar_note'] =
    '把每个古物放回戈尔瓦遗迹后完成成就。'
L['golvar_ruins'] = '戈尔瓦遗迹'
L['options_icons_ember_relics_desc'] =
    '显示 {achievement:13082} 成就中古物的位置。'
L['options_icons_ember_relics'] = '{achievement:13082}'

L['linda_deepwater_note'] =
    '要获得访问权限，必须完成就在安利港外面 {npc:136458} 的任务线。'
...
L['avenger_note'] =
    '当 {npc:155254} 是访客时，击杀 {npc:151159}（在全地图跑）来刷新。'
L['beastbot_note'] = '在 {npc:150359} 制作一个 {item:168045} 来激活。'
L['cogstar_note'] =
    '在任意区域内击 {npc:150667} 直到他传送来加强它们。'
L['crazed_trogg_note'] =
    '在邦多的大杂院使用 {npc:154573} 或颜料囊袋，把自己染色成他大喊的颜色然后去找他。'
L['deepwater_note'] = '在 {npc:150359} 制作一个 {item:167649} 来召唤。'
L['doppel_note'] =
    '与其他两名玩家，使用 {daily:56405} 获得的 {item:169470} 来激活。'
L['foul_manifest_note'] = '连接三个断路器到水中的能量塔。'
L['furor_note'] =
    '在 {daily:55463} 期间，点击蓝色小 {npc:135497} 直到它刷新。'
L['killsaw_note'] =
    '在瀑溪森林任何地方出现，似乎因为击杀 {npc:151871} 后比较容易刷新。不会在风险投资公司在森林里时刷新，那时候没有 {npc:151871}。'
...
L['rusty_note'] =
    '在 {npc:150359} 制作一个 {item:169114} 进入平行未来时空。只在 {npc:153993} *不是*锈栓镇访客期间才会刷新。'
L['vaultbot_note'] =
    '风筝到邦多的大杂院的电磁圈或在 {npc:150359} 制作一个 {item:167062} 来打开它。'
...
L['rec_rig_note'] =
    '要激活困难模式，使用 {spell:292352} 武器將所有 {npc:150825} 转换为 {npc:151049}。宠物可以在两种难度获得。'

L['grease_bot_note'] =
    '点击 {npc:155911} 获取急速提高5%，移动速度提高10%持续2小时。'
L['shock_bot_note'] =
    '点击 {npc:155909} 获取闪电链伤害持续2小时。'
L['welding_bot_note'] =
    '点击 {npc:155910} 增加生命值和承受治疗效果提高10%持续2小时。'

L['options_icons_mech_buffs'] = '增益机器人'
L['options_icons_mech_buffs_desc'] =
    '显示 {npc:155911}、{npc:155909} 和 {npc:155910} 在地下城内地图上的位置。'
L['options_icons_mech_chest'] = '机械补给箱'
L['options_icons_mech_chest_desc'] =
    '显示机械补给箱的位置。有10个独立的箱子可以每日拾取一次，每个箱子有4-5个刷新位置。位置按颜色分组。'
...
L['rockweed_note'] =
    '击杀整个区域的 {npc:152549} 和 {npc:151166} 直到它刷新。建议组团，因为这可能需要很长时间。'
L['sandcastle_note'] =
    '使用 {item:167077} 在区域内任何地方探测宝箱直到它刷新。'
L['tidelord_note'] =
    '击杀三个 {npc:145326} 和被召唤的 {npc:153999} 直到海潮领主被召唤出来。'
...
L['prismatic_crystal_note'] =
    '用它喂食小动物给纳沙塔尔的 {npc:151782}。'
L['strange_crystal'] = '奇怪的水晶'
L['strange_crystal_note'] =
    '解锁 {item:167893} 刷新，必须在此位置先拾取 {item:169778} 并把它上交 {quest:56560}。'
L['options_icons_prismatics'] = '{item:167893}'
L['options_icons_prismatics_desc'] =
    '显示喂食 {npc:151782} 的 {item:167893} 的位置。'

L['slimy_cocoon'] = '粘糊糊的茧'
L['ravenous_slime_note'] =
    '使用 {item:167893} 魅惑小动物喂养茧。重复五天直到它刷新一个宠物的蛋。茧会消失直到下周重置。'
L['slimy_cocoon_note'] =
    '一只宠物可以从茧中收集！如果它没有出现，茧在这个位面正在冷却，更换位面或稍后再来检查。'

L['cat_figurine'] = '水晶猫咪雕像'
L['cat_figurine_01'] =
    '在一个水下洞穴。雕像在露天的地板上。入口在东侧。'
L['cat_figurine_02'] =
    '在附近瀑布下的一个洞穴里。雕像在墙上的海星下面。'
L['cat_figurine_03'] =
    '在一个水下洞穴。雕像被藏在某些破碎的贝壳下。'
L['cat_figurine_04'] = '在一个水下洞穴。雕像在露天的地板上。'
L['cat_figurine_05'] =
    '在一个小洞穴。雕像隐藏在地板上的植物后面。'
L['cat_figurine_06'] =
    '在一个充满敌对的礁石行者的水下洞穴中。小雕像在墙上。入口在北侧。'
L['cat_figurine_07'] = '在一个小洞穴。雕像在一些珊瑚的墙上。'
L['cat_figurine_08'] =
    '在一个小洞穴。躲避奥术陷阱。雕像在后面的高大的岩石上。'
L['cat_figurine_09'] =
    '在一个水下洞穴。雕像位于天花板的岩石拱门上。'
L['cat_figurine_10'] =
    '在路径下方的一个洞穴里。雕像在三个桶之间。'
...
L['options_icons_carved_in_stone_desc'] =
    '显示 {achievement:13024} 成就中象形图画的位置。'
...
L['options_icons_hoppin_sad_desc'] =
    '显示 {achievement:13028} 成就中 {npc:143317} 的位置。'
...
L['sabertron_note'] =
    '击杀 {npc:139334} 来激活 {npc:139328} 其中之一。'
...
L['eddie_fixit_note'] =
    '准备面对我的高度定制版改装机器人小队吧！'
L['ellie_vern_note'] =
    '但我有海洋中最强的生物为我而战，你根本不可能赢。'
L['leana_darkwind_note'] =
    '我怀疑这片大陆的奇怪生物也会带来奇怪的战斗。'

L['honeyback_harvester_note'] =
    '和 {npc:155193} 交谈开始事件。新鲜的蜜胶块每小时可以拾取一次，一小时后重置。'
L['options_icons_honeybacks'] = '{npc:155193}'
L['options_icons_honeybacks_desc'] =
    '显示收割蜜背蜂群声望的 {npc:155193} 事件位置。'

L['lets_bee_friends_note'] =
    '完成 {daily:53371} 七次后获得成就和宠物。并解锁日常：'
L['lets_bee_friends_step_1'] =
    '完成米登霍尔蜜酒庄任务线直到 {quest:50553}。'
L['lets_bee_friends_step_2'] =
    '在米登霍尔蜜酒庄击杀 {npc:133429} 和 {npc:131663} 直到找到 {item:163699}。'
L['lets_bee_friends_step_3'] =
    '把 {item:163699} 交给位于伯拉勒斯 {npc:143128}。'
L['lets_bee_friends_step_4'] =
    '把 {item:163702} 交给位于米登霍尔蜜酒庄 {npc:133907}。'
L['lets_bee_friends_step_5'] = '完成 {npc:133907} 的 {quest:53347}。'

local luncheon = (UnitFactionGroup('player') == 'Alliance') and
                     '{npc:138221} 位于布伦纳丹' or
                     '{npc:138096} 位于战牙要塞'
L['these_hills_sing_note'] =
    '在这里打开 {item:160485}。从' .. luncheon ..
        '购买或者从布伦纳丹的“被丢弃的午餐盒”拾取宝藏。'
...
L['options_icons_tidesage_legends_desc'] =
    '显示 {achievement:13051} 成就中古代卷轴的位置。'

L['long_forgotten_rum_note'] =
    '要进入洞穴，必须完成位于死亡浅滩 {npc:134710} 的 {quest:50697}。德鲁斯瓦 {npc:137040} 也出售。'
...
L['hay_covered_chest_note'] =
    '骑上 {npc:130350} 沿路往下走到达 {npc:131453} 来刷新宝藏。'
...
L['damp_scroll_note_2'] = '地下室 {npc:136343}后面的地上。' ..
                              damp_note
L['damp_scroll_note_3'] = '楼上 {npc:136343} 旁边的地上。' .. damp_note
L['damp_scroll_note_4'] = '地下室 {npc:136343}旁边的地上。' ..
                              damp_note
...
L['secret_of_the_depths_note'] =
    '阅读全部五个卷轴，然后和不祥祭坛交谈会被传送到宝藏。'

L['burly_note'] =
    '这些小家伙很奇怪，但确实强而有力。你确定要进行战斗？'
L['delia_hanako_note'] =
    '在我们开始之前，我想要提醒你，当我的队伍把你的碾压了之后，可不要哭鼻子。'
L['kwint_note'] =
    '一个人对一头鲨鱼，可能还算是一场公平的较量。但是一对三？你可真是疯了。'

L['shanty_fruit_note'] =
    '拾取布满灰尘的歌谱，在小洞穴内的地面上。'
L['shanty_horse_note'] = '拾取痞子的歌谱，在酒馆内的吧台上。'
L['shanty_inebriation_note'] =
    '拾取杰伊的歌谱，在 {npc:141066} 后面地面上。'
L['shanty_lively_note'] = '拾取罗素的歌谱，在壁炉架顶上。'
L['options_icons_shanty_raid'] = '{achievement:13057}'
L['options_icons_shanty_raid_desc'] =
    '显示 {achievement:13057} 成就中禁忌船歌的位置。'
...
L['options_icons_upright_citizens_desc'] =
    '显示 {achievement:13285} 成就中 NPC 的位置。'
...
L['friendly_alpaca'] =
    '每天可以喂食 {npc:162765} 一个 {item:174858}，7天(次)后会获得坐骑。在一个位置只出现10分钟，然后在一个较长的刷新时间后再次出现。'
L['gaze_of_nzoth'] = '与 {npc:156890} 共享刷新。'
L['gersahl_note'] =
    '用于喂食 {npc:162765} 七次后可以获得坐骑。不需要草药学。'
L['gersahl'] = '基萨尔野菜'
L['hmiasma'] = '喂食它周围的软泥直到激活。'
L['kanebti'] =
    '从 {npc:152427} 身上收集 {item:168160}，与一般的 {npc:151859} 共享刷新。把雕像插入甲虫神龛召唤稀有。'
L['neferset_rare'] =
    '这六个稀有在尼斐塞特具有共享三个刷新点。 完成召唤仪式事件后，将随机刷新三个。'
L['platform'] = '刷新在浮空平台顶部。'
L['right_eye'] = '掉落 {item:175140} 玩具的 {item:175142}。'
L['single_chest'] =
    '此宝箱只在一处刷新！如果没有在这没有发现，等待一会儿将会刷新。'
L['tomb_widow'] =
    '当柱子上出现白色卵囊时，杀死看不见的蜘蛛召唤。'
L['uatka'] =
    '需要三个人分别同时点击 {npc:152777}，消耗一个 {item:171208} 出自阿玛塞特圣箱。'
...
L['pyre_amalgamated'] =
    '地上有个融合者的火堆，点击之后击杀小怪直到稀有出现。'
L['ritual_ascension'] = '击杀 {npc:152233}。'
L['solar_collector'] =
    '使收集器开启所有周边的全部5个模块。点击一个模块也会切换与它相邻的模块。'
L['summoning_ritual'] =
    '击杀侍战者后传送门关闭。几次事件完成后，尼斐塞特周围将刷新一组三种稀有怪。'
...
L['bear_spirit_note'] =
    '击杀 {npc:160404} 和全部波数怪物获得10%急速增益。'
L['buffs_change'] =
    '可用增益每次更换。如果建筑物关闭或没有 NPC 与物体，则本次没有此增益。'
L['clear_sight'] = '需要 {spell:307519} 等级%d。'
L['craggle'] =
    '丢下一个玩具到地上（比如 {item:44606}）分散他的注意力。拉开并优先击杀机器人。'
L['empowered_note'] =
    '穿过地雷阵并站在楼上的 {npc:161324} 获得10%伤害增益。'
L['enriched_note'] = '击杀 {npc:161293} 获得10%爆击率增益。'
L['ethereal_essence_note'] = '击杀 {npc:161198} 获得10%爆击率增益。'
L['ethereal_note'] =
    '收集隐藏在整个视野中的橙色水晶，并将其交还给 {npc:162358} 以获取额外的纪念品。总共有10个水晶，每个区域2个。\n\n|cFF00FF00别忘了拾取宝箱！|r'
L['heroes_bulwark_note'] =
    '击杀旅店的 {npc:158588} 获得10%生命值增益。'
...
L['smiths_strength_note'] =
    '击杀铁匠小屋的 {npc:158565} 获得10%伤害增益。'
L['spirit_of_wind_note'] =
    '击杀 {npc:161140} 获得10%急速和移动速度增益。'
...
L['options_icons_dune_rider_desc'] =
    '显示 {achievement:13018} 成就中摇晃的木板的位置。'

L['options_icons_scavenger_of_the_sands'] = '{achievement:13016}'
L['options_icons_scavenger_of_the_sands_desc'] =
    '显示 {achievement:13016} 成就中垃圾物品的位置。'

L['elusive_alpaca'] =
    '将 {item:161128} 喂给 {npc:162681} 以获得坐骑。一个位置存在10分钟，很长时间刷新。'
...
L['burning_goliath_note'] =
    '击杀后，一个 {npc:141663} 将在 {npc:141668} 附近刷新。'
L['cresting_goliath_note'] =
    '击杀后，一个 {npc:141658} 将在 {npc:141668} 附近刷新。'
L['rumbling_goliath_note'] =
    '击杀后，一个 {npc:141659} 将在 {npc:141668} 附近刷新。'
L['thundering_goliath_note'] =
    '击杀后，一个 {npc:141648} 将在 {npc:141668} 附近刷新。'
L['echo_of_myzrael_note'] =
    '一旦四个元素巨怪被击杀后，{npc:141668} 将出现。'
...
L['murderbeak_note'] =
    '把鱼饵扔进海里，然后击杀数只 {npc:134780} 直到 {npc:134782} 刷新。'
L['vukuba_note'] =
    '调查 {npc:134049}，然后击杀数波 {npc:134047} 直到 {npc:134048} 刷新。'

L['cache_of_secrets_note'] =
    '瀑布后面的洞穴内一个 {npc:137234} 拿着。'
...
L['karaga_note'] =
    '我已经很久没战斗过了，不过我仍然很有机会战胜你。'
L['talia_spark_note'] =
    '这片大陆上的小动物很凶猛，我希望你准备好了。'
...
L['torcali_note'] =
    '在战兽栏完成任务直到 {quest:47261} 变为可用。一些任务将花费数天来完成。'

L['totem_of_paku_note'] =
    '和巨擘封印北侧的 {npc:137510} 交谈选择帕库为你的祖达萨洛阿神灵。'
L['options_icons_paku_totems'] = '帕库图腾'
L['options_icons_paku_totems_desc'] =
    '显示达萨罗 {npc:131154} 和他的旅行路径。'
...
local shared_dinos =
    '从 {npc:133680} 的任务线 {daily:50860} 日常必须激活（四个可能的日常之一）让他们出现，任何人可以在这些天看到他们。'
L['azuresail_note'] =
    '与 {npc:135512} 和 {npc:135508} 共享刷新计时器。\n\n' ..
        shared_dinos
L['thunderfoot_note'] =
    '与 {npc:135510} 和 {npc:135508} 共享刷新计时器。\n\n' ..
        shared_dinos
L['options_icons_life_finds_a_way'] = '{achievement:13048}'
L['options_icons_life_finds_a_way_desc'] =
    '显示 {achievement:13048} 成就中可怕恐龙的位置。'
...
L['goramor_note'] =
    '从位于悲伤之地附近的小洞穴内的 {npc:126833} 购买一个 {item:163563} 并喂给 {npc:143644}。'
L['makafon_note'] =
    '从位于鳞商驿站的 {npc:124034} 购买一个 {item:163564} 并喂给 {npc:130922}。'
L['stompy_note'] =
    '从位于风花绿洲北侧的 {npc:133833} 购买一个 {item:163567} 并喂给 {npc:143332}。'
L['options_icons_brutosaurs'] = '{achievement:13029}'
L['options_icons_brutosaurs_desc'] =
    '显示 {achievement:13029} 成就中雷龙的位置。'

local hekd_note =
    '\n\n要获得 {npc:126334} 访问权限，必须完成任务 %s。'
if UnitFactionGroup('player') == 'Horde' then
    hekd_note = hekd_note:format(
        '位于达萨罗 {npc:127665} 的 {quest:47441} 然后是 {npc:126334} 的 {quest:47442}')
else
    hekd_note = hekd_note:format(
        '位于沃顿 {npc:136562} 的 {quest:51142} 然后是 {npc:136559} 的 {quest:51145}')
end
local hekd_quest = '从 {npc:126334} 完成任务 %s。' ..
                       ns.color.Orange(hekd_note)
local hekd_item =
    '从垃圾堆附近的 %s 拾取 %s 并带给 {npc:126334}。' ..
        ns.color.Orange(hekd_note)
...
L['nazwathan_junk_note'] = format(hekd_item, '纳兹瓦萨亡灵',
    '{item:157802}')
...
L['options_icons_sausage_sampler_desc'] =
    '显示 {achievement:13087} 成就中供应商的位置。'
...
L['supply_chest_note'] =
    '一个 {npc:135181} 或 {npc:138694} 每隔45分钟就会在头顶飞过一次，并空投一个 {npc:135238} 到潜在可能的三个位置之一。'
...
L['secret_supply_chest_note'] = '当阵营入侵激活时，' ..
                                    ns.color.Yellow('秘密补给箱') ..
                                    ' 可能短时间出现在这些位置之一。'
L['options_icons_secret_supplies'] = '秘密补给箱'
L['options_icons_secret_supplies_desc'] =
    '显示 {achievement:13317} 成就中 ' ..
        ns.color.Yellow('秘密补给箱') .. ' 的位置。'
