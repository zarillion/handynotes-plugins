...
L['ancient_sarco_note'] =
    'Open the Ancient Sarcophagus to summon waves of {npc:128181}.'
L['beshol_note'] = 'Open the Obviously Safe Chest to summon the rare.'
L['cottontail_matron_note'] =
    'Study the Beastly Ritual Skull to summon the rare.'
...
L['seething_cache_note'] =
    'Open the Seething Cache to summon waves of {npc:129031}.'
...
L['merchants_chest_note'] =
    'Kill the nearby {npc:137468} that is holding a keyring to acquire {item:163710}'
L['wicker_pup_note'] = [[
...
local runebound =
    'Activate the {npc:143688s} in the order shown on the metal plates behind the chest:\n\n'
...
L['dilbert_mcclint_note'] =
    'Hey there, name\'s {npc:140461}, Infestation Management. Always nice to battle a fellow arachnoid enthusiast.'
L['fizzie_spark_note'] =
    'You think your pets have a chance against my Azerite infused team? You wish!'
...
L['options_icons_drust_facts_desc'] =
    'Display stele locations for the {achievement:13064} achievement.'
L['options_icons_drust_facts'] = '{achievement:13064}'

L['embers_crossbow_note'] =
    'Loot the {item:163749} on the ground between two trees, then return it to the ruins of Gol Var.'
L['embers_flask_note'] =
    'Loot the {item:163746} in the water between two rocks, then return it to the ruins of Gol Var.'
L['embers_hat_note'] =
    'Loot the {item:163748} from the pile of bones, then return it to the ruins of Gol Var.'
L['embers_knife_note'] =
    'Pull the {item:163747} from the trunk of the tree, then return it to the ruins of Gol Var.'
L['embers_golvar_note'] =
    'Return each relic to the ruins of Gol Var to complete the achievement.'
L['golvar_ruins'] = 'Ruins of Gol Var'
L['options_icons_ember_relics_desc'] =
    'Display relic locations for the {achievement:13082} achievement.'
L['options_icons_ember_relics'] = '{achievement:13082}'

L['linda_deepwater_note'] =
    'To gain access, you must complete {npc:136458}\'s quest line just outside of Anyport.'
...
L['avenger_note'] =
    'When {npc:155254} is in Rustbolt, kill the {npc:151159} (runs all over the zone) to spawn.'
L['beastbot_note'] = 'Craft a {item:168045} at {npc:150359} to activate.'
L['cogstar_note'] =
    'Kill {npc:150667} mobs anywhere in the zone until he teleports in to reinforce them.'
L['crazed_trogg_note'] =
    'Use a spraybot, paint filled bladder or the bots in Bondo\'s Yard to coat yourself in the color he yells.'
L['deepwater_note'] = 'Craft a {item:167649} at {npc:150359} to summon.'
L['doppel_note'] =
    'Along with two other players, use a {item:169470} from {daily:56405} to activate.'
L['foul_manifest_note'] =
    'Connect all three circuit breakers to the pylons in the water.'
L['furor_note'] =
    'During {daily:55463}, click the small blue mushrooms until he spawns.'
L['killsaw_note'] =
    'Spawns anywhere in the Fleeting Forest, likely in response to killing {npc:151871s}. Does not spawn on days when the Venture Company is in the forest and Clearcutters are not available.'
L['leachbeast_note'] =
    'Shares a spawn with {npc:151745s} in Junkwatt Depot, which only spawn while the area is raining. Use an {item:168961} to activate the Weather Alteration Machine.'
L['nullifier_note'] = [[
...
L['rusty_note'] =
    'Craft a {item:169114} at {npc:150359} to enter the alternate future. Only spawns when {npc:153993} is NOT present in Rustbolt.'
L['vaultbot_note'] =
    'Kite to the tesla coil in Bondo\'s Yard or craft a {item:167062} at {npc:150359} to break him open.'
...
L['iron_chest_note'] =
    'Open with an {item:169872} dropped from mobs in the Western Spray.'
L['msup_chest_note'] =
    'Open with a {item:169873} dropped from mobs in the Western Spray.'
L['rust_chest_note'] =
    'Open with an {item:169218} dropped from mobs in the Western Spray.'

L['rec_rig_note'] =
    'To activate hard-mode, use the {spell:292352} weapon to convert all {npc:150825s} into {npc:151049s}. Pets are obtainable on both difficulties.'

L['grease_bot_note'] =
    'Click the bot to gain 5% haste and 10% movement speed for 2 hours.'
L['shock_bot_note'] =
    'Click the bot to gain a chain lightning damage proc for 2 hours.'
L['welding_bot_note'] =
    'Click the bot to increase health and healing received by 10% for 2 hours.'

L['options_icons_mech_buffs'] = 'Buff Bots'
L['options_icons_mech_buffs_desc'] =
    'Display locations of grease, shock and welding bots on the map inside the dungeon.'
L['options_icons_mech_chest'] = 'Mechanized Chests'
L['options_icons_mech_chest_desc'] =
    'Display locations of mechanized chests. There are 10 unique chests that can be looted once a day and each chest has 4-5 spawn locations. Locations are grouped by color.'
L['options_icons_locked_chest'] = 'Locked Chests'
L['options_icons_locked_chest_desc'] =
    'Display locations of locked chests in the Western Spray.'
L['options_icons_recrig'] = '{npc:150448}'
L['options_icons_recrig_desc'] =
    'Display the location of the {npc:150448} and its rewards.'
...
L['naz_intro_note'] =
    'Complete the introductory quest chain to unlock rares, treasures, and world quests on Nazjatar.'
...
L['avarius_note'] =
    'Use a {item:167012} to collect and place the colored crystals on the pedestals. You do not have to be a miner!'
L['banescale_note'] =
    'Small chance to spawn immediately after killing {npc:152359}.'
...
L['matriarch_note'] =
    'Shares a respawn timer with the other two Scale Matriarchs.'
L['needle_note'] = 'Usually spawns in the Gate of the Queen area.'
L['oronu_note'] = 'Summon a {npc:154849} pet to activate.'
L['rockweed_note'] =
    'Kill {npc:152549} and {npc:151166} all over the zone until he spawns. A raid group is recommended as this can be a long grind.'
L['sandcastle_note'] =
    'Use a {item:167077} to reveal chests anywhere in the zone until he spawns.'
L['tidelord_note'] =
    'Kill the three {npc:145326s} and the summoned {npc:153999} until the Tidelord is summoned.'
...
L['arcane_chest_07'] =
    'In the back of a cave. Entrance in Zanj\'ir Wash to the east.'
...
L['prismatic_crystal_note'] =
    'Use these to feed critters to {npc:151782s} in Nazjatar.'
L['strange_crystal'] = 'Strange Crystal'
L['strange_crystal_note'] =
    'To unlock {item:167893} spawns, you must first loot the {item:169778} at this location and then turn in {quest:56560}.'
L['options_icons_prismatics'] = '{item:167893s}'
L['options_icons_prismatics_desc'] =
    'Display {item:167893} locations for feeding {npc:151782s}.'

L['slimy_cocoon'] = 'Slimy Cocoon'
L['ravenous_slime_note'] =
    'Feed the slime a critter using a {item:167893}. Repeat five days until it spawns an egg with a pet inside. The slime will stay gone until the next weekly reset.'
L['slimy_cocoon_note'] =
    'A pet is ready to be collected from the cocoon! If it does not appear for you, the egg in on cooldown in your phase. Change phases or check back later.'

L['cat_figurine'] = 'Crystalline Cat Figurine'
L['cat_figurine_01'] =
    'In an underwater cave. Figurine is on the floor in the open. Entrance to the east.'
L['cat_figurine_02'] =
    'In a cave under the nearby waterfall. Figurine is under a starfish on the wall.'
L['cat_figurine_03'] =
    'In an underwater cave. Figurine is hidden under some broken shells.'
L['cat_figurine_04'] =
    'In an underwater cave. Figurine is on the floor in the open.'
L['cat_figurine_05'] =
    'In a small cave. Figurine is hidden behind plant on the floor.'
L['cat_figurine_06'] =
    'In an underwater cave filled with hostile Reefwalkers. Figurine is up on the wall. Entrance to the north.'
L['cat_figurine_07'] = 'In a small cave. Figurine is on the wall in some coral.'
L['cat_figurine_08'] =
    'In a small cave. Dodge the arcane circles. Figurine is on a tall rock in the back.'
L['cat_figurine_09'] =
    'In an underwater cave. Figurine is on the rock archway by the ceiling.'
L['cat_figurine_10'] =
    'In a cave just below the path. Figurine is between three barrels.'
...
L['Salgos'] = nil
L['tentacle_taco'] =
    'Sells {item:170100} if you are wearing the Benthic {item:169489}.'

L['options_icons_slimes_nazj'] = '{npc:151782s}'
L['options_icons_slimes_nazj_desc'] =
    'Display locations of the four {npc:151782s} that produce pets once fed.'
L['options_icons_cats_nazj'] = '{achievement:13836}'
L['options_icons_cats_nazj_desc'] =
    'Display locations of the cat figurines for the {achievement:13836} achievement.'
L['options_icons_misc_nazj'] = 'Miscellaneous'
L['options_icons_misc_nazj_desc'] =
    'Display the location of {npc:152593}\'s cave and Mardivas\'s Laboratory.'
...
L['captain_mukala_note'] =
    'Attempt to loot the Cursed Chest to summon the captain.'
...
L['offering_to_bwonsamdi_note'] =
    'Run up the nearby tree and jump into the broken structure.'
L['shambling_ambusher_note'] =
    'Attempt to loot the {npc:124473} to activate the rare.'
...
L['carved_in_stone_41862'] =
    'At the destroyed wall, in front of the huge pillar.'
...
L['options_icons_carved_in_stone_desc'] =
    'Display pictograph locations for {achievement:13024}.'
...
L['options_icons_hoppin_sad_desc'] =
    'Display {npc:143317} locations for the {achievement:13028} achievement.'
...
L['sabertron_note'] =
    'Kill the {npc:139334} to activate one of the {npc:139328s}.'
...
L['weathered_treasure_chest_note'] =
    'In a hidden cave. There are three entrances, each hidden behind a cluster of trees.'
...
L['eddie_fixit_note'] =
    'Prepare to face my unbeatable team of highly modified and customized robots!'
L['ellie_vern_note'] =
    'I\'ve found the toughest sea creatures around to battle for me, you don\'t stand a chance.'
L['leana_darkwind_note'] =
    'Strange creatures on this island will make for a strange battle I suspect.'

L['honeyback_harvester_note'] =
    'Talk to the {npc:155193} to begin the event. The Fresh Jelly Deposit can be looted once an hour and resets on the hour.'
L['options_icons_honeybacks'] = '{npc:155193s}'
L['options_icons_honeybacks_desc'] =
    'Display {npc:155193} event locations for farming Honeyback Hive reputation.'

L['lets_bee_friends_note'] =
    'Complete {daily:53371} seven times to earn the achievement and pet. To unlock the daily:'
L['lets_bee_friends_step_1'] =
    'Complete the Mildenhall Meadery questline through {quest:50553}.'
L['lets_bee_friends_step_2'] =
    'Kill {npc:133429s} and {npc:131663s} at Mildenhall Meadery until you find an {item:163699}.'
L['lets_bee_friends_step_3'] = 'Bring {item:163699} to {npc:143128} in Boralus.'
L['lets_bee_friends_step_4'] =
    'Bring {item:163702} to {npc:133907} at Mildenhall Meadery.'
...
local luncheon = (UnitFactionGroup('player') == 'Alliance') and
                     ...
                     '{npc:138096} in Warfang Hold'
L['these_hills_sing_note'] = 'Open {item:160485} here. Buy one from ' ..
                                 luncheon ..
                                 ' or loot one from the "Discarded Lunchbox" treasure in Brennadam.'

L['ancient_tidesage_scroll'] = 'Ancient Tidesage Scroll'
L['ancient_tidesage_scroll_note'] =
    'Read all 8 Ancient Tidesage Scrolls to earn the achievement.'
L['options_icons_tidesage_legends'] = '{achievement:13051}'
L['options_icons_tidesage_legends_desc'] =
    'Display ancient scroll locations for the {achievement:13051} achievement.'

L['long_forgotten_rum_note'] =
    'To enter the cave, {quest:50697} must be completed from {npc:134710} in Deadwash. Also sold by {npc:137040} in Drustvar.'
...
L['hay_covered_chest_note'] =
    'Ride the {npc:130350} down the road to {npc:131453} to spawn the treasure.'
...
L['damp_scroll_note_2'] = 'On the floor in a basement behind a {npc:136343}.' ..
                              damp_note
L['damp_scroll_note_3'] = 'On the floor upstairs next to a {npc:136343}.' ..
                              damp_note
L['damp_scroll_note_4'] =
    'On the floor in a basement next to a {npc:136343}.' .. damp_note
L['damp_scroll_note_5'] = 'In a corner under the boardwalk.' .. damp_note
L['ominous_altar'] = 'Ominous Altar'
L['ominous_altar_note'] =
    'Talk to the Ominous Altar to be teleported to the treasure.'
L['secret_of_the_depths_note'] =
    'Read all five Damp Scrolls, then talk to the Ominous Altar to teleport to the treasure.'

L['burly_note'] =
    'These little guys are pretty strange, but they sure pack a punch. Are you sure you want this fight?'
L['delia_hanako_note'] =
    'Before we start, I just want to remind you to not feel too bad when my team annihilates yours.'
L['kwint_note'] =
    'One person against one shark, maybe an even fight. One person against three? You\'re insane.'

L['shanty_fruit_note'] =
    'Loot the Dusty Songbook, found on the floor in a small cave.'
L['shanty_horse_note'] =
    'Loot the Scoundrel\'s Songbook, found on the bar inside the tavern.'
L['shanty_inebriation_note'] =
    'Loot Jay\'s Songbook, found on the floor behind {npc:141066}.'
L['shanty_lively_note'] =
    'Loot Russel\'s Songbook, found on top of the fireplace mantel.'
L['options_icons_shanty_raid'] = '{achievement:13057}'
L['options_icons_shanty_raid_desc'] =
    'Display sea shanty locations for the {achievement:13057} achievement.'
...
L['options_icons_upright_citizens_desc'] =
    'Display NPC locations for the {achievement:13285} achievement.'
...
L['uldum_intro_note'] =
    'Complete the introductory quest chain to unlock rares, treasures and assault quests in Uldum.'
...
L['dunewalker'] =
    'Click the Essence of the Sun on the platform above to release him.'
L['friendly_alpaca'] =
    'Feed the alpaca {item:174858} seven times to learn it as a mount. Appears for 10 minutes in one location, then a long respawn.'
L['gaze_of_nzoth'] = 'Shares a spawn with {npc:156890s}.'
L['gersahl_note'] =
    'Feed to the {npc:162765} seven times for a mount. Does not require Herbalism.'
L['gersahl'] = 'Gersahl Shrub'
L['hmiasma'] = 'Feed it the surrounding oozes until it activates.'
L['kanebti'] =
    'Collect a {item:168160} from a {npc:152427}, which shares a spawn with regular {npc:151859s}. Insert the figurine into the Scarab Shrine to summon the rare.'
L['neferset_rare'] =
    'These six rares share the same three spawn locations in Neferset. After a number of Summoning Ritual events have been completed, a random set of three will spawn.'
L['platform'] = 'Spawns on top of the floating platform.'
L['right_eye'] = 'Drops the right half of the {item:175140} toy.'
L['single_chest'] =
    'This chest spawns in only one location! If it is not there, wait a bit and it will respawn.'
L['tomb_widow'] =
    'When the white egg-sacs are present by the pillars, kill the invisible spiders to summon.'
L['uatka'] =
    'Along with two other players, click each Mysterious Device. Requires a {item:171208} from an Amathet Reliquary.'
...
L['options_icons_assault_events_desc'] =
    'Display locations for possible assault events.'
L['options_icons_coffers'] = 'Locked Coffers'
L['options_icons_coffers_desc'] =
    'Display locations of locked coffers (lootable once per assault).'
...
L['combust_cocoon'] =
    'Throw the makeshift firebombs at the cocoons on the ceiling.'
...
L['pyre_amalgamated'] =
    'Cleanse the pyre, then kill all amalgamations until the rare spawns.'
L['ritual_ascension'] = 'Kill the {npc:152233s}.'
L['solar_collector'] =
    'Enable all five cells on all sides of the collector. Clicking a cell also toggles all cells touching that cell.'
L['summoning_ritual'] =
    'Kill the acolytes then close the summoning portal. After the event is completed a number of times, a set of three rares will spawn around Neferset.'
...
L['lightblade_training'] =
    'Kill instructors and unprovens until {npc:152197} spawns.'
...
L['vale_intro_note'] =
    'Complete the introductory quest chain to unlock rares, treasures and assault quests in the Vale of Eternal Blossoms.'

L['big_blossom_mine'] =
    'Inside the Big Blossom Mine. Entrance to the north-east.'
...
L['pools_of_power'] =
    'Inside the Pools of Power. Entrance at The Golden Pagoda.'
...
L['colored_flames'] =
    'Collect the colored flames from their torches and bring them to the matching runes.'
L['construction_ritual'] = 'Push the tiger statue into the beam.'
L['consuming_maw'] = 'Purify growths and tentacles until kicked out.'
L['corruption_tear'] =
    'Grab the {spell:305470} and close the tear without letting the whirling eyes hit you.'
...
L['font_corruption'] =
    'Rotate the mogu statues until both beams reach the back, then click the console.'
...
L['mantid_hatch'] =
    'Pick up the {spell:305301} and destroy the larva incubators.'
L['mending_monstro'] = 'Destroy all the {npc:157552} crystals.'
L['mystery_sacro'] =
    'Destroy all the Suspicious Headstones, then kill the {npc:157298}.'
...
L['stormchosen_arena'] =
    'Clear all mobs in the arena, then kill the Clan General.'
...
L['war_banner'] =
    'Burn the banners and kill waves of mobs until the commander appears.'
L['weighted_artifact'] =
    'Pick up the Oddly Heavy Vase and navigate the maze back to the pedestal. Getting stunned by a statue drops the vase.'
...
L['bear_spirit_note'] =
    'Kill the {npc:160404} and all waves of mobs to gain a 10% haste buff.'
L['buffs_change'] =
    'Available buffs change each run. If the building is closed or the NPC/object is missing, that buff is not up this run.'
L['clear_sight'] = 'Requires {spell:307519} rank %d.'
L['craggle'] =
    'Drop a toy on the ground (such as the {item:44606}) to distract him. Pull his bots away and kill them first.'
L['empowered_note'] =
    'Go through the maze of mines and stand on the {npc:161324} upstairs for a 10% damage buff.'
L['enriched_note'] = 'Kill the {npc:161293} for a 10% crit buff.'
L['ethereal_essence_note'] = 'Kill {npc:161198} for a 10% crit buff.'
L['ethereal_note'] =
    'Collect orange crystals hidden throughout the vision and return them to {npc:162358} for extra momentos. There are ten cystals total, two in each area.\n\n|cFF00FF00Don\'t forget to loot the chest!|r'
L['heroes_bulwark_note'] =
    'Kill {npc:158588} inside the inn for a 10% health buff.'
...
L['smiths_strength_note'] =
    'Kill {npc:158565} in the blacksmith hut for a 10% damage buff.'
L['spirit_of_wind_note'] =
    'Kill {npc:161140} for a 10% haste and movement speed buff.'
...
L['c_hidden_boxes'] =
    'Hidden behind some boxes behind {npc:152089}\'s building.'
...
L['c_left_inquisitor'] =
    'Behind the inquisitor miniboss to the left of the stairs.'
...
L['bloodwing_bonepicker_note'] =
    'Collect the {npc:136390} at the summit to summon the vulture.'
L['nezara_note'] =
    'Cut the ropes attached to all four {npc:128952s} to release the rare.'
...
L['ashvane_spoils_note'] =
    'Ride the {npc:132662} down the hill to spawn the treasure at the bottom.'
L['excavators_greed_note'] = 'Inside a collapsed tunnel.'
L['grayals_offering_note'] =
    'After completing {quest:50702}, enter Atul\'Aman and click the Ancient Altar to spawn the treasure.'
L['kimbul_offerings_note'] = 'On the hill above the Temple of Kimbul.'
L['sandsunken_note'] =
    'Click the Abandoned Bobber to pull the treasure out of the sand.'

L['keeyo_note'] = 'Time for a great adventure!'
L['kusa_note'] =
    'I\'m on a winning streak, you have no chance against me and my team.'
...
L['plank_3'] =
    'On the side of the pyramid. Path starts at the other nearby plank.'
...
L['options_icons_dune_rider_desc'] =
    'Display rickety plank locations for the {achievement:13018} achievement.'

L['options_icons_scavenger_of_the_sands'] = '{achievement:13016}'
L['options_icons_scavenger_of_the_sands_desc'] =
    'Show junk item locations for the {achievement:13016} achievement.'

L['elusive_alpaca'] =
    'Feed {item:161128} to the {npc:162681} to learn it as a mount. Appears for 10 minutes in one location, then a long respawn.'
...
L['boulderfist_outpost'] =
    'Inside Boulderfist Outpost (a large cave). Entrance to the northeast.'
L['burning_goliath_note'] =
    'When defeated, a {npc:141663} will spawn near {npc:141668}.'
L['cresting_goliath_note'] =
    'When defeated, a {npc:141658} will spawn near {npc:141668}.'
L['rumbling_goliath_note'] =
    'When defeated, a {npc:141659} will spawn near {npc:141668}.'
L['thundering_goliath_note'] =
    'When defeated, a {npc:141648} will spawn near {npc:141668}.'
L['echo_of_myzrael_note'] =
    'Once all four elemental goliaths are defeated, {npc:141668} will appear.'
L['frightened_kodo_note'] =
    'Despawns after a few minutes. Guaranteed to spawn after a server restart.'
...
L['murderbeak_note'] =
    'Toss the chum into the sea, then kill {npc:134780s} until {npc:134782} spawns.'
L['vukuba_note'] =
    'Investigate the {npc:134049}, then kill waves of {npc:134047s} until {npc:134048} spawns.'

L['cache_of_secrets_note'] =
    'Held by an {npc:137234} in a cave behind a waterfall.'
...
L['karaga_note'] =
    'I have not battled in a long while, I hope I am still a good challenge to you.'
L['talia_spark_note'] =
    'The critters in this land are vicious, I hope you\'re ready for this.'
...
L['torcali_note'] =
    'Complete quests at Warbeast Kraal until {quest:47261} becomes available. Some quests will take multiple days to complete.'

L['totem_of_paku_note'] =
    'Speak to {npc:137510} north of the Great Seal to select Pa\'ku as your loa in Zuldazar.'
L['options_icons_paku_totems'] = 'Totems of Pa\'ku'
L['options_icons_paku_totems_desc'] =
    'Display {npc:131154} locations and their travel paths in Dazar\'alor.'
...
local shared_dinos =
    'The {daily:50860} daily must be active (one of four possible dailies) from the {npc:133680} quest line for them to appear. Anyone can see them on those days.'
L['azuresail_note'] =
    'Shares a short respawn timer with {npc:135512} and {npc:135508}.\n\n' ..
        shared_dinos
L['thunderfoot_note'] =
    'Shares a short respawn timer with {npc:135510} and {npc:135508}.\n\n' ..
        shared_dinos
L['options_icons_life_finds_a_way'] = '{achievement:13048}'
L['options_icons_life_finds_a_way_desc'] =
    'Display fearsome dinosaur locations for the {achievement:13048} achievement.'
...
L['goramor_note'] =
    'Purchase a {item:163563} from {npc:126833} and feed it to {npc:143644}. {npc:126833} is located in a small cave near the Terrace of Sorrows.'
L['makafon_note'] =
    'Purchase an {item:163564} from {npc:124034} in Scaletrader Post and feed it to {npc:130922}.'
L['stompy_note'] =
    'Purchase a {item:163567} from {npc:133833} north of the Whistlebloom Oasis and feed it to {npc:143332}.'
L['options_icons_brutosaurs'] = '{achievement:13029}'
L['options_icons_brutosaurs_desc'] =
    'Display brutosaur locations for the {achievement:13029} achievement.'

local hekd_note = '\n\nTo gain access to {npc:126334}, you need to complete %s.'
if UnitFactionGroup('player') == 'Horde' then
    hekd_note = hekd_note:format(
        '{quest:47441} from {npc:127665} in Dazar\'alor followed by {quest:47442} from {npc:126334}')
else
    hekd_note = hekd_note:format(
        '{quest:51142} from {npc:136562} in Voldun followed by {quest:51145} from {npc:136559}')
end
local hekd_quest = 'Complete the quest %s from {npc:126334}.' ..
                       ns.color.Orange(hekd_note)
local hekd_item =
    'Loot a %s from %s near the trashpile and bring it to {npc:126334}.' ..
        ns.color.Orange(hekd_note)
...
L['options_icons_get_hekd_desc'] =
    'Display tasks for {npc:126334} locations for the {achievement:12482} achievement.'

L['options_icons_mushroom_harvest'] = '{achievement:13027}'
L['options_icons_mushroom_harvest_desc'] =
    'Display fungarian villain locations for the {achievement:13027} achievement.'

L['options_icons_tales_of_de_loa'] = '{achievement:13036}'
L['options_icons_tales_of_de_loa_desc'] =
    'Display tablet locations for the {achievement:13036} achievement.'
...
L['bow_to_your_masters_note'] = 'Bow to the loa of Zandalar (' ..
                                    ns.color.Orange('/bow') .. ').'
L['options_icons_bow_to_your_masters'] = '{achievement:13020}'
L['options_icons_bow_to_your_masters_desc'] =
    'Display loa locations for the {achievement:13020} achievement.'

L['alisha_note'] = 'This vendor requires quest progress in Drustvar.'
L['elijah_note'] =
    'This vendor requires quest progress in Drustvar. He begins selling sausage after {quest:47945}.'
...
L['options_icons_sausage_sampler_desc'] =
    'Display vendor locations for the {achievement:13087} achievement.'
...
local horde_sheets = (UnitFactionGroup('player') == 'Horde') and
                         [[ The following drinks are unavailable to Horde and must be purchased on the auction house:
...
L['three_sheets_note'] =
    'Acquire one of every drink to earn the achievement.' .. horde_sheets
L['options_icons_three_sheets'] = '{achievement:13061}'
L['options_icons_three_sheets_desc'] =
    'Display vendor locations for the {achievement:13061} achievement.'

L['options_icons_daily_chests_desc'] =
    'Display locations of chests (lootable daily).'
L['options_icons_daily_chests'] = 'Chests'

L['supply_chest'] = 'War Supply Chest'
L['supply_chest_note'] =
    'A {npc:135181} or {npc:138694} will fly overhead once every 45 minutes and drop a {npc:135238} at one of three potential drop locations.'
L['supply_single_drop'] = ns.color.Orange(
    'This flight path always drops the supply crate at this location.')
...
L['secret_supply_chest_note'] = 'When a faction assault is active, a ' ..
                                    ns.color.Yellow('Secret Supply Chest') ..
                                    ' can appear at one of these locations for a short time.'
L['options_icons_secret_supplies'] = 'Secret Supply Chests'
L['options_icons_secret_supplies_desc'] = 'Display ' ..
                                              ns.color
                                                  .Yellow('Secret Supply Chest') ..
                                              ' locations for the {achievement:13317} achievement.'
