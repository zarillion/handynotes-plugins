...
map.nodes[35407000] = Rare({
    ...
    pois= {
        Path({
            35407000, 32006980, 31606240
        }), Path({
            47407820, 49207900, 47208060, 49608520, 48608680, 46408480
        }), Path({
            73803140, 74003380, 72003640, 72003920, 68004120, 67003740
        })
    }
}) -- High Thane Jorfus
...
map.nodes[59105330] = Rare({
    ...
    pois= {
        Path({
            ...
            36912573, 33822748, 32792871, 30772657, 29342769, 29403025, 30633270, 29883750, 28253903, 28524547, 31044322, 32004026, 29883750
        })
    }
...
map.nodes[61004180] = Rare({
    ...
    pois = {
        Path({
            68206880, 67605860, 65605140, 61004180, 56204060, 50204120,47804660, 44805380, 46806520
        })
    }
