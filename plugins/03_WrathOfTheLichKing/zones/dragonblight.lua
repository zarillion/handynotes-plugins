...
map.nodes[72207060] = Rare({
    ...
    pois = {
        POI({
            72007400, 69007580, 86804160, 86003640, 88003660, 75602720, 72202560, 71202260
        })
    }
...
map.nodes[53805920] = Rare({
    ...
    pois = {
        Path({
            53805920, 55545560, 56885204, 57664845, 57894348, 58823937, 60343496, 61283216, 60872948, 59112850
        }),
        Path({
            58094224, 60294336, 61654433
        }),
        Path({
            56885204, 57205545, 58705758, 60735789, 62515607, 62465187, 61884776, 61654433, 62664035, 64273744, 65233614,
            67793569, 69933397, 70353212, 70053036, 68492936, 67173066, 66743414, 66923814, 67164254, 67674538, 68544748,
