...
map.nodes[34614995] = Rare({
    ...
    pois ={
        POI({
            40485098, 39654877, 38334966, 28174545, 26524685
        })
    }
}) -- Seething Hate
...
map.nodes[20205620] = Rare({
    ...
    pois = {
        ...
        Path({
            10203720, 11004200, 12204360, 13204660, 13405160, 12605400, 12205540, 13605420, 14605280, 15605020
        }),
        Path({
            20205620, 21605760, 23005760, 24005680, 24005440, 25205620, 26205640, 25205720, 24806000, 24005940
        }),
        Path({
            11207100, 13607080, 15007000, 16406940, 17807140, 20207260, 21607080, 22607360
        })
    }
}) -- Grocklar
...
map.nodes[65003000] = Rare({
    ...
    pois = {
        Path({
            65003000, 65802840, 67602800, 68602680, 68803080, 70203340, 71603500, 73603760, 75203880, 76204160
        }),
        Path({
            66604160, 66204040, 66603600, 65603360, 64603560, 61803660, 61203520
        })
    }
