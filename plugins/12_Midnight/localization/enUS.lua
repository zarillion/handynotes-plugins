...
L['ensorcelled_cryptid_note'] = 'Click the {npc:273760} and stay close while its {spell:1313802} stacks are drained, dodging the arcane swirls. Interact with {npc:273775} afterwards to receive {item:282417}.\n\nHe respawns at one of the three spots after about 10 minutes.'
...
L['waterlogged_crate'] = 'Waterlogged Crate'
L['broken_urn'] = 'Broken Urn'
L['brine_crusted_chest_note'] = '1. Open a {dot:Blue}{object:Bubbling Clam} to loot a {item:271815}.\n\n2. Go to {dot:Red}{npc:263347} and place the pearl on the arrow on the ground. She will take it and drop the {item:271881}.\n\n3. Pick up the key and open the treasure.\n\n{note:If a clam cannot be opened, you probably already have a pearl in your bags.}'
L['bubbling_clam'] = 'Bubbling Clam'
