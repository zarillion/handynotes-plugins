...
L['vulzahn_smuggled_treasure_note'] = '1. Parlez à {dot:Green}{npc:263265} qui se trouve à côté du trésor. \n\n2. Parlez au {dot:Red}{npc:262204}. \n\n 3. Obtenez une {item:271791} auprès de l\'{dot:Blue}{npc:253837}.\n\n4. Donnez la {item:271791} au {dot:Red}{npc:262204} pour recevoir un {item:271788}.\n\n5. Apportez le {item:271788} à {dot:Green}{npc:263265} pour recevoir la {item:271792} et déverrouiller le trésor.'
L['grave_of_someone_forgotten_note'] = '1. Interagissez avec la {object:Tombe sans nom}. \n\n2. Parlez à {dot:Red}{npc:263242}.\n\n3. Parlez à {dot:Green}{npc:263243}.\n\n4. Parlez à {dot:Blue}{npc:263241}.\n\n5. Retournez a la {object:Tombe sans nom} pour la piller.'
...
L['curse_surge_note'] = 'Les événements de Déferlante maudite alternent toutes les 45 minutes.\n\n{note:Si vous l\'avez manqué, formez un groupe cross-realm — l\'événement peut encore être en cours sur d\'autres royaumes.}'
