...
L['options_icons_stormarion_assault'] = '史托瑪里恩突擊'
L['options_icons_stormarion_assault_desc'] = '在提示中顯示 {location:史托瑪里恩突擊} 的獎勵。'
...
L['impenatrably_sealed_gourd_note'] = '從附近的 {object:垂吊的壺} 拾取 {item:260251}，並從附近的 {object:懸掛的藥劑} 拾取 {item:260250}。\n與 {object:牢固的花瓶} 互動並加入液體以獲得 {item:260266}。\n與寶藏互動以領取獎勵。'
...
L['altar_of_wisdom'] = '睿智祭壇'
L['altar_of_innocence_note'] = '與 {object:純真祭壇} 互動後，將 {item:256882} 交還給 {npc:254030}。\n\n完成其餘祭壇的任務，即可在 {location:獸穴} 出現 {object:輪迴的禮物} 寶藏。'
L['altar_of_vigor_note'] = '與 {object:活力祭壇} 互動後，將 {item:257024} 交還給 {npc:254104}。\n\n完成其餘祭壇的任務，即可在 {location:獸穴} 出現 {object:輪迴的禮物} 寶藏。'
L['altar_of_wisdom_note'] = '與 {object:睿智祭壇} 互動後，將 {item:257054} 交還給 {npc:254116}。\n\n完成其餘祭壇的任務，即可在 {location:獸穴} 出現 {object:輪迴的禮物} 寶藏。'

-------------------------------------------------------------------------------
---------------------------------- VOIDSTORM ----------------------------------
-------------------------------------------------------------------------------

L['bloody_sack_note'] = '從附近的骨堆收集 {object:滴水的肉} 以餵食 {object:被遺忘的密牢}。'
L['malignant_chest_note'] = '啟動洞穴中的 {object:怨毒節點} 以解鎖寶箱。'
L['malignant_node'] = '怨毒節點'
...
L['share_a_drink_note'] = '從亞坎提娜的 {npc:250495} 購買 {item:251039} 並與所有種族分享。'
