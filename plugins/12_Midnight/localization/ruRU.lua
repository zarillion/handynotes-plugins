...
L['curse_surge_note'] = 'События Проклятой волны сменяются каждые 45 минут.\n\n{note:Если вы пропустили его, соберите группу с другого сервера — на других серверах событие может всё ещё продолжаться.}'
