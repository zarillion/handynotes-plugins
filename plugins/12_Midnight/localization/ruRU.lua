...
L['ensorcelled_cryptid_note'] = 'Нажмите на {npc:273760} и оставайтесь рядом, пока спадают эффекты его {spell:1313802}, уклоняясь от завихрений тайной магии. После этого поговорите с {npc:273775}, чтобы получить {item:282417}.\n\nОн возрождается в одной из трех точек примерно через 10 минут.'
...
L['highly_decorated_note'] = 'Завершите задания со сменяющимися реликвиями, затем соберите и разместите украшения в Тайной таверне.'
...
L['waterlogged_crate'] = 'Промокший ящик'
L['broken_urn'] = 'Разбитая урна'
L['brine_crusted_chest_note'] = '1. Откройте {dot:Blue}{object:Пузырчатого моллюска}, чтобы получить {item:271815}.\n\n2. Отправляйтесь к {dot:Red}{npc:263347} и положите жемчужину на стрелку на земле. Она заберет ее и бросит {item:271881}.\n\n3. Подберите ключ и откройте сокровище.\n\n{note:Если моллюск не открывается, скорее всего, жемчужина уже лежит в ваших сумках.}'
L['bubbling_clam'] = 'Пузырчатый моллюск'
