...
map.nodes[49006010] = Squirrel({
    ...
    pois = {
        POI({
            27405900, 27605900, 31802820, 32002360, 44006140, 44006160,
            44206380, 44406320, 44606060, 44805820, 44806180, 45006360,
            45206340, 45405860, 45605920, 46205960, 46206060, 46406160,
            46605760, 46605900, 46805980, 47206160, 47405740, 47406140,
            47605880, 47806020, 48405820, 48605820, 48805940, 49005980,
            63203120, 63203200, 64403220, 64603220, 65602520, 65803560,
            66003520, 68002860, 68802280, 69203060, 69402540, 69402660
        })
    }
}) -- Chittering Claw
...
map.nodes[48506050] = Squirrel({
    ...
    pois = {
        POI({
            26004300, 27005180, 28205100, 29804960, 31403100, 31804140,
            32004180, 32202760, 32406600, 33006560, 33803100, 35402300,
            35404780, 36604680, 36804600, 37404980, 37405060, 37804900,
            38005040, 38005060, 40407460, 45206380, 45805780, 45805980,
            46205740, 47005780, 47206200, 48205780, 48206520, 48406020,
            48606020, 48606440, 49006460, 50006060, 50406680, 51006720,
            51406800, 52206780, 52403640, 52403660, 52606500, 55003360,
            55006800, 55203740, 55403260, 55405200, 55603380, 55803260,
            55805460, 56003680, 64803480
        })
    }
}) -- Writhing Rachis
