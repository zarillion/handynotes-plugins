...
map.nodes[52663542] = Rare({
    ...
    rewards = {
        ...
        Transmog({item = 184154}), -- Grungy Containment Pack
...
map.nodes[72872891] = Rare({
    ...
    rewards = {
        ...
        Transmog({item = 181810, covenant = NECROLORD}) -- Phylactery of the Dead Conniver
    }
}) -- Necromantic Anomaly
...
map.nodes[50346328] = Rare({
    ...
    rewards = {
        ...
        Transmog({item = 181811, covenant = NECROLORD}) -- Beckoner's Shadowy Crystal
    }
...
map.nodes[28965138] = Rare({
    ...
    rewards = {
        ...
        Transmog({item = 181804, covenant = NECROLORD}) -- Trophy of the Reborn Bonelord
    },
    pois = {POI({26314280})}
}) -- Zargox the Reborn
...
map.nodes[57007421] = Rare({
    ...
    rewards = {
        ...
        Transmog({item = 184156, note = '{npc:157312}'}), -- Recovered Containment Pack
        ns.reward.Spacer(),
...
map.nodes[44083989] = Treasure({
    ...
    rewards = {
        ...
        Transmog({item = 181800, covenant = NECROLORD}), -- Standard of the Blackhound Warband
