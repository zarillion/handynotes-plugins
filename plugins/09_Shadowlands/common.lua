...
ns.groups.MAWSWORN_CACHE = Group('mawsworn_cache', 3729814, {defaults=ns.GROUP_HIDDEN75}) -- Korthia
ns.groups.MAWSWORN_CACHE2 = Group('mawsworn_cache', 3729814, {defaults=ns.GROUP_ALPHA75}) -- Maw (necro assault)
