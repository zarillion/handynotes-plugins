...
ns.groups.KORTHIA_SHARED = Group('korthia_dailies', 1506458, {default=ns.GROUP_HIDDEN})
ns.groups.MAW_LORE = Group('maw_lore', 'chest_gy')
ns.groups.NILGANIHMAHT_MOUNT = Group('nilganihmaht', 1391724, {default=ns.GROUP_HIDDEN})
