...
local ADDON_NAME, ns = ...
local L = LibStub("AceLocale-3.0"):NewLocale(ADDON_NAME, "frFR", true, true)
...
L["lehgo_note"] = "Détruisez les œufs de Gorm frémissants et tuez {npc:171827} jusqu'à ce qu'il apparaisse. Dans une grotte (entrée au sud-est dans les Terriers poussiéreux)."
...
L["rootwrithe_note"] = "Tapez sur les {npc:167928}s jusqu'à ce que le rare apparaisse."
...
L["valfir_note"] = "Cliquez sur le cocon d'anima instable à mi-parcourd du chemin et utilisez {spell:338045} pour retirer son {spell:338038}."
L["wrigglemortis_note"] = "Engagez le {npc:164179} pour faire apparaître le rare."

L["night_mare_note"] = [[
Allez à Tirna Scithe et suivez le chemin de racines sur la falaise nord-ouest jusqu'à une charrette cassée. Là, vous pourrez ramasser un {item:181243} sur le sol.

Apportez cet objet à {npc:165704} au bassin Tombe-Lueur. Elle vous donnera un {item:181242} en échange de 10 {item:173204}. |cFFFF8C00Si elle n'est pas là, vous devez compléter les suites de quêtes |cFFFFFD00Problèmes au Corral des rejetons Gorms|r et |cFFFFFD00Spriggans farceurs|r.

Ensuite, parlez à {npc:160262} au Coeur de la forêt pour échanger le {item:181242} contre un {item:178675}. Utilisez cet objet pour obtenir le buff {spell:327083}, vous permettant de voir le {npc:168135}.
...
L["elusive_faerie_cache"] = "Prenez le {spell:333923} dans le coin nord-est du Bosquet du Brunant et utilisez-le pour piller le coffre."
...
L["hearty_dragon_plume"] = "Cliquez sur {spell:333554} en haut des chutes d'eau voisines et utilisez-le pour flotter vers la branche."
L["old_ardeite_note"] = "Tuer {npc:160747} et {npc:160748} au sud-est de Lumefronde pour obtenir {item:174042}. Utilisez cet objet pour voler près du rare et l'engager."
...
Lisez le "Conte de l'enchevêtrement", puis suivez les lampes bleues à travers le chemin jusqu'à ce que vous atteigniez {npc:171767}. Tuez-le et prenez ensuite le pillage du {npc:171699}.
...
L["collector_astor_note"] = "Lisez les six chapitres de L'héritage de Mercia éparpillés dans la salle, après quoi vous recevrez un murmure de {npc:157979}. Parlez-lui pour recevoir {spell:333779}, ce qui vous permettra de trouver le {point:180569} caché au nord-ouest. Rendre le chapitre fera apparaître le rare."
...
L["herculon_note"] = [[
Collectez des {item:172451} et utilisez-les pour donner des charges de {spell:343531} à {npc:158659}. A 10 charges, il s'activera.

Les motes peuvent être collectées à partir de Bidons d'Anima épuisés situés dans la pièce ou juste à l'extérieur.
...
L["swelling_tear_note"] = "Cliquez sur le {npc:171012} pour invoquer l'un des trois rares. Les larmes peuvent apparaître à plusieurs endroits de la zone."
L["unstable_memory_note"] = "Peut être invoqué quand les {npc:171018}s sont présents. Amenez un {npc:171018} vers les autres pour lui donner 10 charges de {spell:333558}, le transformant ainsi en monstre rare."
L["wingflayer_note"] = "Pour l'invoquer, cliquez sur la Corne du Courage sur la table voisine (au sud-est, en haut des escaliers)."

L["broken_flute"] = "Tuez les {npc:170009} à proximité jusqu'à ce qu'ils laissent tomber le {item:180536}, puis utilisez les outils pour le réparer."
...
L["memorial_offering"] = "Achetez un {item:180788} auprès de {npc:171526} au Repos de l'Aspirant. Placez-le sur le plateau de boissons près du coffre pour obtenir le {item:180797}."
...
L["gift_of_devos"] = [[
Au sud-ouest du coffre se trouve une torche où l'on peut prendre le {spell:333912}. Chevaucher une monture, entrer en combat ou subir des dégâts fera tomber la flamme. Vous devez retourner au coffre et placer la flamme dans le brasero de la dévotion pour obtenir le {spell:333070}.

Avant de reprendre la flamme, dégagez tous les monstres devant le coffre. Tout en transportant la flamme, cliquez sur n'importe quel {npc:156571} en cours de route pour obtenir {spell:335012}, augmentant la vitesse de déplacement.
]]
L["gift_of_thenios"] = [[
...
L["gift_of_vesiphone"] = "Sonnez une des cloches pour faire apparaître un {npc:170849} et tuez-le pour recevoir le debuff {spell:333239}. L'eau qui tombe en face du coffre supprimera ce debuff et vous donnera {spell:332785}."
...
L["leeda_note"] = "Tuez les deux {npc:162220}s jusqu'à ce que le rare apparaisse."
...
L["schmitd_note"] = "Utilisez le {spell:313451} proche pour briser son bouclier."
L["taskmaster_xox_note"] = "Partage son apparition avec {npc:160204}, {npc:160230} et {npc:160226}."
L["zargox_the_reborn_note"] = "Utilisez {item:175841} en plus du {npc:157124}. Pour obtenir l'orbe, vous devez compléter la quête {quest:57245} de {npc:157076} et lui parler à nouveau."
L["mixed_pool_note"] = [[
...
• Récupérez {spell:306713} à partir de {npc:167923} et {npc:167948} au nord.

• Récupérez {spell:306719} auprès de {npc:165015} et {npc:171142} au sud.

• Récupérez {spell:306722} auprès de {npc:165027} et {npc:166438} au sud.
]]
...
L["ritualists_cache_note"] = "Ramassez des {item:181558} sur un tas d'os (plusieurs lieux d' apparition). Utilisez-les pour compléter le Livre des Rituels de Liaison sur le stand derrière {npc:174386} et gagner le buff {spell:337041}." --Correction : Nom du livre possiblement erroné
L["runespeakers_trove_note"] = "Trouvez {npc:170563} à l'est et tuez-le pour obtenir le {item:181777}."
...
L["spinebug_note"] = [[
Oh, regardez ! Un {spell:343124} ! Approchez-le, courageux aventurier, ce n'est sûrement pas une ruse. Attends, est-ce la musique de Karazhan ? Qu'est-ce que ce {npc:174663} fait ici... ?
...
L["amalgamation_of_filth_note"] = "Quand l'expédition {wq:Sale boulot : Détail de la démolition} est disponible, cliquez sur une Boîte à ordures et utilisez {spell:324115} dans l'eau." --Correction : Doute sur le nom de l'expédition
L["amalgamation_of_light_note"] = "Déplacez les trois pièges à miroir pour libérer le rare."
...
L["bog_beast_note"] = "A une chance d'apparaître pendant l'expédition {wq:Foire aux idées} après avoir utilisé {item:177880} sur un {npc:166206}." --Correction : Doute sur le nom de l'expédition
L["endlurker_note"] = "Cliquez sur le Pieu Anima près du cadavre {npc:165229} et utilisez {spell:321826} au sommet de la Faille Scintillante."
L["executioner_aatron_note"] = "Tuez les trois PNJ proches {npc:166715} pour supprimer {spell:324872}."
...
L["innervus_note"] = "Tuez les {npc:160375}s proches pour obtenir un {item:177223} et déverrouillez la crypte."
...
L["manifestation_of_wrath_note"] = "A une chance d'apparaître lorsqu'un {npc:169916} est recueilli au cours de l'expédition {wq:Déferlement d'âmes}."
...
L["taskmaster_trove_note"] = "Lisez les rites d'entrée et de sortie, puis dirigez-vous avec précaution vers le coffre."
...
L["sinrunner_note_day2"] = "Obtenez un {item:182585} de {npc:173570} à Sombrehavre et utilisez-le pour nettoyer Blanchette."
L["sinrunner_note_day3"] = "Equiper Blanchette avec 4 {item:182595} trouvés sur les routes entourant Sombrehavre."
L["sinrunner_note_day4"] = "Ramassez {item:182620} près de {npc:173570} et remplissez-le avec de l'eau provenant de Bastion ou de Sylvarden. Ramenez le {item:182599} à Blanchette."
