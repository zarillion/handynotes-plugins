...
L['squirrels_note'] = 'Vous devez utiliser l\'émote {emote:/amour} sur les bestioles, pas sur les familiers de combat.'
...
L['gormtamer_tizo_note'] = 'Tuez des Lutins Poil-de-pin dans le {location:Maquis Voile-de-Brume} jusqu\'à ce que {npc:164110} apparaisse.'
L['humongozz_note'] = 'Plantez un {item:175247} dans le {object:Terreau humide} pour y faire apparaître un {npc:164122}. Le champignon peut être récupéré sur de nombreux monstres de la zone.'
L['lehgo_note'] = 'Détruisez les {object:Œufs de gorm frémissants} et tuez des {npc:171827} jusqu\'à ce qu\'il apparaisse. Dans une grotte (entrée au sud-est dans les {location:Terriers poussiéreux}).'
L['macabre_note'] = [[
Apparaît en plusieurs endroits. Pour l'invoquer, placez-vous dans le {object:Cercle de champignons mystérieux} avec deux autres joueurs et dansez ensemble.
...
Il apparaîtra toujours au nord de {location:Tirna Vaal}, fixez votre {item:6948} là et attendez l'émote dans le chat de la zone.
...
L['night_mare_note'] = [[
Allez à {location:Tirna Scithe} et suivez le chemin de racines sur la falaise nord-ouest jusqu'à une charrette cassée. Là, vous pourrez ramasser une {item:181243} sur le sol.

Apportez cet objet à {npc:165704} au {location:Bassin Tombe-Lueur}. Elle vous donnera une {item:181242} en échange de 10 {item:173204}. {note:Si elle n'est pas là, vous devez compléter les suites de quêtes |cFFFFFD00Règlement de compte chez les gormelins|r et |cFFFFFD00Spriggans farceurs|r.}

Ensuite, parlez à {npc:160262} au {location:Coeur de la forêt} pour échanger l'{item:181242} contre un {item:178675}. Utilisez cet objet pour obtenir le buff {spell:327083}, vous permettant de voir la {npc:168135}.
]]
...
L['cache_of_the_moon'] = 'Rassemblez les cinq outils manquants de {npc:171360} dans le {location:Jardin de la nuit} et combinez-les pour créer {item:180753}. Rendez-lui sa boîte à outils et elle vous lancera {spell:334353}, ce qui vous permettra de voir la cache.'
...
L['darkreach_supplies'] = 'Sautez sur le {npc:169995} et planez vers le sud-ouest dans la flèche creusée située directement au-dessus du trésor de la {object:Cache de la nuit}.'
L['desiccated_moth'] = 'Sautez sur le {npc:169997} au nord-ouest de l\'arbre pour flotter vers une branche. Brûler {item:180784} dans le {object:Brûleur d\'encens} pour récupérer le trésor.'
L['dreamsong_heart'] = 'Utilisez le {npc:169997} sous l\'arbre pour vous faire propulser dans l\'arbre.'
L['elusive_faerie_cache'] = 'Prenez la {spell:333923} dans le coin nord-est du {location:Bosquet du Brunant} et utilisez-la pour piller le coffre.'
...
L['old_ardeite_note'] = 'Tuer des {npc:160747}s et {npc:160748}s au sud-est de {location:Lumefronde} pour obtenir {item:174042}. Utilisez cet objet pour voler près du rare et l\'engager.'
...
• commence à creuser curieusement = {emote:/curieux}
• erre sans pouvoir rester assis = {emote:/assis}
• chante tout seul = {emote:/chanter}
• danse avec joie = {emote:/dancer}
• s'assied seul et triste = {emote:/caresser}
]]

L['tame_gladerunner'] = 'Coureur halo-de-brume'
L['tame_gladerunner_note'] = [[
Lisez le {object:Conte de l'enchevêtrement}, puis suivez les lampes bleues à travers le chemin jusqu'à ce que vous atteigniez {npc:171767}. Tuez-le et prenez ensuite le butin du {npc:171699}.

Si vous prenez un mauvais chemin et que {npc:171699} disparaît lorsque vous arrivez à la fin, revenez au début et lisez à nouveau {object:Conte de l'enchevêtrement} avant d'essayer à nouveau. Si {npc:171767} n'est pas là, vous devrez attendre qu'il réapparaisse.
]]
...
L['lost_book_note'] = 'Rendez ce livre perdu à {npc:165867} dans le {location:Bosquet du Souvenir}.'
L['options_icons_faerie_tales'] = '{achievement:14788}'
L['options_icons_faerie_tales_desc'] = 'Afficher les emplacements des livres perdus pour le haut-fait {achievement:14788}.'
...
Ciblez {npc:181694} et tapez {emote:/apaise}
Peut apparaître au centre du sommet des 6 grands arbres autour de {location:Sylvarden} :
• {location:Palun Chanterêve}
• {location:Bassin Tombe-Lueur}
• {location:Tirna Vaal}
• {location:Creux Hibernal}
• {location:Bosquet du Xylocarde}
• {location:Bord-de-Griffe}
]]
L['soulshape_corgi_note'] = [[
Ciblez {npc:174608} et tapez {emote:/pet}
...
L['collector_astor_note'] = 'Lisez les six chapitres de {object:L’héritage de Mercia} éparpillés dans la salle, puis parlez à {npc:157979} pour recevoir {spell:333779}. Trouvez {item:180569} caché dans les environs et rendez-le pour faire apparaître le rare.'
L['corrupted_clawguard_note'] = 'Procurez-vous un {item:180651} dans la pièce ou à l\'{location:Avant-poste de Forgefeu} en haut de la colline et utilisez-le pour réparer le {npc:171300}.'
...
L['sotiros_orstus_note'] = 'Cliquez sur la {object:Cloche noire} pour invoquer les rares.'
...
L['wingflayer_note'] = 'Pour l\'invoquer, cliquez sur la {object:Corne du Courage} sur la table voisine (au sud-est, en haut des escaliers).'
...
L['gift_of_devos'] = [[
Au sud-ouest du coffre se trouve une torche où l'on peut prendre la {spell:333912}. Chevaucher une monture, entrer en combat ou subir des dégâts fera tomber la flamme. Vous devez retourner au coffre et placer la flamme dans le {object:Brasero de la dévotion} pour obtenir la {spell:333070}.
...
L['gift_of_thenios'] = [[
Derrière le coffre se trouve une plateforme de vol nommée {object:Chemin de la sagesse}. Cela mène à une séquence de plateformes possédant différents encens avec lesquels vous pouvez communier :

• {object:Encens de la connaissance}
• {object:Encens de la patience}
• {object:Encens de la clairvoyance}
• {object:Encens du jugement}

Communiez avec eux dans l'ordre Patience => Connaissance => Clairvoyance. Sur la plateforme du Jugement, un orbe appelé {object:Chemin de la sagesse perspicace} apparaîtra.

L'orbe vous emmènera au véritable {object:Encens du jugement}. Communiez avec lui et la dernière plateforme de vol vous donnera {spell:333068}, permettant d'ouvrir le coffre.
]]
...
L['vespers_ascended_note'] = 'Cliquez sur cette vêpre en même temps que les quatre autres vêpres pour invoquer le {npc:170899} au {location:Creuset de l\'aspirant}.'
...
L['anima_shard_61241'] = 'Au-dessus de l\'entrée de la {location:Chambre de première réflexion}.'
...
L['anima_shard_61249'] = 'Caché derrière une colonne de pierre au niveau supérieur du {location:Pinacle de la pureté}.'
...
L['anima_shard_61258'] = 'Sur une petite corniche sous le {location:Repos du Héros}.'
...
L['anima_shard_61275'] = 'Dans le {location:Hall des Bêtes}, derrière quelques tonneaux.'
...
L['anima_shard_61281'] = 'Sur une corniche au-dessus du trésor des {object:Offrandes commémoratives}.'
...
L['anima_shard_61283'] = 'Dans une grotte sous la {location:Chapelle de Miri}, derrière quelques barils.'
...
L['carriage_crusher_note'] = 'Suivez la {npc:180182} dans l\'{location:Antre} et défendez-là jusqu\'à ce que l\'{npc:180246} attaque.'
L['chamber_note'] = 'Utilisez une {item:186718} de l\'{npc:178257} sur le {object:Téléporteur ancien}. Utilise le {object:Téléporteur ancien réparé} pour accéder à la chambre.'
L['consumption_note'] = [[
...
L['flayedwing_transporter_note'] = 'Cliquez sur {npc:178633} pour voler vers ou depuis le {location:Caveau des Secrets}.'
...
L['towering_exterminator_note'] = 'Apparaît à partir d\'un événement de portail antrelige. L\'événement peut apparaître dans de nombreux endroits de {location:Korthia}.'
...
L['korthian_shrine_note'] = 'Cliquez sur le sanctuaire pour obtenir {spell:352367} et voir le chemin caché vers le sanctuaire.'
L['num_research'] = '%d Recherche'
L['plus_research'] = '+Recherche'
L['options_icons_relic'] = '{achievement:15066}'
L['options_icons_relic_desc'] = 'Afficher les emplacements des 20 reliques pour le haut-fait {achievement:15066}.'

L['rift_portal_note'] = [[
Entrez dans {location:La Faille}, une phase alternative de {location:Korthia} et de l'{location:Antre} contenant des monstres rares, reliques et coffres supplémentaires.
...
Ce monstre rare sortira de {location:La Faille} une fois qu'il aura été abordé à l'intérieur de celle-ci.

Les trois monstres rares de {location:La Faille} apparaissent généralement dans un ordre déterminé à environ 20 minutes d'intervalle :
...
L['options_icons_rift_portal_desc'] = 'Afficher les emplacements des {npc:179595s} utilisés pour entrer dans {location:La Faille}.'
...
L['sabriel_note'] = 'Peut apparaître comme l\'un des champions du {location:Théâtre de la souffrance}.'
...
L['blackhound_cache_note'] = 'Invoquez {npc:157843} à la {location:Fabrique à Abominations}, puis escortez-le jusqu\'à l\'{location:Avant-poste de Noir-Mâtin}.'
L['bladesworn_supply_cache'] = 'Cache de fournitures des ligelames'
L['cache_of_eyes'] = 'Cache des yeux'
L['cache_of_eyes_note'] = 'Apparaît à plusieurs endroits dans la {location:Forteresse Aveugle}.'
...
Une fois transformé, visitez la grotte située sous la plate-forme de {npc:158406} (entrée du côté est) et cliquez sur le {object:Tuyau de malepeste} pour être transporté jusqu'au coffre.
]]
L['ritualists_cache_note'] = 'Ramassez les {item:181558} au sol et utilisez-les pour compléter le {object:Livre des rituels de lien}.'
...
Dans le {location:Théâtre de la souffrance}, vous trouverez {item:180273} coincé dans le sol et le {item:181164} qui y est attaché. Pour les libérer :

• Achetez 1 {item:182163} à {npc:171808} à {location:Revendreth}.
• Achetez 1 {item:180771} à {npc:166640} à {location:Maldraxxus}.
• Achetez 1 {item:181163} à {npc:169964} à {location:Maldraxxus}.
• Obtenez 2 charges de {spell:306272} de l'expédition {wq:Quelques accidents de parcours} à l'ouest.
• Mangez 4x {spell:327367} à la {location:Deliquescense de Glutharn}.
...
L['options_icons_slime_cat_desc'] = 'Afficher les emplacements des chatons pour le haut-fait {achievement:14634}.'
...
L['sorcerers_blade_note'] = 'Complétez {quest:62317} donnée par le {object:Message de l’ensorceleur} à l\'intérieur du {location:Caveau des âmes}. En bas des escaliers et à gauche sur la bibliothèque.'

L['mucosal_pigment_label'] = '{item:183691}'
L['mucosal_pigment_note'] = 'Récupérables sur n\'importe quelle gelée, gouttelette, limon, rare ou géant près de la {location:Maison de la Peste} ou de la zone près de {npc:162727}'
...
L['amalgamation_of_light_note'] = 'Déplacez les trois {object:Miroirs piégés} pour libérer le rare.'
L['amalgamation_of_sin_note'] = 'Lors de l\'expédition {wq:Invocation de vices}, ramassez le {object:Catalyseur de puissance} pour avoir une chance d\'obtenir {item:180376}, puis utilisez l\'objet pour invoquer le rare.'
...
L['endlurker_note'] = 'Cliquez sur le {object:Pieu d\'Anima} près du cadavre de {npc:165229} et utilisez {spell:321826} près de la {object:Faille chatoyante}.'
...
L['harika_note'] = 'À {location:Combeffroi}, à l\'ouest, procurez-vous un {item:176397}, puis donnez le carreau à {npc:165327} et dites-lui de faire tomber le rare.'
...
L['madalav_note'] = 'Cliquez sur le {object:Marteau de Madalav} sur l\'enclume voisine pour l\'invoquer.'
...
L['scrivener_lenua_note'] = 'Remettre {npc:160753} à la {object:Bibliothèque interdite}.'
L['sinstone_hoarder_note'] = 'Tentez de vous procurer le {npc:162503} et le rare se manifestera.'
L['sire_ladinas_note'] = 'Ramassez un {object:Vestige de lumière} à proximité et utilisez {spell:313065} sur {npc:157733}.'
...
L['broken_mirror_note'] = 'Un groupe de trois {object:Miroirs brisés} sera actif chaque jour. Utilisez une {item:181363} pour réparer chaque miroir et ouvrir le {object:Coffre oublié} à l\'intérieur.'
...
L['return_to_the_maw'] = 'Retour à l\'{location:Antre}'
L['maw_intro_note'] = [[
Complétez la suite de quêtes d'introduction pour débloquer les rares et les événements dans l'{location:Antre}.

Jusqu'à ce que vous rameniez {npc:170651} à {location:Oribos}, vous serez séparé de la plupart des autres joueurs.
]]
...
L['lilabom_note'] = [[
Collectez les 5 parties pour reconstruire la mascotte. Certaines parties peuvent apparaître à plusieurs endroits.
...
Combinez les trois gravures pour créer {item:182329}, qui peut être utilisé pour invoquer le rare à l'{location:Autel de la Domination}. Utilisez le {npc:173892} pour atteindre le niveau supérieur.
]]

L['animaflow_teleporter_note'] = 'À activer pour se rendre directement à d\'autres endroits dans l\'{location:Antre}.'
L['chaotic_riftstone_note'] = 'À activer pour utiliser {spell:344157} et voyager rapidement à travers l\'Antre.'
L['venari_note'] = [[
...
L['box_of_torments_note'] = 'Ouvrez les {npc:173837} sous le {location:Tremaculum}.'
L['tormentors_notes_note'] = 'Fouillez le corps du {npc:173811}.'
L['words_of_warden_note'] = 'Examinez le {object:Papier Brouillon} sur un rocher derrière quelques pots.'

-- Locations given relative to a map area name
L['nexus_area_calcis_branch'] = 'En haut sur une branche de cristal dans {location:Calcis} (utilisez la {object:Prise de grappin})'
L['nexus_area_calcis_crystals'] = 'Derrière certains cristaux bleus dans {location:Calcis}'
L['nexus_area_cradle_bridge'] = 'Sous le pont dans le {location:Berceau des Ruines}'
L['nexus_area_domination_bridge'] = 'Sur un pont au sud de l\'{location:Autel de la Domination}'
L['nexus_area_domination_edge'] = 'Sur le bord au sommet de l\'{location:Autel de la Domination}'
L['nexus_area_domination_room'] = 'Dans une petite pièce au sommet de l\'{location:Autel de la Domination}'
L['nexus_area_domination_stairs'] = 'Au sommet de l\'{location:Autel de la Domination}, à côté du {npc:173904}'
L['nexus_area_gorgoa_bank'] = 'Sur la rive de {location:Gorgoa} (la rivière des âmes)'
L['nexus_area_gorgoa_middle'] = 'En plein milieu de la rivière yo !'
L['nexus_area_gorgoa_mouth'] = 'A l\'embouchure de {location:Gorgoa} (la rivière des âmes)'
L['nexus_area_perdition_wall'] = 'Le long du mur extérieur du {location:Fort de la Perdition}'
L['nexus_area_torment_rock'] = 'Sur un rocher dans les {location:Plans de la Tourmente}'
L['nexus_area_zone_edge'] = 'Le long du bord de la zone'
L['nexus_area_zovaal_edge'] = 'Le long du bord du {location:Chaudron de Zovaal}'
L['nexus_area_zovaal_wall'] = 'Le long du mur en dessous du {location:Chaudron de Zovaal}'
-- Locations given relative to a named cave/cavern
L['nexus_cave_anguish_lower'] = 'Dans la {location:Fosse de l’Angoisse} (niveau inférieur)'
L['nexus_cave_anguish_outside'] = 'Hors de la {location:Fosse de l’Angoisse}'
L['nexus_cave_anguish_upper'] = 'Dans la {location:Fosse de l’Angoisse} (niveau supérieur)'
L['nexus_cave_desmotaeron'] = 'Dans une petite grotte à l\'extérieur du {location:Desmotæron}'
L['nexus_cave_echoing_outside'] = 'En dehors des {location:Cavernes de l’Écho}'
L['nexus_cave_forlorn'] = 'A l\'intérieur de la grotte de la {location:Halte Mélancolique}.'
L['nexus_cave_howl_outside'] = 'Sur le sol à l\'extérieur de la caverne de la {location:Complainte de la mort}'
L['nexus_cave_howl'] = 'A l\'intérieur de la caverne de la {location:Complainte de la mort}'
L['nexus_cave_roar'] = 'A l\'intérieur de la caverne du {location:Rugissement de la mort}'
L['nexus_cave_roar_outside'] = 'A l\'extérieur de la {location:Caverne du Rugissement de la mort}'
L['nexus_cave_ledge'] = 'Dans une petite grotte sous une corniche'
L['nexus_cave_prodigum'] = 'Dans une petite grotte dans le {location:Prodigium}'
L['nexus_cave_soulstained'] = 'Dans une petite grotte dans les {location:Champs Maculés d’âmes}'
L['nexus_cave_torturer'] = 'Dans le {location:Taudis du Tortionnaire}'
...
L['nexus_misc_floating_cage'] = 'Sur une cage flottante (utilisez les {object:Prises de grappin})'
L['nexus_misc_below_ramparts'] = 'Le long du bas des remparts'
L['nexus_misc_grapple_ramparts'] = 'Au sommet des remparts (utilisez la {object:Prise de grappin})'
L['nexus_misc_grapple_rock'] = 'Près d\'une {object:Prise de grappin} sur un rocher'
...
L['nilg_silver_ring_note'] = 'Récupérez 4 {item:186727} dans le {location:Desmotæron} et utilisez-les pour ouvrir le {object:Coffre scellé par la domination}.'
L['nilg_silver_ring_note1'] = 'Tuez {npc:177444} et ouvrez la {item:186970}.'
L['nilg_silver_ring_note2'] = 'Récupérez le {object:Trousseau de clés de la Persécutrice}, situé sur le mur dans une pièce souterraine à côté de {npc:178311}.'
L['nilg_silver_ring_note3'] = 'Ouvrez des {object:Caches de fournitures de Helgarde} dans la zone du {location:Desmotæron}. Votre {npc:180598} peut vous aider à les localiser.'
L['nilg_silver_ring_note4'] = 'Farmez des {npc:177134s} dans la zone du {location:Desmotæron} (faible taux d\'obtention).'
L['nilg_stone_ring_note'] = 'Collectez quatre {item:186600} pendant l\'Assaut des Nécro-seigneurs et combinez-les à n\'importe quelle {npc:171492} dans le {location:Chaudron de Zovaal}.'
L['nilg_stone_ring_note1'] = 'Trouvé dans certaines {object:Caches antreliges} (icône jaune) au sommet des remparts du {location:Fort de la Perdition}.'
L['nilg_stone_ring_note2'] = 'Accomplissez la quête {quest:63545}, puis fouillez les {object:Caches antreliges} jusqu\'à ce que vous trouviez l\'objet de quête {item:186573}. Cette quête est partageable !'
L['nilg_stone_ring_note3'] = 'Récupéré sur l\'{npc:179601} dans la zone centrale du {location:Fort de la Perdition}.'
L['nilg_stone_ring_note4'] = 'Trouvé sur le sol au {location:Fort de la Perdition} près du {npc:170634}. Votre {npc:180598} peut vous aider à le localiser.'
L['nilg_gold_band_note'] = 'Au sommet de la montagne, sur une pointe.'
L['nilganihmaht_note'] = 'Vous devez collecter les 5 anneaux et les apporter à la {npc:179572} dans {location:La Faille}.'
L['calcis'] = 'Calcis'
...
L['options_icons_covenant_assaults'] = 'Assauts de congrégation'
L['options_icons_covenant_assaults_desc'] = 'Récompenses des Assauts de congrégation'
...
L['dormant_alcove_note'] = string.format(HIDDEN_ALCOVE, 'Dormante', 'Dormante', 'aux {location:Pics Résonnants}', 'Dormante')
L['fulgor_alcove_note'] = string.format(HIDDEN_ALCOVE, 'Aveuglante', 'Aveuglante', 'aux {location:Pics Résonnants}', 'Aveuglante')
L['rondure_alcove_note'] = string.format(HIDDEN_ALCOVE, 'Incurvée', 'Incurvée', 'sur la plateforme du {location:Locus Tertius}', 'Incurvée')
L['repertory_alcove_note'] = string.format(HIDDEN_ALCOVE, 'du Répertoire', 'du Répertoire', 'à l\'intérieur de la grotte de la {location:Cache Terrestre}', 'du Répertoire')
...
L['furidian_note'] = 'Activez trois {object:Serrures renforcées} dans la zone, puis déverrouillez le {object:Coffre étrangement remonté}.'
...
2. Pêchez un {item:187915} dans l'{object:Amas de Poissons-blobs âcres} à l'intérieur du {location:Réservoir de Glissecroc} au {location:Marécage de Zangar}.

3. Pêchez un {item:187922} dans le {object:Banc de Nectalies} près du point de vol de la {location:Tombe de Kelya} à {location:Nazjatar}.

4. Récupérez une {item:187916} (très bien cachée) sur un balcon au deuxième niveau de la {location:Terrasse de Nar'shola} aux {location:Étendues Chatoyantes} (34,7, 75,0).

5. Trouvez la {npc:182194} près de l'étang au sud du {location:Siège du Primat} à {location:Maldraxxus}. Demandez-lui de fabriquer l'{item:187923} final.

6. Utilisez l'{item:187923}, qui vous permettra de voir le point de pêche d'{object:Amas d'Aurélides} près de {npc:180978} pendant 15min. Pêchez dedans pour faire remonter {npc:180978} à la surface.
...
L['architects_reserve_note'] = 'Complétez la suite de quêtes {quest:64829} de l\'{npc:180630} à la {location:Grâce du Pèlerin} pour déverrouiller le trésor.'
...
L['library_vault_note'] = 'Cliquez sur les tablettes dans la {location:Grotte Lexicale} jusqu\'à ce que vous trouviez le buff {spell:362062} approprié pour ouvrir le caveau.'
L['mistaken_ovoid_note'] = 'Dans la {location:Grotte des Chutes dimensionnelles}, vous devez collecter 5x {item:190239} et les amener à {npc:185280}.'
L['ripened_protopear_note'] = 'Commencez la suite de quêtes {quest:64641} pour accéder à la {location:Fonderie de l’Éclosion}. Collectez 5 {spell:367180} (nuages verts) à l\'intérieur et apportez-les un par un à la {npc:185416} pour la polliniser. Une fois qu\'elle aura grandi 5 fois, elle tombera.'
L['sphere_treasure_note'] = 'Sautez prudemment sur les sphères jusqu\'à ce que vous atteigniez le trésor.'
L['submerged_chest_note'] = 'Absorbez le {object:Dangereux orbe de puissance} au sud, puis interagissez avec la {object:Pompe oubliée} près du trésor.'
...
L['syntactic_vault_note'] = 'Pour déverrouiller le trésor, vous devez accumuler 6 charges de {spell:367499} en interagissant avec les {object:Syllabes Runiques} dans la zone du {location:Sépulcre des Fondateurs}.'
...
L['rondure_cache_note'] = 'Une forge pouvant être cliquée au sommet d\'un parcours de sauts dans l\'{location:Alcôve Incurvée}.'
...
L['sand_piles_note'] = [[
Tous les tas de sable se trouvent dans la chambre cachée de l'{location:Alcôve Dormante}. Chaque tas requiert un {item:189863}, qui peut être trouvé dans d'autres trésors de la zone :
...
L['torn_ethereal_drape_note'] = 'Se trouve à l\'intérieur de l\'{location:Alcôve Aveuglante}. Activez les {object:Console d’Automa}, puis montez sur les {npc:183565s} pour atteindre le plafond.'
...
L['schematic_curious_crystalsniffer_note'] = 'Disponible pendant une courte période après la mort de {npc:184915} dans le raid {location:Le sépulcre des Fondateurs}.'
...
L['schematic_genesis_crawler_note'] = 'Trouvé au sommet de l\'entrée de l\'{location:Alcôve de la Genèse}.'
...
L['schematic_ineffable_skitterer_note'] = 'Suicidez-vous ! Non, sérieusement... vous ne pouvez voir l\'{npc:185092} au {location:Creux de l’Exil} que lorsque vous êtes un fantôme.'
L['schematic_leaping_leporid_note'] = 'Trouvé au sommet d\'un arbre flottant.'
L['schematic_mawdapted_raptora_note'] = 'Faible chance d\'être trouvé sur les {npc:181412s} dans les {location:Sables Infinis}.'
L['schematic_microlicid_note'] = 'Sur la branche la plus basse de l\'arbre flottant, sous le feuillage.'
L['schematic_omnipotential_core_note'] = 'Se trouve dans l\'{location:Alcôve Incurvée}. Le schéma est caché derrière le bord supérieur de la voûte du côté sud-ouest de la pièce.'
...
L['schematic_prototype_fleetpod_note'] = 'Se trouve dans l\'{location:Alcôve Concave}. Interagissez avec le {npc:184900} pour déclencher un mini-jeu. Guidez l\'escargot à travers 5 anneaux sans toucher les {npc:185455s} pour obtenir le schéma.'
L['schematic_raptora_swooper_note'] = 'Trouvé à l\'intérieur de la {location:Chambre de Façonnage}.'
L['schematic_resonant_echo_note'] = 'Peut être trouvé dans un {object:Écho du premier chant cristallisé}.'
...
L['schematic_serenade_note'] = 'Situé dans une chaîne sous une plateforme flottante dans la zone {location:Foyer immortel} du raid.'
L['schematic_shelly_note'] = 'Situé à l\'arrière d\'une étagère dans la {location:Grotte Lexicale}. Nécessite une capacité de téléportation pour escalader l\'étagère.'
L['schematic_stabilized_geomental_note'] = 'A une chance d\'être lâché par {npc:182169} dans le raid {location:Le sépulcre des Fondateurs}.'
L['schematic_tarachnid_creeper_note'] = 'A l\'intérieur d\'une petite structure dans les {location:Sables Infinis}. Nécessite d\'avoir progressé dans la campagne jusqu\'au chapitre 5 pour dégager les rochers.'
L['schematic_terror_jelly_note'] = 'Au sommet du pylône carré à côté de la rampe.'
L['schematic_tunneling_vombata_note'] = 'A côté de quelques décombres dans un tunnel bloqué à l\'intérieur du complexe {location:Esper locrien}.'
L['schematic_vespoid_flutterer_note'] = 'Dépasse d\'un tas de sable au niveau {location:Locus primus} des {location:Pics Résonnants}.'
...
L['concordance_note'] = 'Lisez chaque harmonique pour déverrouiller les données de la {object:Console d\'histoire} au {location:Creux de l\'Exil}.'

L['echoed_jiro_note'] = 'Dépensez l\'énergie de {npc:181059} pour obtenir des buffs temporaires. Nécessite la recherche {object:Créatien} à la {npc:181397}.'
...
L['runethief_xylora_note'] = 'Apparaît camouflé à la {location:Grâce du Pèlerin}.'

local proto_area = 'Peut être trouvé dans les forges autour de la zone {location:%s}.'
...
L['serene_pigment_note'] = 'Dans une forge au-dessus de l\'entrée du {location:Creux de l’Exil}. Peut nécessiter plusieurs essais.'
...
L['patient_bufonid_note_day6'] = 'Achetez 5x {item:190880} à {npc:185748} près de la {location:Grâce du Pèlerin}.'
L['patient_bufonid_note_day7'] = 'Acheter 1x {item:187171} auprès du {npc:180114} dans le donjon {location:Tazavesh}.'
...
L['venaris_fate_sublabel'] = 'Situé dans le {location:Catalyseur de Création}'
L['venaris_fate_note'] = [[
1. Parlez avec la {npc:162804} incorporelle au {location:Refuge de Ve'nari} dans l'{location:Antre}.
2. Si elle n'est pas incorporelle, une avancée supplémentaire de l'histoire du 9.2 est requise.
3. Interagissez avec le cadavre de {npc:162804} au {location:Catalyseur de Création} à {location:Zereth Mortis}.
...
L['options_icons_echoed_jiros_desc'] = 'Afficher les emplacements des buffs d\'offrandes des {npc:Jiros sonores}.'
