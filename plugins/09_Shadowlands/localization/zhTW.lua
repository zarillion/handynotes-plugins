...
|cFFFF0000注意|r：此 NPC 經常出錯並不會與你交談。
]]
...
拾取火焰之前，清除寶箱前面的全部怪物。在運送火焰時，點選任意路上的 {npc:156571} 獲得 {spell:335012} 負面效果提高移動速度。
]]
L["gift_of_thenios"] = [[
...
L["misplaced_supplies"] = "在巨大的蘑菇頂上。跑上山後跳上較小的棕色蘑菇，在跑道較大的山丘後跳上巨大的蘑菇。"
...
轉化後，到 {npc:158406} 平臺(入口在東側)下面洞穴並點選管道傳送寶箱。
]]
...
L["vat_of_slime_note"] = "點選桌上的瓶子，然後點選軟泥桶。"
...
L["valis_note"] = "按正確順序點選三個 {npc:174810} 召喚稀有。每次嘗試順序都會更換，並且點選錯誤的符文會受到傷害和負面效果 {spell:343636}。"
L["yero_note"] = "靠近 {npc:172862} 然後跟著他進入附近的一個山洞，之後他會變成敵對。"
