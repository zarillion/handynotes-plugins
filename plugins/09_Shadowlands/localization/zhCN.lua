...
L["razorwing_note"] = "交付从吞噬者掉落的 {item:187054}，需要6天。"
...
L["options_icons_invasive_mawshroom_desc"] = "显示侵入蘑菇的位置。"
L["options_icons_invasive_mawshroom"] = "侵入蘑菇（日常）"
L["options_icons_korthia_dailies_desc"] = "显示未标记日常宝箱的位置。"
L["options_icons_korthia_dailies"] = "隐藏宝箱（日常）"
L["options_icons_mawsworn_cache_desc"] = "显示渊誓宝箱的位置。"
L["options_icons_mawsworn_cache"] = "渊誓宝箱（日常）"
L["options_icons_nest_materials_desc"] = "显示不寻常材料的巢穴的位置。"
L["options_icons_nest_materials"] = "不寻常材料的巢穴（日常）"
...
L["deomen_note"] = "进入密室西边的房间并激活锁控制以接近他。"
...
L["etherwyrm_note"] = "需要法夜突袭激活。获得 {item:186190} 需要击杀位于裂隙的 {npc:179030}。"
