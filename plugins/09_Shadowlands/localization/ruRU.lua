...
L["cache_of_the_moon"] = "Соберите пять недостающих инструментов {npc:171360} в сад ночи и объедините их, чтобы создать {item:180753}. Верните ее набор инструментов, и она наложит на вас {spell:334353}, что позволит вам увидеть сокровище."
