...
L["collector_astor_note"] = "Прочтите все шесть глав «Наследие Милосерды», разбросанные по комнате, после чего вы услышите эмоцию от {npc:157979}. Поговорите с ней, чтобы получить {spell:333779}, что позволит вам найти спрятанный {item:180569} на северо-западе. Возврат главы вызовет редкого монстра."
...
L["amalgamation_of_sin_note"] = "Используйте катализатор силы, чтобы получить {item:180376} во время локального задания {wq:Призыв своих грехов}, затем используйте этот предмет, чтобы вызвать редкого монстра."
