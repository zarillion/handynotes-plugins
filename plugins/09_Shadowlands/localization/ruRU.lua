...
L["transport_research"] = "Требуется уровень транспортной сети %d"
L["anima_channeled"] = "анима направлена на %s."

L["options_icons_fae_network_desc"] = "Показать все направления транспорта для сети грибов Ночного народца."
L["options_icons_fae_network"] = "Мицелиальная сеть"
L["options_icons_kyr_network_desc"] = "Отображение всех транспортных направлений для сети шлюзов Кирии."
L["options_icons_kyr_network"] = "Шлюзы Кирий"
L["options_icons_nec_network_desc"] = "Показать все транспортные пункты назначения костяных врат Некролордов."
L["options_icons_nec_network"] = "Костяные врата смерти"
L["options_icons_ven_network_desc"] = "Отображение всех транспортных направлений для кровавых зеркал Вентиров."
L["options_icons_ven_network"] = "Кровавые зеркала"
