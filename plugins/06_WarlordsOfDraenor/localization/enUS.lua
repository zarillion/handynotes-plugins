...
L['glowing_obsidian_shard_treasure'] = 'Glowing Obsidian Shard'
...
L['tormmok_follower_note'] = 'First appears as ' .. ns.color.Red('Hostile') .. '. Assist with killing waves of mobs until you defeat {npc:83871}. When he appears ' .. ns.color.Green('Friendly') .. ' talk to him to recruit him as a follower.'
...
L['reusable_mana_potion_treasure'] = 'Reusable mana potion'
...
L['shadowmoon_exile_treasure_note'] = 'In a cave below |cffffff00Exile Rise|r'
...
L['rooby_roos_ruby_rollar_treasure'] = 'Rooby Roo\'s Ruby Rollar'
...
L['isarris_cache_treasure'] = 'Isarri\'s Cache'
