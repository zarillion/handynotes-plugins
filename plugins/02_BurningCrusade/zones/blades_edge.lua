...
map.nodes[66802680] = Rare({
    ...
    pois = {
        POI({
            ...
            56342405, 56232472, 56052550, 56052618, 56292684, 56702738,
            57082795, 57312864, 57512927, 57692999, 57673066, 57633134,
            57783206, 57933273, 57863349, 57163354, 56683402, 56343464,
            56023527, 55873602
        })
    }
}) -- Speaker Mar'grom
