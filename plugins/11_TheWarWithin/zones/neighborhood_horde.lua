...
map.nodes[56404790] = _Riddle_({quest = 93075, item = 236666})
map.nodes[58004890] = _Riddle_({quest = 93077, item = 244532})
map.nodes[63504470] = _Riddle_({quest = 93078, item = 244533})
map.nodes[62204890] = _Riddle_({quest = 93079, item = 244534})
map.nodes[62605160] = _Riddle_({quest = 93080, decor = 1700})
map.nodes[72005000] = _Riddle_({quest = 93081, item = 245266})
...
map.nodes[68306890] = _Riddle_({quest = 93098, item = 246218})
map.nodes[68107570] = _Riddle_({quest = 93099, item = 246224})
map.nodes[64807300] = _Riddle_({quest = 93100, item = 246587})
...
map.nodes[53808200] = _Riddle_({quest = 93105, item = 246883})
map.nodes[52108180] = _Riddle_({quest = 93106, item = 247221})
map.nodes[53408460] = _Riddle_({quest = 93107, item = 248246})
map.nodes[50308300] = _Riddle_({quest = 93108, item = 251973})
map.nodes[47808860] = _Riddle_({quest = 93109, item = 245680})
map.nodes[44208670] = _Riddle_({quest = 93110, item = 245398})
map.nodes[39807280] = _Riddle_({quest = 93111, item = 245555})
map.nodes[42106630] = _Riddle_({quest = 93115, item = 246614})
map.nodes[44766636] = Riddle({quest = 93131, item = 246868})
map.nodes[42405040] = _Riddle_({quest = 93132, item = 246869})
map.nodes[51608260] = _Riddle_({quest = 93133, item = 246882})
map.nodes[45244631] = Riddle({quest = 93134, item = 248760})
map.nodes[45405730] = _Riddle_({quest = 93135, item = 245581})
map.nodes[47105960] = _Riddle_({quest = 93136, item = 245583})
...
map.nodes[57805900] = _Riddle_({quest = 93140, item = 246249})
map.nodes[50367680] = Riddle({quest = 93141, item = 251981})
map.nodes[50806150] = _Riddle_({quest = 93142, item = 257691})
...
map.nodes[39405760] = _Riddle_({quest = 93150, item = 241620})
