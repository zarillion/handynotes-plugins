...
L['gobblin_with_glublurp_note'] = 'Haz Click en un {dot:Blue}{object:Cristal Trémulo} para ganar {spell:456739}. Coge una {npc:227138} volando en ' .. ns.color.Orange('Orange Circle') .. ' y llévasela a {npc:227132}.\n\n(Se recomienda Vuelo Constante para conseguilo).'
