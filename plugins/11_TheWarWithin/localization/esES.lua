...
L['turtles_thanks_2_note'] = 'Entrega 1x {item:222533} (puede ser pescado de bancos {object:Lagoluz}, {object:Charco de putrefacción purulenta}, {object:Vertido de icor imbuido} o comprados en la Casa de Subastas).'
...
L['faithful_dog_note'] = [[
1. Encuentra al {npc:59533} en {location:Los Cultivos Florecientes} en el {locations:Valle de los Cuatro Vientos} de {location:Pandaria} y completa la misión {quest:30526}.
...
El {npc:87553} estará ahora en {location:Monturas exóticas} de {location:Dalaran}.
4. Interactúa con el {object:Cuenco de perro semienterrado} en la {location:Isla de Dorn} y acaricia el {npc:87553} para conseguir la mascota.
]]
...
L['not_so_quick_fix_note'] = 'Repara la consola terránea estropeada.'
...
L['options_icons_disturbed_earth'] = 'Tierra perturbada'
L['options_icons_disturbed_earth_desc'] = 'Muestra dónde están las {object:Tierra perturbada}.'
...
L['gobblin_with_glublurp_note'] = 'Haz Click en un {dot:Red}{object:Cristal de luz trémula} para ganar {spell:456739}. Coge una {npc:227138} volando en el ' .. ns.color.Orange('círculo naranja') .. ' y llévasela a {npc:227132}.\n\n(Se recomienda Vuelo Constante para conseguilo).'

L['critter_love_note'] = 'Tienes que teclear la emoción {emote:/amor} en alimañas, no en mascotas de batalla.'
...
L['caesper_note'] = 'Compra una {item:225238} a ({dot:Blue}) {npc:217645} en {location:Amabilidad de Dunelle} de {location:Santificación}.\n\nAlimenta a {npc:225948} y síguelo al tesoro.'
L['dark_ritual_note'] = 'Interactúa con el {object:Ritual oscuro} y derrota a {npc:226059}, {npc:226052}, y {npc:226062} para despojar la {object:Esencia ensombrecida}.'
...
L['priory_satchel_location'] = 'Despoja la {object:Bolsa arrastrada por el viento} colgando de la esquina del monasterio del {location:Priorato de la Llama Sagrada}.'
...
L['biblo_book_10_location'] = 'En las habitaciones del capitán a bordo del {location:Rompealbas}.'
...
L['tarnished_compass_location'] = 'Entrega {item:219524} a {object:Ubicación de ofrenda funeraria}.'
...
L['purrlock_location'] = 'Enciende la {object:Llave ardiente de la Floración de la Luz} cercana.'
L['shadowpouncer_location'] = 'Enciende la {object:Llave ardiente de la Floración de la Luz} cercana.'
...
L['croakit_note'] = 'Pesca 10x {item:211474} de un {object:Banco de meros sombraceguera} cercano (o cómpralos en la Casa de Subastas) y lánzaselos para poder atacar al raro.'
...
L['spreading_the_light_rares_note'] = 'El raro aparece después que la {object:Llave ardiente} encendida se apague en el lugar actual.'

L['options_icons_mereldar_menace'] = '{achievement:40151}'
L['options_icons_mereldar_menace_desc'] = 'Muestra dónde están los objetivos del logro {achievement:40151}.'

L['mereldar_menace_note'] = 'Interactúa con la {object:Piedra lanzable} y lánzala a los objetivos.'
L['light_and_flame_location'] = 'Apunta hacia {npc:218472} al este de la {object:Piedra lanzable}.'
...
L['chett_available'] = 'La {item:236682} de esta semana ha sido reclamada por {npc:238029}.\n'
L['chett_ongoing'] = 'Hay una {item:236682} en curso.\n'
L['chett_submit'] = '\nAbre la {item:236682} para entregar las completadas.\n'

L['side_with_a_cartel'] = 'Asociarse con un cártel'
L['ship_right'] = 'Envío en condiciones'
L['reclaimed_scrap'] = 'Chatarra recuperada'
L['side_gig'] = 'Trabajo secundario'
L['war_mode_violence'] = 'Violencia en el modo guerra'
L['go_fish'] = 'A pescar'
L['gotta_catch_at_least_a_few'] = 'Hay que pescar unos cuantos'
L['rare_rivals'] = 'Rivales poco comunes'
L['clean_the_sidestreets'] = 'Despejar los callejones'
L['time_to_vacate'] = 'Hora de desalojar'
L['desire_to_drive'] = 'Con C.A.R.R.O. y a lo loco'
L['kaja_cruising'] = 'Kaja\'crucero'
L['garbage_day'] = 'A tirar la basura'

L['scrap_exchange'] = 'Intercambio de C.H.A.T.A.R.R.A.'
L['paint_job_colors'] = 'Pintura'
L['engine_options'] = 'Motor'
L['wheel_options'] = 'Ruedas'
L['turbo_options'] = 'Turbo'
L['horn_options'] = 'Claxon'

L['rep_paragon'] = 'Dechado'
