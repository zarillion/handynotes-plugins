...
{note:Requires passing through the flight point to spawn {npc:227421}.}
]]
...
L['chett_exchange_2a'] = ns.color.LightBlue('500x') .. ' {currency:%d} Reputation\n (Buy {item:%d} from {faction:%d} Quartermaster)\n'
L['chett_exchange_2b'] = ns.color.LightBlue('500x') .. ' Aligned Cartel Reputation\n ( {note:Have to side with a cartel first this week!})\n'
L['chett_exchange_2_requirement'] = ' {note:Requires {achievement:41627} (Complete twice option #1) to unlock option #2}\n'
L['chett_complete'] = '{note:This week\'s {item:236682} has been completed.}\n'
L['chett_extra'] = 'Exchange 40x {item:236668} for an extra {item:236682}.\n'
L['chett_available'] = 'This week\'s {item:236682} is to be claimed from {npc:238029}.\n'
L['chett_ongoing'] = 'Having an ongoing {item:236682}.\n'
L['chett_submit'] = '\nOpen {item:236682} to submit the completed ones.\n'

L['side_with_a_cartel'] = 'Side with a Cartel'
L['ship_right'] = 'Ship Right'
L['reclaimed_scrap'] = 'Reclaimed Scrap'
L['side_gig'] = 'Side Gig'
L['war_mode_violence'] = 'War Mode Violence'
L['go_fish'] = 'Go Fish'
L['gotta_catch_at_least_a_few'] = 'Gotta Catch at Least a Few'
L['rare_rivals'] = 'Rare Rivals'
L['clean_the_sidestreets'] = 'Clean the Sidestreets'
L['time_to_vacate'] = 'Time to Vacate'
