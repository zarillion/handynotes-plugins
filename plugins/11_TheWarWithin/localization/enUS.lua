...
L['lost_and_found_note'] = 'Progress the Memories of the Sky storyline starting with the quest {quest:80673} from ({dot:Blue}) {npc:220718} to unlock the required quests. {note:The quests unlock weekly}.\n\n3 mementos can be completed each week, until complete the quest {quest:80678}.'
...
L['evan_location'] = 'Inside the building.'
L['emery_location'] = 'Inside the building.'
L['jinx_location'] = 'Inside the building.'
L['moog_location'] = 'Inside the building.'
L['iggy_location'] = 'Inside the building.'
L['nightclaw_location'] = 'Light the {object:Lesser Keyflame} nearby. Requires 3x {item:206350}.'
L['purrlock_location'] = 'Light the {object:Light\'s Blooming Keyflame} nearby. Requires 20x {item:206350}.'
