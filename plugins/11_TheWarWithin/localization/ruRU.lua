...
L['disturbed_earthgorger_note'] = 'Используйте заклинание дополнительного действия, чтобы {spell:437003} коснуться земли 3 раза, чтобы появился редкий монстр.'
...
Затем {npc:227421} исчезнут и снова появятся на карте.
