...
L['attwogaz_location'] = '在窗台上。'
L['halthaz_location'] = '在柱子底部的壁架上。'
L['krattdaz_location'] = '在两座瀑布之间的壁架上。'
L['uisgaz_location'] = '在窗台上。'
L['venedaz_location'] = '在管道旁边的平台上。'
L['merunth_location'] = '在楼梯上方的管道上。'
L['varerko_location'] = '在窗台上。'
L['alfritha_location'] = '在悬崖边上。'
L['gundrig_location'] = '在壁架上。'
L['sathilga_location'] = '在土灵采矿机械建筑物附近的壁架上。'
