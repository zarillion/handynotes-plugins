...
L['chett_exchange_2a'] = ns.color.LightBlue('500') .. ' {currency:%d} 声望\n ( {item:%d} 出售自 {faction:%d} 军需官)'
L['chett_exchange_2b'] = ns.color.LightBlue('500') .. ' 签约财阀声望\n ( {note:本周你还没有支持一个财阀})'
L['chett_exchange_2_requirement'] = ' {note:需要 {achievement:41627} (完成两次抉择 #1) 来解锁抉择2 #2}\n'
L['chett_complete'] = '{note:本周的 {item:236682} 已经完成}\n'
L['chett_extra'] = '每 40 个 {item:236668} 可额外换取一个 {item:236682}\n'
L['chett_available'] = '{npc:238029} 处，本周的 {item:236682} 尚未领取 \n'
L['chett_ongoing'] = '有个 {item:236682} 进行中\n'
L['chett_submit'] = '\n打开 {item:236682} 提交完成项\n'

L['side_with_a_cartel'] = '支持一个财阀'
L['ship_right'] = '正常发货'
L['reclaimed_scrap'] = '回收的废料'
L['side_gig'] = '副业'
L['war_mode_violence'] = '战争模式对抗'
L['go_fish'] = '钓鱼'
L['gotta_catch_at_least_a_few'] = '总得捉住几个'
L['rare_rivals'] = '稀有死对头'
L['clean_the_sidestreets'] = '清扫陋巷'
L['time_to_vacate'] = '清场时间'
