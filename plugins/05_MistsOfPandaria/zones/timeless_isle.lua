...
map.nodes[30535067] = Rare({
    ...
    rewards = {Achievement({id = 8714, criteria = 23967})},
    pois = {
        POI({
...
map.nodes[24805500] = Rare({
    ...
    pois = {
        ...
        Path({24807031, 23146803, 22816508, 22856185}), POI({
...
map.nodes[34046916] = Rare({
    ...
    rewards = {Achievement({id = 8714, criteria = 23968})},
    pois = {
        POI({
...
map.nodes[59004880] = Rare({
    ...
    pois = {
        POI({
            ...
            55107290, 55305030, 55605930, 63104530, 64507230, 65405170, 68406040
...
lostspirits.nodes[48116069] = Rare({
    ...
    pois = {
        POI({
            48006094, 54797178, 55633192, 62283465, 65236484, 70776311, 74443334
        }) -- Caverns spawns
    }
}) -- Spirit of Jadefire
...
map.nodes[71348293] = Rare({
    id = 73704,
    quest = {33280, 33305},
    rewards = {Achievement({id = 8714, criteria = 24144})}
}) -- Stinkbraid
...
lostspirits.nodes[62853535] = Treasure({
    ...
    note = L['cavern_of_lost_spirits'],
    parent = {id = map.id, pois = {POI({43624055})}},
    rewards = {Achievement({id = 8729, criteria = 2})}
}) -- Skull-Covered Chest
...
map.nodes[49676941] = Treasure({
    ...
    icon = 'star_chest_g',
    scale = 1.5,
    rewards = {Achievement({id = 8726, criteria = 24018})},
    pois = {
        POI({51607460}),
...
map.nodes[53934723] = Treasure({
    ...
    icon = 'star_chest_g',
    scale = 1.5,
    rewards = {Achievement({id = 8726, criteria = 24019})},
    pois = {POI({60204590}), Path({60204590, 57804728, 55144409, 53934723})}
...
map.nodes[58506010] = Treasure({
    ...
    icon = 'star_chest_g',
    scale = 1.5,
    rewards = {Achievement({id = 8726, criteria = 24020})}
...
map.nodes[22705890] = Treasure({
    ...
    icon = 'star_chest_g',
    scale = 1.5,
    rewards = {Achievement({id = 8727, criteria = 24022})},
    pois = {
...
map.nodes[70608090] = Treasure({
    ...
    rewards = {Achievement({id = 8727, criteria = 24023})}
