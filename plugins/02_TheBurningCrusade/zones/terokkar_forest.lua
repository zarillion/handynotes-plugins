...
map.nodes[49407100] = Rare({
    ...
    pois = {
        POI({
            30406380, 32005520, 32405200, 40005040, 44805620, 45207400,
            45207920, 45805960, 46007860, 47606260, 48207460, 48405540, 48405740
        }), Path({
            37546655, 37306722, 37436791, 37786848, 38446868, 38876817,
            38746752, 38556673, 38416608, 38376529, 38596455, 38846394,
            39116321, 39646271, 40336261, 40996257, 41446306, 41406382,
            41316449, 41246519, 41086584, 40786649, 40726721, 40336779,
            39636817, 38976784, 38536715, 38186656, 37546655
        })
    }
}) -- Crippler
