**The [HandyNotes](https://www.curseforge.com/wow/addons/handynotes) plugin for original World of Warcraft zones on retail. It will add the locations and rewards for rare mobs, battle pets, treasures and other miscellaneous points of interest to the map.**
...
* Patch 1.0 - All 48 original Kalimdor and Easter Kingdoms zones.

In addition to rares, treasures and pet battles, this plugin also adds the following expansion or zone-specific items.

### Kalimdor & Easter Kingdoms

* Junk pool locations for the [The Scavenger](https://www.wowhead.com/achievement=1257/the-scavenger) achievement.
* World of Warcraft yearly anniversary boss locations.

### Zul'Gurub

* Fishing location for the [Deadliest Cache](https://www.wowhead.com/achievement=17367/deadliest-cache) achievement.
* Relic location for the [Relics of a Fallen Empire](https://www.wowhead.com/achievement=17366/relics-of-a-fallen-empire) achievement.
* Vendor locations for ancient ensembles and recipes.
