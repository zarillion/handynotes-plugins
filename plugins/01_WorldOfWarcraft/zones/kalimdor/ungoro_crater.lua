...
map.nodes[67207020] = Safari.Parrot({
    pois = {
        POI({
            20404260, 26805500, 27803340, 30006540, 30202360, 30804100,
            33004100, 33804660, 34007020, 36006660, 37806160, 39602240,
            40805420, 43207020, 43400700, 48806920, 50200860, 53202280,
            54408260, 56007160, 58204060, 58608120, 59602520, 59806320,
            60207260, 60606680, 62006920, 64607660, 67207020, 67807640,
            67807680, 69407120, 69607100, 70407660, 70603860, 70805880,
            71006180, 73806320, 79404500, 79804980
        })
    }
}) -- Parrot
...
map.nodes[68604700] = Safari.SpottedBellFrog({
    pois = {
        POI({
            29605040, 29605280, 29804700, 30604760, 31402460, 32202640,
            32205940, 34002660, 34802420, 34802460, 35605980, 35805080,
            35805380, 36805540, 36805940, 38402780, 38602740, 39202840,
            42403060, 42602860, 44003020, 44004020, 44203660, 44804020,
            48203960, 49603900, 53403680, 55403900, 58404320, 62006820,
            62206920, 62407100, 62607100, 64407180, 64604200, 64607160,
            64607420, 64805800, 64806340, 65004020, 65006980, 65007540,
            65207680, 65606380, 66207320, 66404260, 66605660, 66806320,
            67004180, 67006460, 67205300, 67404320, 67407480, 67604300,
            67607520, 67805240, 67805460, 68005260, 68006400, 68407280,
            68604700, 68605280, 69607060, 69807020, 70006320, 70007520,
            70007560, 70404300, 70806660, 71404400, 71405840, 71605580,
            72205980, 72406220, 72604440, 72804660, 74204920, 74404700,
            74804840, 75405620
        })
    }
}) -- Spotted Bell Frog

map.nodes[58605320] = Safari.TreePython({
    pois = {
        POI({
            22606460, 27406600, 30207160, 30403080, 31607780, 35407780,
            38606120, 38608080, 39006780, 40807540, 45203240, 45802080,
            46202400, 49808540, 50000860, 53003220, 53607360, 54007200,
            55602960, 56206660, 56406640, 58408100, 58605320, 59402220,
            59608240, 60606700, 63002520, 63208000, 66004060, 67206440,
            67405100, 68007640, 68007660, 71004600, 71408140, 72004040, 80005000
        })
    }
}) -- Tree Python
...
map.nodes[53379308] = ns.node.Dragonrace({
    ...
    rewards = {
        ...
        Achievement({id = 17714, criteria = 16, oneline = true}), -- normal gold
        Achievement({id = 17715, criteria = 16, oneline = true}), -- advanced bronze
        Achievement({id = 17716, criteria = 16, oneline = true}), -- advanced silver
        Achievement({id = 17717, criteria = 16, oneline = true}), -- advanced gold
