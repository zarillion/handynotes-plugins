...
L['options_toggle_interval_enlarged'] = 'Ampliar los iconos de intérvalo en su ventana de aparición'
L['options_toggle_interval_enlarged_desc'] = 'Amplia el icono de un nodo de intérvalo o temporizador mientras está en su ventana de aparición. Desactívalo para mantener todos los iconos en su tamaño normal.'
