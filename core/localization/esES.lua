...
L['map_button_text'] =
    'Ajustar visibilidad del icono, transparencia y escalado para este mapa.'
...
L['options_general_description'] =
    'Ajustes que controlan el comportamiento de los nodos y sus recompensas.'
L['options_global_description'] =
    'Ajustes que controlan la visualización de todos los nodos en todas las zonas.'
L['options_zones_description'] =
    'Ajustes que controlan la visualización de nodos en cada zona individual.'
...
L['options_show_worldmap_button_desc'] =
    'Añade un menú desplegable para cambiar opciones rápidamente en la esquina superior derecha del mapa del mundo.'
...
L['options_show_completed_nodes_desc'] =
    'Muestra todos los nodos incluso si ya han sido despojados o completados hoy.'
L['options_toggle_hide_done_rare'] =
    'Ocultar los raros, si se conoce todo el botín'
L['options_toggle_hide_done_rare_desc'] =
    'Oculta todos los raros a los que se les conozca el botín.'
L['options_toggle_hide_minimap'] = 'Ocultar todos los iconos sobre el minimapa'
L['options_toggle_hide_minimap_desc'] =
    'Oculta todos los iconos de este addon sobre el minimapa y mostrarlos solamente sobre el mapa principal.'
L['options_toggle_maximized_enlarged'] =
    'Agrandar iconos en el mapa del mundo maximizado'
L['options_toggle_maximized_enlarged_desc'] =
    'Cuando el mapa del mundo está maximizado, agranda todos los iconos.'
L['options_toggle_use_char_achieves'] = 'Mostrar logros de personaje'
L['options_toggle_use_char_achieves_desc'] =
    'Muestra el progreso de logros para este personaje en lugar de para toda la cuenta.'
L['options_toggle_per_map_settings'] =
    'Usar opciones específicas para cada zona'
L['options_toggle_per_map_settings_desc'] =
    'Aplicar opciones, escalado y opacidad para cada zona individualmente.'
L['options_restore_hidden_nodes'] = 'Restaurar los nodos ocultos'
L['options_restore_hidden_nodes_desc'] =
    'Vuelve a mostrar todos los nodos ocultos usando el menú contextual con click-derecho.'
...
L['options_mount_rewards_desc'] =
    'Muestra las recompensas de monturas en las notas y rastrea el estado de si ha sido aprendida.'
L['options_pet_rewards'] = 'Mostrar recompensas de mascotas'
L['options_pet_rewards_desc'] =
    'Muestra las recompensas de mascotas en las notas y rastrea el estado de si ha sido aprendida.'
L['options_toy_rewards'] = 'Mostrar recompensas de juguetes'
L['options_toy_rewards_desc'] =
    'Muestra las recompensas de juguetes en las notas y rastrea el estado de si ha sido aprendida.'
L['options_transmog_rewards'] = 'Mostrar recompensas de transfiguraciones'
L['options_transmog_rewards_desc'] =
    'Muestra las recompensas de transfiguraciones en las notas y rastrea el estado de si ha sido aprendida.'
L['options_all_transmog_rewards'] =
    'Mostrar las recompensas de transfiguraciones que no pueden conseguirse'
L['options_all_transmog_rewards_desc'] =
    'Muestra las recompensas de transfiguraciones conseguibles por otras clases.'
...
L['options_icons_pet_battles_desc'] =
    'Muestra dónde están los entrenadores de mascotas y NPCs.'
...
L['options_poi_color_desc'] =
    'Establece el color para el punto de interés cuando un icono está en el foco.'
L['options_path_color'] = 'Color de Caminos'
L['options_path_color_desc'] =
    'Establece el color para los caminos cuando un icono está en el foco.'
L['options_reset_poi_colors'] = 'Resetear colores'
L['options_reset_poi_colors_desc'] =
    'Establece los colores de encima a sus valores por defecto.'
...
L['options_toggle_show_loot_desc'] =
    'Muestra la información de botín al tooltip'
L['options_toggle_show_notes'] = 'Mostrar las Notas'
L['options_toggle_show_notes_desc'] =
    'Agrega las notas útiles al tooltip cuando esté disponible'
...
L['options_toggle_show_debug_map_desc'] =
    'Muestra información de depuración para los mapas'
