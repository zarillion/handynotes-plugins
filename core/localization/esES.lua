...
----------------------------------- REWARDS -----------------------------------
L['decor'] = 'Adorno para las viviendas'
L['heirloom'] = 'Reliquia'
L['item'] = 'Objeto'
L['mount'] = 'Montura'
L['pet'] = 'Mascota'
...
L['options_decor_rewards_desc'] = 'Muestra los elementos decorativos del las recompensas de las Viviendas en las descripciones.'
