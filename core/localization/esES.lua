...
L['options_restore_hidden_nodes_desc'] = 'Vuelve a mostrar todos los nodos ocultos usando el menú contextual con clic derecho.'
...
L['options_icons_pet_battles_desc'] = 'Muestra dónde están los entrenadores de mascotas y PNJ.'
L['options_icons_pet_battles'] = 'Mascotas de combate'
L['options_icons_rares_desc'] = 'Muestra dónde están los PNJ raros.'
...
L['options_toggle_show_debug_currency_desc'] = 'Muestra información de depuración para cambios de moneda (requiere recargar)'
