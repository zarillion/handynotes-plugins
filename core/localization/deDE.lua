...
L['options_all_transmog_rewards'] = 'Zeige nicht Transmogrifizierbare Vorlagenbelohnungen' -- @Dathwada: oder einfach 'nicht nutzbare'?
L['options_all_transmog_rewards_desc'] = 'Zeigt Vorlagenbelohnungen an, die nur für andere Klassen Transmogrifizierbar sind.'
