...
L['map_button_text'] =
    'Passe die Symbolanzeige, die Transparenz und die Größe für diese Karte an.'
...
L['options_general_description'] =
    'Einstellungen, die das Verhalten von Punkten und deren Belohnungen steuern.'
L['options_global_description'] =
    'Einstellungen, die die Darstellung aller Punkte in allen Zonen steuern.'
L['options_zones_description'] =
    'Einstellungen, die die Darstellung von Punkten in jeder einzelnen Zone steuern.'
...
L['options_show_worldmap_button_desc'] =
    'Fügt der Weltkarte in der rechten oberen Ecke einen Button hinzu, womit per Dropdownmenü schnell auf Einstellungen zugegriffen werden kann.'
...
L['options_show_completed_nodes_desc'] =
    'Zeigt alle Punkte an, auch wenn diese heute bereits geplündert oder abgeschlossen wurden.'
L['options_toggle_hide_done_rare'] =
    'Blende seltene Gegner aus, deren Belohnungen bekannt sind.'
L['options_toggle_hide_done_rare_desc'] =
    'Blendet alle seltenen Gegner deren Beute bereits bekannt ist aus.'
L['options_toggle_hide_minimap'] = 'Blende alle Symbole auf der Minikarte aus'
L['options_toggle_hide_minimap_desc'] =
    'Blendet alle Symbole dieses Addons auf der Minikarte aus und zeigt sie nur auf der Hauptkarte an.'
L['options_toggle_maximized_enlarged'] =
    'Symbole bei maximierter Weltkarte vergrößern'
L['options_toggle_maximized_enlarged_desc'] =
    'Wenn die Weltkarte maximiert ist, werden alle Symbole vergrößert.'
L['options_toggle_use_char_achieves'] = 'Verwende charakterspezifische Erfolge'
L['options_toggle_use_char_achieves_desc'] =
    'Zeigt den Erfolgsfortschritt von diesem Charakter, anstelle des gesamten Accounts an.'
L['options_toggle_per_map_settings'] = 'Verwende zonenspezifische Einstellungen'
L['options_toggle_per_map_settings_desc'] =
    'Die Einstellungen zum Anzeigen/Ausblenden, die Größe und die Transparenz der Symbole werden auf jede Zone einzeln angewendet.'
L['options_restore_hidden_nodes'] = 'Versteckte Punkte wiederherstellen'
L['options_restore_hidden_nodes_desc'] =
    'Stellt alle Punkte wieder her, die über das Kontextmenü versteckt wurden.'
...
L['options_mount_rewards_desc'] =
    'Zeige Reittierbelohnungen in Tooltips an und verfolge ihren Sammlungsstatus.'
L['options_pet_rewards'] = 'Zeige Haustierbelohnungen'
L['options_pet_rewards_desc'] =
    'Zeige Haustierbelohnungen in Tooltips an und verfolge ihren Sammlungsstatus.'
L['options_toy_rewards'] = 'Zeige Spielzeugbelohnungen'
L['options_toy_rewards_desc'] =
    'Zeige Spielzeugbelohnungen in Tooltips an und verfolge ihren Sammlungsstatus.'
L['options_transmog_rewards'] = 'Zeige Vorlagenbelohnungen'
L['options_transmog_rewards_desc'] =
    'Zeige Vorlagenbelohnungen für Waffen und Rüstungen in Tooltips an und verfolge ihren Sammlungsstatus.'
L['options_all_transmog_rewards'] =
    'Zeige nicht erhältliche Vorlagenbelohnungen'
L['options_all_transmog_rewards_desc'] =
    'Zeigt Vorlagenbelohnungen an, die nur für andere Klassen erhältlich sind.'

L['options_icons_misc_desc'] =
    'Zeigt die Positionen von anderen nicht kategorisierten Punkten an.'
L['options_icons_misc'] = 'Sonstiges'
L['options_icons_pet_battles_desc'] =
    'Zeigt Standorte von Kampfhaustiertrainern und NPCs an.'
...
L['options_icons_treasures_desc'] =
    'Zeigt die Standorte versteckter Schätze an.'
...
L['options_poi_color_desc'] =
    'Legt die Farbe für Punkte fest, wenn ein Symbol fokussiert ist.'
L['options_path_color'] = 'Wegfarbe'
L['options_path_color_desc'] =
    'Legt die Farbe des Weges fest, wenn ein Symbol fokussiert ist.'
L['options_reset_poi_colors'] = 'Farben zurücksetzen'
L['options_reset_poi_colors_desc'] =
    'Setzt die obigen Farben auf ihre Standardeinstellungen zurück.'
...
L['options_toggle_show_notes_desc'] =
    'Zeigt hilfreiche Notizen an sofern diese verfügbar sind.'
