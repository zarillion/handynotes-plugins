...
L['options_toggle_use_server_time'] = 'Serverzeit verwenden'
L['options_toggle_use_server_time_desc'] = 'Zeigt die Zeiten in der Server-Zeitzone anstelle der lokalen Zeit in Tooltips an.'
