...
L['options_hide_done_nodes'] = 'Verstecke erledigte Punkte'
L['options_hide_done_nodes_desc'] = 'Versteckt Punkte, bei denen alle Belohnungen gesammelt wurden.'
...
L['options_reward_types'] = 'Filtere Belohnungstypen'
