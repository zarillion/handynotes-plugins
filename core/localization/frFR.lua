...
L['options_all_transmog_rewards'] = 'Afficher les transmos inutilisables en récompense'
L['options_all_transmog_rewards_desc'] = 'Afficher les transmos en récompenses pouvant être utilisées par d\'autres classes.'
