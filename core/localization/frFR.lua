...
L['options_toggle_interval_enlarged'] = 'Agrandir les icônes d\'intervalle de temps lorsque l\'on se trouve dans la période d\'apparition'
L['options_toggle_interval_enlarged_desc'] = 'Agrandit l\'icône d\'un nœud lié à un intervalle de temps ou d\'un timer lorsqu\'il se trouve dans sa période d\'apparition. Désactivez cette option pour garder toutes les icônes à leur taille normale.'
