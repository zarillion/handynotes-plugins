...
L['options_rep_rewards_desc'] = 'Afficher les récompenses de réputation dans les infobulles et suivre leur état de possession.'
L['show_claimed_rep'] = 'Afficher les réputations réclamées'
L['show_claimed_rep_desc'] = 'Afficher les récompenses de réputation qui ont déjà été réclamées par votre bataillon.'
