...
L['options_toggle_use_server_time'] = 'Использовать серверное время'
L['options_toggle_use_server_time_desc'] = 'Показывать время в часовом поясе сервера вместо местного времени во всплывающих подсказках.'
