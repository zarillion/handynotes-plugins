...
L['requirement_not_found'] =
    'Местоположение требования неизвестно!'
...
L['context_menu_set_waypoint'] =
    'Установить путевую точку на карте'
L['context_menu_add_tomtom'] = 'Добавить в TomTom'
L['context_menu_hide_node'] = 'Скрыть эту точку'
L['context_menu_restore_hidden_nodes'] =
    'Восстановить все скрытые точки'

L['map_button_text'] =
    'Настройте отображение значков, прозрачности и масштаба для этой карты.'
...
L['options_general_description'] =
    'Настройки, управляющие поведением точек и их наградами.'
L['options_global_description'] =
    'Настройки, управляющие отображением всех точек во всех локациях.'
L['options_zones_description'] =
    'Настройки, управляющие отображением точек в каждой отдельной локации.'

L['options_open_settings_panel'] =
    'Открыть панель настроек ...'
L['options_open_world_map'] = 'Карта открытого мира'
L['options_open_world_map_desc'] =
    'Открыть эту локацию на карте мира.'
...
L['options_opacity_desc'] =
    '0 = прозрачный, 1 = непрозрачный'

---------------------------------- VISIBILITY ---------------------------------

L['options_show_worldmap_button'] =
    'Показать кнопку карты мира'
L['options_show_worldmap_button_desc'] =
    'Добавьте раскрывающееся меню с быстрым переключением в правом верхнем углу карты мира.'
...
L['options_show_completed_nodes_desc'] =
    'Показать все точки, даже если они уже были получены или завершены сегодня.'
L['options_toggle_hide_done_rare'] =
    'Скрыть редких монстров, если все награды получены'
L['options_toggle_hide_done_rare_desc'] =
    'Скрыть всех редких монстров, с которых получены все награды.'
L['options_toggle_hide_minimap'] =
    'Скрыть все значки на миникарте'
L['options_toggle_hide_minimap_desc'] =
    'Скрывает все иконки из этого аддона на миникарте и отображает их только на главной карте.'
L['options_toggle_maximized_enlarged'] =
    'Увеличивайте значки на увеличенной карте мира.'
L['options_toggle_maximized_enlarged_desc'] =
    'Когда карта мира развернута, увеличьте все значки.'
L['options_toggle_use_char_achieves'] =
    'Используйте достижения персонажа'
L['options_toggle_use_char_achieves_desc'] =
    'Отображать прогресс достижений этого персонажа вместо общего на аккаунт.'
L['options_toggle_per_map_settings'] =
    'Используйте настройки для конкретной локации'
L['options_toggle_per_map_settings_desc'] =
    'Применяйте настройки переключателя, масштаба и непрозрачности к каждой локации индивидуально.'
L['options_restore_hidden_nodes'] =
    'Восстановить скрытые места'
L['options_restore_hidden_nodes_desc'] =
    'Восстановите все скрытые места, используя контекстное меню, вызываемое правой кнопкой мыши.'
...
L['options_mount_rewards_desc'] =
    'Отображать маунтов во всплывающих подсказках и отслеживать их собранный статус.'
L['options_pet_rewards'] = 'Показать питомцев'
L['options_pet_rewards_desc'] =
    'Отображать питомцев во всплывающих подсказках и отслеживать их статус.'
L['options_toy_rewards'] = 'Показать игрушки'
L['options_toy_rewards_desc'] =
    'Отображать игрушки во всплывающих подсказках и отслеживание их статуса.'
L['options_transmog_rewards'] =
    'Показать трансмогрификацию'
L['options_transmog_rewards_desc'] =
    'Отображать трансмогрификацию во всплывающих подсказках и отслеживать их статус.'
L['options_all_transmog_rewards'] = nil
L['options_all_transmog_rewards_desc'] = nil

L['options_icons_misc_desc'] =
    'Отображение местоположения других разных точек.'
L['options_icons_misc'] = 'Разное'
L['options_icons_pet_battles_desc'] =
    'Показать местонахождение наставников боевых питомцев и NPC.'
L['options_icons_pet_battles'] = 'Боевые Питомцы'
L['options_icons_rares_desc'] =
    'Показать местонахождение редких НПС.'
L['options_icons_rares'] = 'Редкие монстры'
L['options_icons_treasures_desc'] =
    'Отображение местоположения спрятанных сокровищ.'
...
L['options_poi_color_desc'] =
    'Устанавливает цвет точки, когда значок находится в фокусе.'
L['options_path_color'] = 'Цвет пути'
L['options_path_color_desc'] =
    'Устанавливает цвет путей, когда значок находится в фокусе.'
L['options_reset_poi_colors'] = 'Сбросить цвета'
L['options_reset_poi_colors_desc'] =
    'Восстановите значения по умолчанию для указанных выше цветов.'
...
L['options_toggle_show_loot_desc'] =
    'Добавить информацию о добыче в подсказку'
L['options_toggle_show_notes'] = 'Показать заметки'
L['options_toggle_show_notes_desc'] =
    'Добавьте полезные заметки в подсказку, где это возможно'

--------------------------------- DEVELOPMENT ---------------------------------

L['options_dev_settings'] = 'Разработка'
L['options_toggle_show_debug_map'] =
    'Отладка идентификаторов карты'
L['options_toggle_show_debug_map_desc'] =
    'Показать отладочную информацию для карт'
...
L['options_toggle_force_nodes_desc'] =
    'Принудительно отобразить все точки'
