...
L['recipe_prefix_alchemy'] = 'Рецепт: '
L['recipe_prefix_blacksmithing'] = 'Чертеж: '
L['recipe_prefix_enchanting'] = 'Формула: '
L['recipe_prefix_engineering'] = 'Схема: '
L['recipe_prefix_inscription'] = 'Техника: '
L['recipe_prefix_jewelcrafting'] = 'Эскиз: '
L['recipe_prefix_leatherworking'] = 'Выкройка: '
L['recipe_prefix_tailoring'] = 'Выкройка: '
L['recipe_prefix_cooking'] = 'Рецепт: '
...
L['options_recipe_rewards'] = 'Показать награды где есть рецепты'
L['options_recipe_rewards_desc'] = 'Отображение наград где есть рецепты во всплывающих подсказках и отслеживание их собранного статуса.'
