...
L['options_toggle_interval_enlarged'] = 'Увеличивать иконки интервалов в окне появления'
L['options_toggle_interval_enlarged_desc'] = 'Увеличивает иконку интервала или таймера, пока этот элемент находится в окне появления. Отключите, чтобы все иконки оставались стандартного размера.'
