...
L['options_rep_show_claimed'] = 'Show claimed reputation rewards'
L['options_rep_show_claimed_desc'] = 'Show reputation rewards which have already been claimed by your warband.'
