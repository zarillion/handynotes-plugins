...
L['options_toggle_use_server_time'] = 'Use Server Time'
L['options_toggle_use_server_time_desc'] = 'Display event times in the server timezone instead of your local time in tooltips.'
