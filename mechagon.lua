...
defaults['npc_mech'] = true;
defaults['cave_mech'] = true;
...
nodes[66535891] = {type=RARE, id=154739, quest=56368, note=L["drill_rig"]..'(DR-CC73).', rewards={
    ...
    {type=ITEM, id=169170, quest=55078} -- Blueprint: Utility Mechanoclaw
}}; -- Caustic Mechaslime

nodes[82522072] = {type=RARE, id=149847, quest=55812, note=L["crazed_trogg_note"], rewards={
    {type=ACHIEVE, id=13470, criteria=45137}, -- Kill
    {type=ITEM, id=169169, quest=55077}, -- Blueprint: Blue Spraybot
    {type=ITEM, id=169168, quest=55076}, -- Blueprint: Green Spraybot
    {type=ITEM, id=169167, quest=55075}, -- Blueprint: Orange Spraybot
    {type=ITEM, id=167792, quest=55452}, -- Paint Vial: Fel Mint Green
    {type=ITEM, id=167793, quest=55457} -- Paint Vial: Overload Orange
}}; -- Crazed Trogg

nodes[35464229] = {type=RARE, id=151569, quest=55514, note=L["deepwater_note"], rewards={
    {type=ACHIEVE, id=13470, criteria=45128}, -- Kill
    {type=ITEM, id=167836, quest=55057}, -- Blueprint: Canned Minnows
}}; --Deepwater Maw
...
nodes[55075684] = {type=RARE, id=154153, quest=56207, note=nil, rewards={
    ...
    {type=ITEM, id=169174, quest=55082}, -- Blueprint: Rustbolt Pocket Turret
...
nodes[65515167] = {type=RARE, id=151202, quest=55513, note=L["foul_manifest_note"], rewards={
    ...
    {type=ITEM, id=167871, quest=55063} -- Blueprint: G99.99 Landshark
}}; -- Foul Manifestation
...
nodes[61395117] = {type=RARE, id=153228, quest=55852, note=L["cogstar_note"], rewards={
    ...
    {type=ITEM, id=167847, quest=55062}, -- Blueprint: Ultrasafe Transporter: Mechagon
    {type=TRANSMOG, item=170467, slot=L["1h_sword"]} -- Whirring Chainblade
...
nodes[57165258] = {type=RARE, id=151124, quest=55207, note=L["nullifier_note"], rewards={
    ...
    {type=ITEM, id=168490, quest=55069}, -- Blueprint: Protocol Transference Device
    {type=ITEM, id=169688, quest=56515} -- Vinyl: Gnomeregan Forever
...
nodes[61036101] = {type=RARE, id=151627, quest=55859, note=nil, rewards={
    ...
    {type=ITEM, id=168248, quest=55068}, -- Blueprint: BAWLD-371
    {type=TRANSMOG, item=170467, slot=L["1h_sword"]} -- Whirring Chainblade
}}; -- Mr. Fixthis
...
nodes[56636287] = {type=RARE, id=152764, quest=55856, note=L["leachbeast_note"], rewards={
    ...
    {type=ITEM, id=167794, quest=55454}, -- Paint Vial: Lemonade Steel
}}; -- Oxidized Leachbeast
...
nodes[40235317] = {type=RARE, id=150575, quest=55368, note=L["cave_spawn"], rewards={
    ...
    {type=ITEM, id=168001, quest=55517} -- Paint Vial: Big-ol Bronze
}}; -- Rumblerocks

nodes[65637850] = {type=RARE, id=152182, quest=55811, note=nil, rewards={
    {type=ACHIEVE, id=13470, criteria=45135}, -- Kill
    {type=ITEM, id=169173, quest=55081}, -- Blueprint: Anti-Gravity Pack
...
nodes[19127975] = {type=RARE, id=150937, quest=55545, note=nil, rewards={
    ...
    {type=ITEM, id=168063, quest=55065} -- Blueprint: Rustbolt Kegerator
}}; -- Seaspit
...
nodes[26257806] = {type=RARE, id=153226, quest=55854, note=nil, rewards={
    ...
    {type=ITEM, id=168062, quest=55064}, -- Blueprint: Rustbolt Gramophone
    {type=ITEM, id=169690, quest=56517}, -- Vinyl: Battle of Gnomeregan
    {type=ITEM, id=169689, quest=56516}, -- Vinyl: Mimiron's Brainstorm
    {type=ITEM, id=169692, quest=56519} -- Vinyl: Triumph of Gnomeregan
}}; -- Steel Singer Freza
...
nodes[53824933] = {type=RARE, id=150394, quest=55546, note=L["vaultbot_note"], rewards={
    ...
    {type=ITEM, id=167843, quest=55058}, -- Blueprint: Vaultbot Key
    {type=ITEM, id=167796, quest=55455} -- Paint Vial: Mechagon Gold
}}; -- Armored Vaultbot
